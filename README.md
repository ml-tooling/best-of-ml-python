...
- [GitHub](https://github.com/scikit-learn/scikit-learn) (👨‍💻 2.5K · 🔀 22K · 📥 780 · 📦 320K · 📋 10K - 24% open · ⏱️ 03.03.2022):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.1K · 🔀 15K · 📥 2.4K · 📋 28K - 39% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/torch) (📥 7M / month · 📦 6.8K · ⏱️ 27.01.2022):
	```
	pip install torch
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1K · 🔀 19K · 📋 11K - 2% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/keras-team/keras
	```
- [PyPi](https://pypi.org/project/keras) (📥 9.1M / month · 📦 220 · ⏱️ 31.01.2022):
	```
	pip install keras
	```
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 550 · 🔀 8.3K · 📥 3.7K · 📦 28K · 📋 4.4K - 6% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 8.1M / month · 📦 1.3K · ⏱️ 17.01.2022):
	```
	pip install xgboost
	```
...
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">StatsModels</a></b> (🥇44 ·  ⭐ 7.2K) - Statsmodels: statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 360 · 🔀 2.4K · 📥 26 · 📦 59K · 📋 4.8K - 47% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/apache/spark) (👨‍💻 2.6K · 🔀 25K · ⏱️ 03.03.2022):

	```
	git clone https://github.com/apache/spark
	```
- [PyPi](https://pypi.org/project/pyspark) (📥 18M / month · 📦 770 · ⏱️ 26.01.2022):
	```
	pip install pyspark
	```
...
- [GitHub](https://github.com/PyTorchLightning/pytorch-lightning) (👨‍💻 630 · 🔀 2.2K · 📥 5.6K · 📦 7.2K · 📋 4.7K - 10% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/PyTorchLightning/pytorch-lightning
	```
- [PyPi](https://pypi.org/project/pytorch-lightning) (📥 1.3M / month · 📦 310 · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/google/jax) (👨‍💻 370 · 🔀 1.5K · 📦 3.6K · 📋 3.1K - 31% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/google/jax
	```
- [PyPi](https://pypi.org/project/jax) (📥 300K / month · 📦 270 · ⏱️ 18.02.2022):
	```
	pip install jax
	```
...
- [GitHub](https://github.com/microsoft/LightGBM) (👨‍💻 250 · 🔀 3.5K · 📥 140K · 📦 12K · 📋 2.6K - 6% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/microsoft/LightGBM
	```
- [PyPi](https://pypi.org/project/lightgbm) (📥 5.8M / month · 📦 580 · ⏱️ 07.01.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/Paddle) (👨‍💻 710 · 🔀 4.3K · 📥 15K · 📦 94 · 📋 15K - 18% open · ⏱️ 03.03.2022):
...
- [GitHub](https://github.com/catboost/catboost) (👨‍💻 960 · 🔀 950 · 📥 75K · 📋 1.7K - 20% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/catboost/catboost
	```
- [PyPi](https://pypi.org/project/catboost) (📥 3.4M / month · 📦 210 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 970 · 🔀 6.9K · 📥 25K · 📋 9.7K - 20% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/apache/incubator-mxnet
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 280K / month · 📦 280 · ⏱️ 18.12.2021):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/jina-ai/jina) (👨‍💻 140 · 🔀 1.8K · 📦 230 · 📋 1.3K - 2% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/jina-ai/jina
	```
- [PyPi](https://pypi.org/project/jina) (📥 57K / month · ⏱️ 02.03.2022):
	```
	pip install jina
	```
- [Conda](https://anaconda.org/conda-forge/jina-core) (📥 2.5K · ⏱️ 02.03.2022):
	```
...
- [GitHub](https://github.com/fastai/fastai) (👨‍💻 600 · 🔀 7.1K · 📋 1.6K - 6% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/apache/flink) (👨‍💻 1.5K · 🔀 10K · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/apache-flink) (📥 12K / month · 📦 13 · ⏱️ 17.01.2022):
	```
...
- [PyPi](https://pypi.org/project/theano) (📥 300K / month · 📦 2.8K · ⏱️ 27.07.2020):
	...
	pip install theano
	```
- [Conda](https://anaconda.org/conda-forge/theano) (📥 1.9M · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/VowpalWabbit/vowpal_wabbit) (👨‍💻 310 · 🔀 1.8K · 📋 1.2K - 11% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/VowpalWabbit/vowpal_wabbit
	```
- [PyPi](https://pypi.org/project/vowpalwabbit) (📥 60K / month · 📦 29 · ⏱️ 01.02.2022):
	```
...
- [PyPi](https://pypi.org/project/chainer) (📥 20K / month · 📦 400 · ⏱️ 05.01.2022):
	...
	pip install chainer
	```
- [Conda](https://anaconda.org/conda-forge/chainer) (📥 6.9K · ⏱️ 21.01.2022):
	```
...
- [GitHub](https://github.com/explosion/thinc) (👨‍💻 47 · 🔀 230 · 📦 19K · 📋 120 - 16% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/explosion/thinc
	```
- [PyPi](https://pypi.org/project/thinc) (📥 4.1M / month · 📦 610 · ⏱️ 17.12.2021):
	```
	pip install thinc
	```
...
<details><summary><b><a href="https://github.com/tensorflow/tensorflow">Tensorflow</a></b> (🥈35 ·  ⭐ 160K · 📉) - An Open Source Machine Learning Framework for Everyone. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 880 · 🔀 86K):
...
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 3M · ⏱️ 06.02.2022):
	...
	```
- [Docker Hub](https://hub.docker.com/r/tensorflow/tensorflow) (📥 65M · ⭐ 2K · ⏱️ 03.03.2022):
	```
	docker pull tensorflow/tensorflow
	```
</details>
<details><summary><b><a href="https://github.com/google/flax">Flax</a></b> (🥈34 ·  ⭐ 2.7K) - Flax is a neural network library for JAX that is designed for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google/flax) (👨‍💻 140 · 🔀 300 · 📥 32 · 📦 700 · 📋 500 - 36% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/google/flax
	```
- [PyPi](https://pypi.org/project/flax) (📥 97K / month · 📦 57 · ⏱️ 27.01.2022):
	```
	pip install flax
	```
- [Conda](https://anaconda.org/conda-forge/flax) (📥 2.4K · ⏱️ 27.01.2022):
	```
...
- [PyPi](https://pypi.org/project/tensorpack) (📥 21K / month · 📦 46 · ⏱️ 22.01.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorpack) (📥 240 · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/pytorch/ignite) (👨‍💻 170 · 🔀 520 · 📋 1K - 13% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/pytorch/ignite
	```
- [PyPi](https://pypi.org/project/pytorch-ignite) (📥 150K / month · 📦 79 · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) (👨‍💻 3.9K · 🔀 66 · 📥 17 · 📋 320 - 17% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/ROCmSoftwarePlatform/tensorflow-upstream
	```
- [PyPi](https://pypi.org/project/tensorflow-rocm) (📥 45K / month · 📦 5 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/ludwig-ai/ludwig) (👨‍💻 110 · 🔀 960 · 📦 100 · 📋 680 - 26% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/ludwig-ai/ludwig
	```
- [PyPi](https://pypi.org/project/ludwig) (📥 3.7K / month · 📦 8 · ⏱️ 10.02.2022):
	```
	pip install ludwig
	```
</details>
<details><summary><b><a href="https://github.com/arogozhnikov/einops">einops</a></b> (🥉31 ·  ⭐ 4.6K) - Deep learning operations reinvented (for pytorch, tensorflow, jax and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/arogozhnikov/einops) (👨‍💻 14 · 🔀 190 · 📦 2K · 📋 100 - 32% open · ⏱️ 03.02.2022):

	```
	git clone https://github.com/arogozhnikov/einops
	```
- [PyPi](https://pypi.org/project/einops) (📥 930K / month · 📦 190 · ⏱️ 18.01.2022):
	```
	pip install einops
	```
...
- [GitHub](https://github.com/mlpack/mlpack) (👨‍💻 280 · 🔀 1.4K · 📋 1.5K - 7% open · ⏱️ 21.02.2022):

	```
	git clone https://github.com/mlpack/mlpack
	```
- [PyPi](https://pypi.org/project/mlpack) (📥 1.1K / month · 📦 1 · ⏱️ 28.10.2020):
	```
	pip install mlpack
	```
- [Conda](https://anaconda.org/conda-forge/mlpack) (📥 98K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/deepmind/sonnet) (👨‍💻 53 · 🔀 1.3K · 📦 780 · 📋 170 - 12% open · ⏱️ 01.02.2022):
...
<details><summary><b><a href="https://github.com/skorch-dev/skorch">skorch</a></b> (🥉30 ·  ⭐ 4.4K) - A scikit-learn compatible neural network library that wraps.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/skorch-dev/skorch) (👨‍💻 48 · 🔀 300 · 📦 450 · 📋 420 - 12% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/skorch-dev/skorch
	```
- [PyPi](https://pypi.org/project/skorch) (📥 53K / month · 📦 33 · ⏱️ 31.10.2021):
	```
	pip install skorch
	```
...
- [GitHub](https://github.com/sony/nnabla) (👨‍💻 65 · 🔀 310 · 📥 530 · 📋 77 - 41% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/sony/nnabla
	```
- [PyPi](https://pypi.org/project/nnabla) (📥 5.2K / month · 📦 51 · ⏱️ 26.01.2022):
	```
	pip install nnabla
	```
</details>
<details><summary><b><a href="https://github.com/deepmind/dm-haiku">Haiku</a></b> (🥉29 ·  ⭐ 1.8K) - JAX-based neural network library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/deepmind/dm-haiku) (👨‍💻 57 · 🔀 140 · 📦 350 · 📋 140 - 25% open · ⏱️ 24.02.2022):
...
- [PyPi](https://pypi.org/project/dm-haiku) (📥 87K / month · 📦 30 · ⏱️ 14.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dm-haiku) (📥 2.1K · ⏱️ 14.02.2022):
	```
	conda install -c conda-forge dm-haiku
	```
</details>
<details><summary><b><a href="https://github.com/amaiya/ktrain">ktrain</a></b> (🥉29 ·  ⭐ 960) - ktrain is a Python library that makes deep learning and AI more.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/amaiya/ktrain) (👨‍💻 13 · 🔀 230 · 📦 270 · 📋 390 - 0% open · ⏱️ 09.02.2022):
...
- [GitHub](https://github.com/google/neural-tangents) (👨‍💻 22 · 🔀 190 · 📥 200 · 📦 30 · 📋 110 - 34% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/google/neural-tangents
	```
- [PyPi](https://pypi.org/project/neural-tangents) (📥 980 / month · 📦 1 · ⏱️ 23.02.2022):
	```
...
- [GitHub](https://github.com/google/objax) (👨‍💻 22 · 🔀 59 · 📦 18 · 📋 100 - 44% open · ⏱️ 01.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/objax) (📥 510 / month · 📦 2 · ⏱️ 31.01.2022):
	```
	pip install objax
	```
</details>
...
- [GitHub](https://github.com/pytorchbearer/torchbearer) (👨‍💻 13 · 🔀 68 · 📦 59 · 📋 240 - 3% open · ⏱️ 26.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/torchbearer) (📥 980 / month · 📦 4 · ⏱️ 31.01.2020):
	```
...
- [GitHub](https://github.com/neoml-lib/neoml) (👨‍💻 29 · 🔀 100 · 📋 72 - 38% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/neoml-lib/neoml
	```
- [PyPi](https://pypi.org/project/neoml) (📥 260 / month · ⏱️ 21.06.2021):
	```
	pip install neoml
	```
</details>
<details><summary><b><a href="https://github.com/poets-ai/elegy">elegy</a></b> (🥉20 ·  ⭐ 330) - A High Level API for Deep Learning in JAX. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/poets-ai/elegy) (👨‍💻 15 · 🔀 21 · 📋 87 - 27% open · ⏱️ 23.02.2022):

	```
	git clone https://github.com/poets-ai/elegy
	```
- [PyPi](https://pypi.org/project/elegy) (📥 1.2K / month · ⏱️ 23.02.2022):
	```
	pip install elegy
	```
</details>
...
- <b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉29 ·  ⭐ 6K) - In-Database Machine Learning. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/towhee-io/towhee">Towhee</a></b> (🥉23 ·  ⭐ 290) - Towhee is an framework that helps you encode your unstructured data.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/matplotlib/matplotlib) (👨‍💻 1.3K · 🔀 6.2K · 📦 510K · 📋 8.6K - 20% open · ⏱️ 03.03.2022):
...
<details><summary><b><a href="https://github.com/mwaskom/seaborn">Seaborn</a></b> (🥇40 ·  ⭐ 9.2K) - Statistical data visualization in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 160 · 🔀 1.5K · 📥 210 · 📦 140K · 📋 2K - 5% open · ⏱️ 18.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 7.4M / month · 📦 8.8K · ⏱️ 16.08.2021):
	```
	pip install seaborn
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 140 · 🔀 630 · 📦 23K · 📋 1.6K - 15% open · ⏱️ 24.02.2022):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 5.4M / month · 📦 340 · ⏱️ 29.12.2021):
	```
	pip install altair
	```
...
- [GitHub](https://github.com/plotly/dash) (👨‍💻 110 · 🔀 1.6K · 📦 180 · 📋 1.2K - 48% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/plotly/dash
	```
- [PyPi](https://pypi.org/project/dash) (📥 860K / month · 📦 1.2K · ⏱️ 18.02.2022):
	```
	pip install dash
	```
...
<details><summary><b><a href="https://github.com/ydataai/pandas-profiling">pandas-profiling</a></b> (🥈36 ·  ⭐ 8.6K) - Create HTML profiling reports from pandas DataFrame.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/lmcinnes/umap) (👨‍💻 98 · 🔀 610 · 📦 4.7K · 📋 600 - 52% open · ⏱️ 10.02.2022):
...
- [PyPi](https://pypi.org/project/umap-learn) (📥 1M / month · 📦 290 · ⏱️ 29.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/umap-learn) (📥 910K · ⏱️ 15.01.2022):
	```
...
- [GitHub](https://github.com/pyecharts/pyecharts) (👨‍💻 30 · 🔀 2.6K · 📦 2.1K · 📋 1.5K - 2% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyecharts) (📥 43K / month · 📦 210 · ⏱️ 16.11.2021):
	```
	pip install pyecharts
	```
</details>
<details><summary><b><a href="https://github.com/xflr6/graphviz">Graphviz</a></b> (🥈35 ·  ⭐ 1.1K · 📉) - Simple Python interface for Graphviz. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/xflr6/graphviz) (👨‍💻 18 · 🔀 170 · 📦 29K · 📋 130 - 4% open · ⏱️ 20.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/graphviz) (📥 9.7M / month · 📦 2.9K · ⏱️ 12.12.2021):
	```
...
- [GitHub](https://github.com/pyqtgraph/pyqtgraph) (👨‍💻 220 · 🔀 900 · 📋 990 - 31% open · ⏱️ 22.02.2022):

	```
	git clone https://github.com/pyqtgraph/pyqtgraph
	```
- [PyPi](https://pypi.org/project/pyqtgraph) (📥 82K / month · 📦 760 · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/holoviz/holoviews) (👨‍💻 120 · 🔀 350 · 📋 2.8K - 30% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/holoviz/holoviews
	```
- [PyPi](https://pypi.org/project/holoviews) (📥 260K / month · 📦 200 · ⏱️ 22.02.2022):
	```
...
- [GitHub](https://github.com/amueller/word_cloud) (👨‍💻 64 · 🔀 2.1K · 📋 480 - 23% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/wordcloud) (📥 640K / month · 📦 710 · ⏱️ 11.11.2020):
	```
...
<details><summary><b><a href="https://github.com/finos/perspective">Perspective</a></b> (🥈32 ·  ⭐ 4.2K) - A data visualization and analytics component, especially.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 170 · 🔀 580 · 📦 690 · 📋 1.3K - 21% open · ⏱️ 08.02.2022):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 45K / month · 📦 94 · ⏱️ 04.02.2022):
	```
	pip install vispy
	```
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 72 · 🔀 220 · 📥 520 · 📦 620 · 📋 720 - 28% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pyvista/pyvista
	```
- [PyPi](https://pypi.org/project/pyvista) (📥 51K / month · 📦 89 · ⏱️ 24.02.2022):
	```
	pip install pyvista
	```
...
- [GitHub](https://github.com/ResidentMario/missingno) (👨‍💻 17 · 🔀 390 · 📦 6.4K · 📋 120 - 4% open · ⏱️ 27.02.2022):
...
<details><summary><b><a href="https://github.com/voxel51/fiftyone">FiftyOne</a></b> (🥈31 ·  ⭐ 1.1K) - Visualize, create, and debug image and video datasets.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/man-group/dtale">D-Tale</a></b> (🥉30 ·  ⭐ 3.2K) - Visualizer for pandas data structures. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 22 · 🔀 240 · 📦 300 · 📋 450 - 10% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/dtale) (📥 68K / month · 📦 11 · ⏱️ 20.02.2022):
	```
	pip install dtale
	```
...
- [GitHub](https://github.com/holoviz/datashader) (👨‍💻 46 · 🔀 330 · 📦 970 · 📋 490 - 26% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/holoviz/datashader
	```
- [PyPi](https://pypi.org/project/datashader) (📥 38K / month · 📦 74 · ⏱️ 09.06.2021):
	```
...
<details><summary><b><a href="https://github.com/tensorflow/data-validation">data-validation</a></b> (🥉29 ·  ⭐ 610) - Library for exploring and validating machine learning.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/data-validation) (👨‍💻 23 · 🔀 120 · 📥 300 · 📦 430 · 📋 150 - 24% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/tensorflow/data-validation
	```
- [PyPi](https://pypi.org/project/tensorflow-data-validation) (📥 1.4M / month · 📦 27 · ⏱️ 02.03.2022):
	```
...
- [GitHub](https://github.com/ContextLab/hypertools) (👨‍💻 21 · 🔀 160 · 📥 12 · 📦 170 · 📋 190 - 35% open · ⏱️ 12.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/hypertools) (📥 1.2K / month · 📦 10 · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 16 · 🔀 32 · 📥 200 · 📦 14 · 📋 230 - 30% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/JetBrains/lets-plot
	```
- [PyPi](https://pypi.org/project/lets-plot) (📥 6.6K / month · 📦 1 · ⏱️ 10.12.2021):
	```
...
<details><summary><b><a href="https://github.com/jupyter-widgets/pythreejs">pythreejs</a></b> (🥉25 ·  ⭐ 790) - A Jupyter - Three.js bridge. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/pavlin-policar/openTSNE">openTSNE</a></b> (🥉24 ·  ⭐ 950) - Extensible, parallel implementations of t-SNE. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/AutoViML/AutoViz">AutoViz</a></b> (🥉24 ·  ⭐ 650) - Automatically Visualize any dataset, any size with a single line of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/AutoViML/AutoViz) (👨‍💻 11 · 🔀 98 · 📦 140 · 📋 51 - 11% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/AutoViML/AutoViz
	```
- [PyPi](https://pypi.org/project/autoviz) (📥 42K / month · 📦 5 · ⏱️ 13.02.2022):
	```
	pip install autoviz
	```
- [Conda](https://anaconda.org/conda-forge/autoviz) (📥 2.6K · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/SauceCat/PDPbox) (👨‍💻 7 · 🔀 110 · 📦 480 · 📋 58 - 34% open · ⏱️ 14.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdpbox) (📥 36K / month · 📦 25 · ⏱️ 14.03.2021):
	```
	pip install pdpbox
	```
...
<details><summary><b><a href="https://github.com/marcharper/python-ternary">python-ternary</a></b> (🥉22 ·  ⭐ 520) - Ternary plotting library for python with matplotlib. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/leotac/joypy">joypy</a></b> (🥉22 ·  ⭐ 400) - Joyplots in Python with matplotlib & pandas. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/leotac/joypy) (👨‍💻 6 · 🔀 45 · 📦 130 · 📋 48 - 22% open · ⏱️ 19.12.2021):
...
<details><summary><b><a href="https://github.com/gyli/PyWaffle">PyWaffle</a></b> (🥉20 ·  ⭐ 470) - Make Waffle Charts in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gyli/PyWaffle) (👨‍💻 6 · 🔀 83 · 📦 110 · 📋 16 - 25% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pywaffle) (📥 3.2K / month · 📦 1 · ⏱️ 21.12.2021):
	```
...
<details><summary><b><a href="https://github.com/huggingface/transformers">transformers</a></b> (🥇48 ·  ⭐ 59K) - Transformers: State-of-the-art Machine Learning for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/huggingface/transformers) (👨‍💻 1.2K · 🔀 14K · 📥 1.4K · 📦 23K · 📋 8.9K - 4% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/huggingface/transformers
	```
- [PyPi](https://pypi.org/project/transformers) (📥 4.3M / month · 📦 760 · ⏱️ 31.01.2022):
	```
...
- [GitHub](https://github.com/nltk/nltk) (👨‍💻 410 · 🔀 2.6K · 📦 130K · 📋 1.6K - 13% open · ⏱️ 01.03.2022):
...
- [GitHub](https://github.com/explosion/spaCy) (👨‍💻 660 · 🔀 3.7K · 📥 3.1K · 📦 36K · 📋 5.1K - 1% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/explosion/spaCy
	```
- [PyPi](https://pypi.org/project/spacy) (📥 4.4M / month · 📦 2.3K · ⏱️ 11.02.2022):
	```
	pip install spacy
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 420 · 🔀 4.1K · 📥 3.5K · 📦 31K · 📋 1.7K - 21% open · ⏱️ 26.02.2022):

	```
	git clone https://github.com/RaRe-Technologies/gensim
	```
- [PyPi](https://pypi.org/project/gensim) (📥 5.1M / month · 📦 2.8K · ⏱️ 17.09.2021):
	```
	pip install gensim
	```
...
- [GitHub](https://github.com/RasaHQ/rasa) (👨‍💻 530 · 🔀 3.9K · 📋 6.6K - 14% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/RasaHQ/rasa
	```
- [PyPi](https://pypi.org/project/rasa) (📥 250K / month · 📦 57 · ⏱️ 11.02.2022):
	```
	pip install rasa
	```
</details>
...
- [GitHub](https://github.com/flairNLP/flair) (👨‍💻 220 · 🔀 1.8K · 📦 1.2K · 📋 1.8K - 4% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/flairNLP/flair
	```
- [PyPi](https://pypi.org/project/flair) (📥 80K / month · 📦 66 · ⏱️ 18.11.2021):
	```
	pip install flair
	```
- [Conda](https://anaconda.org/conda-forge/python-flair) (📥 6.8K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/allenai/allennlp) (👨‍💻 260 · 🔀 2.2K · 📥 44 · 📦 2.3K · 📋 2.5K - 4% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/allenai/allennlp
	```
- [PyPi](https://pypi.org/project/allennlp) (📥 44K / month · 📦 180 · ⏱️ 27.01.2022):
	```
	pip install allennlp
	```
- [Conda](https://anaconda.org/conda-forge/allennlp) (📥 41K · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/pytorch/fairseq) (👨‍💻 380 · 🔀 4.1K · 📥 180 · 📦 680 · 📋 3.2K - 36% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/fairseq) (📥 50K / month · 📦 28 · ⏱️ 05.01.2021):
	```
	pip install fairseq
	```
...
- [GitHub](https://github.com/facebookresearch/ParlAI) (👨‍💻 180 · 🔀 1.7K · 📦 61 · 📋 1.3K - 7% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/facebookresearch/ParlAI
	```
- [PyPi](https://pypi.org/project/parlai) (📥 3.1K / month · 📦 3 · ⏱️ 12.10.2021):
	```
	pip install parlai
	```
</details>
<details><summary><b><a href="https://github.com/UKPLab/sentence-transformers">sentence-transformers</a></b> (🥇35 ·  ⭐ 7.2K) - Multilingual Sentence & Image Embeddings with BERT. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/UKPLab/sentence-transformers) (👨‍💻 74 · 🔀 1.4K · 📦 2.5K · 📋 1.3K - 50% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/sentence-transformers) (📥 780K / month · 📦 95 · ⏱️ 01.10.2021):
	```
	pip install sentence-transformers
	```
- [Conda](https://anaconda.org/conda-forge/sentence-transformers) (📥 15K · ⏱️ 20.02.2022):
	```
...
- [GitHub](https://github.com/sloria/TextBlob) (👨‍💻 35 · 🔀 1.1K · 📥 97 · 📦 18K · 📋 260 - 39% open · ⏱️ 22.10.2021):
...
<details><summary><b><a href="https://github.com/huggingface/tokenizers">Tokenizers</a></b> (🥈34 ·  ⭐ 5.3K) - Fast State-of-the-Art Tokenizers optimized for Research and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 53 · 🔀 440 · 📦 42 · 📋 600 - 30% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/huggingface/tokenizers
	```
- [PyPi](https://pypi.org/project/tokenizers) (📥 5.1M / month · 📦 97 · ⏱️ 28.02.2022):
	```
...
- [GitHub](https://github.com/JohnSnowLabs/spark-nlp) (👨‍💻 110 · 🔀 530 · 📋 660 - 13% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/JohnSnowLabs/spark-nlp
	```
- [PyPi](https://pypi.org/project/spark-nlp) (📥 2.7M / month · 📦 9 · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/fastText) (👨‍💻 59 · 🔀 4.4K · 📦 2.6K · 📋 1.1K - 43% open · ⏱️ 22.02.2022):

	```
	git clone https://github.com/facebookresearch/fastText
	```
- [PyPi](https://pypi.org/project/fasttext) (📥 450K / month · 📦 160 · ⏱️ 28.04.2020):
	```
...
- [GitHub](https://github.com/google/sentencepiece) (👨‍💻 62 · 🔀 790 · 📥 20K · 📦 13K · 📋 530 - 11% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/google/sentencepiece
	```
- [PyPi](https://pypi.org/project/sentencepiece) (📥 4.8M / month · 📦 350 · ⏱️ 18.06.2021):
	```
...
- [GitHub](https://github.com/dedupeio/dedupe) (👨‍💻 63 · 🔀 460 · 📦 220 · 📋 700 - 4% open · ⏱️ 27.02.2022):

	```
	git clone https://github.com/dedupeio/dedupe
	```
- [PyPi](https://pypi.org/project/dedupe) (📥 300K / month · 📦 47 · ⏱️ 03.02.2022):
	```
	pip install dedupe
	```
- [Conda](https://anaconda.org/conda-forge/dedupe) (📥 1.6K · ⏱️ 04.02.2022):
	```
...
- [GitHub](https://github.com/pytorch/text) (👨‍💻 120 · 🔀 680 · 📋 690 - 46% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 41 · 🔀 760 · 📦 880 · 📋 650 - 11% open · ⏱️ 26.01.2022):
...
<details><summary><b><a href="https://github.com/OpenNMT/OpenNMT-py">OpenNMT</a></b> (🥈32 ·  ⭐ 5.5K) - Open Source Neural Machine Translation in PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/OpenNMT/OpenNMT-py) (👨‍💻 170 · 🔀 2K · 📦 130 · 📋 1.3K - 9% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/OpenNMT-py) (📥 17K / month · 📦 8 · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/tensorflow/text) (👨‍💻 75 · 🔀 180 · 📦 1.5K · 📋 190 - 35% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/tensorflow/text
	```
- [PyPi](https://pypi.org/project/tensorflow-text) (📥 2.3M / month · 📦 69 · ⏱️ 04.02.2022):
	```
...
<details><summary><b><a href="https://github.com/deepset-ai/haystack">haystack</a></b> (🥈30 ·  ⭐ 4.3K · 📈) - Haystack is an open source NLP framework that leverages.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 99 · 🔀 680 · 📥 7 · 📋 1.2K - 15% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/deepset-ai/haystack
	```
- [PyPi](https://pypi.org/project/haystack) (📥 1.3K / month · 📦 85 · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/NVIDIA/NeMo) (👨‍💻 130 · 🔀 860 · 📥 6.3K · 📋 1K - 7% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/NVIDIA/NeMo
	```
- [PyPi](https://pypi.org/project/nemo-toolkit) (📥 14K / month · 📦 7 · ⏱️ 05.02.2022):
	```
	pip install nemo-toolkit
	```
</details>
<details><summary><b><a href="https://github.com/chartbeat-labs/textacy">textacy</a></b> (🥈30 ·  ⭐ 1.9K) - NLP, before and after spaCy. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/chartbeat-labs/textacy) (👨‍💻 31 · 🔀 230 · 📋 250 - 11% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/chartbeat-labs/textacy
	```
- [PyPi](https://pypi.org/project/textacy) (📥 47K / month · 📦 100 · ⏱️ 06.12.2021):
	```
	pip install textacy
	```
...
<details><summary><b><a href="https://github.com/makcedward/nlpaug">nlpaug</a></b> (🥈29 ·  ⭐ 3K) - Data augmentation for NLP. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/cltk/cltk) (👨‍💻 110 · 🔀 310 · 📥 25 · 📦 190 · 📋 520 - 4% open · ⏱️ 11.02.2022):

	```
	git clone https://github.com/cltk/cltk
	```
- [PyPi](https://pypi.org/project/cltk) (📥 5.5K / month · 📦 42 · ⏱️ 11.02.2022):
	```
	pip install cltk
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 220 · 🔀 800 · 📥 290 · 📦 100 · 📋 220 - 66% open · ⏱️ 01.03.2022):
...
- [GitHub](https://github.com/google-research/text-to-text-transfer-transformer) (👨‍💻 45 · 🔀 550 · 📦 86 · 📋 400 - 16% open · ⏱️ 23.02.2022):
...
- [PyPi](https://pypi.org/project/sumy) (📥 25K / month · 📦 100 · ⏱️ 21.10.2021):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 640 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/dmlc/gluon-nlp) (👨‍💻 82 · 🔀 520 · 📦 730 · 📋 560 - 46% open · ⏱️ 24.08.2021):
...
<details><summary><b><a href="https://github.com/DerwenAI/pytextrank">PyTextRank</a></b> (🥈28 ·  ⭐ 1.8K) - Python implementation of TextRank for phrase extraction and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/DerwenAI/pytextrank) (👨‍💻 18 · 🔀 320 · 📦 240 · 📋 83 - 27% open · ⏱️ 04.02.2022):

	```
	git clone https://github.com/DerwenAI/pytextrank
	```
- [PyPi](https://pypi.org/project/pytextrank) (📥 25K / month · 📦 12 · ⏱️ 10.10.2021):
	```
	pip install pytextrank
	```
</details>
<details><summary><b><a href="https://github.com/allenai/scispacy">SciSpacy</a></b> (🥈28 ·  ⭐ 1.1K · 📈) - A full spaCy pipeline and models for scientific/biomedical.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/allenai/scispacy) (👨‍💻 23 · 🔀 150 · 📦 410 · 📋 240 - 14% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/scispacy) (📥 29K / month · 📦 11 · ⏱️ 12.02.2021):
	```
...
- [GitHub](https://github.com/cjhutto/vaderSentiment) (👨‍💻 10 · 🔀 830 · 📦 3.5K · 📋 110 - 30% open · ⏱️ 15.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/vadersentiment) (📥 350K / month · 📦 170 · ⏱️ 22.05.2020):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 11 · 🔀 210 · 📥 500 · 📦 1.8K · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 300K / month · 📦 39 · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/huggingface/neuralcoref) (👨‍💻 21 · 🔀 430 · 📥 330 · 📦 450 · 📋 290 - 16% open · ⏱️ 22.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/neuralcoref) (📥 39K / month · 📦 14 · ⏱️ 08.04.2019):
	```
...
<details><summary><b><a href="https://github.com/dwyl/english-words">english-words</a></b> (🥉26 ·  ⭐ 6.7K) - A text file containing 479k English words for all your.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 240 · 📦 330 · 📋 67 - 26% open · ⏱️ 10.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-nlp) (📥 9K / month · 📦 17 · ⏱️ 04.11.2019):
	```
...
- [GitHub](https://github.com/JasonKessler/scattertext) (👨‍💻 12 · 🔀 240 · 📦 260 · 📋 85 - 20% open · ⏱️ 15.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/scattertext) (📥 8.8K / month · 📦 10 · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/explosion/spacy-transformers) (👨‍💻 18 · 🔀 140 · 📦 410 · ⏱️ 13.01.2022):

	```
	git clone https://github.com/explosion/spacy-transformers
	```
- [PyPi](https://pypi.org/project/spacy-transformers) (📥 93K / month · 📦 13 · ⏱️ 14.01.2022):
	```
	pip install spacy-transformers
	```
- [Conda](https://anaconda.org/conda-forge/spacy-transformers) (📥 480 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/snipsco/snips-nlu) (👨‍💻 22 · 🔀 500 · 📋 260 - 23% open · ⏱️ 03.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/snips-nlu) (📥 4K / month · 📦 11 · ⏱️ 15.01.2020):
	```
...
- [GitHub](https://github.com/NTMC-Community/MatchZoo) (👨‍💻 36 · 🔀 910 · 📦 10 · 📋 460 - 6% open · ⏱️ 02.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/matchzoo) (📥 190 / month · ⏱️ 24.10.2019):
	```
...
- [GitHub](https://github.com/fastnlp/fastNLP) (👨‍💻 54 · 🔀 400 · 📥 65 · 📦 61 · 📋 180 - 19% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastnlp) (📥 1.5K / month · 📦 3 · ⏱️ 04.02.2019):
	```
	pip install fastnlp
	```
</details>
...
- [GitHub](https://github.com/BrikerMan/Kashgari) (👨‍💻 21 · 🔀 430 · 📦 50 · 📋 360 - 10% open · ⏱️ 09.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/kashgari-tf) (📥 340 / month · 📦 2 · ⏱️ 18.10.2019):
	```
...
- [GitHub](https://github.com/awslabs/sockeye) (👨‍💻 56 · 🔀 310 · 📥 14 · 📋 280 - 4% open · ⏱️ 22.02.2022):

	```
	git clone https://github.com/awslabs/sockeye
	```
- [PyPi](https://pypi.org/project/sockeye) (📥 2.7K / month · 📦 2 · ⏱️ 28.02.2022):
	```
	pip install sockeye
	```
</details>
...
- [GitHub](https://github.com/bytedance/lightseq) (👨‍💻 8 · 🔀 210 · 📥 580 · 📋 150 - 52% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/bytedance/lightseq
	```
- [PyPi](https://pypi.org/project/lightseq) (📥 2.6K / month · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 17 · 🔀 220 · 📥 25K · 📦 120 · 📋 110 - 17% open · ⏱️ 16.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/sense2vec) (📥 6.3K / month · 📦 8 · ⏱️ 19.04.2021):
	```
...
<details><summary><b><a href="https://github.com/recognai/rubrix">rubrix</a></b> (🥉23 ·  ⭐ 880) - Python framework for data-centric NLP. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/recognai/rubrix) (👨‍💻 18 · 🔀 76 · 📋 440 - 16% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/recognai/rubrix
	```
- [PyPi](https://pypi.org/project/rubrix) (📥 2.6K / month · ⏱️ 19.02.2022):
	```
	pip install rubrix
	```
- [Conda](https://anaconda.org/conda-forge/rubrix) (📥 290 · ⏱️ 23.02.2022):
	```
...
- [GitHub](https://github.com/minimaxir/gpt-2-simple) (👨‍💻 18 · 🔀 590 · 📥 290 · 📋 240 - 61% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/gpt-2-simple) (📥 6.3K / month · 📦 5 · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/jbesomi/texthero) (👨‍💻 18 · 🔀 210 · 📥 89 · 📋 140 - 56% open · ⏱️ 19.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/texthero) (📥 35K / month · 📦 4 · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/utterworks/fast-bert) (👨‍💻 35 · 🔀 330 · 📋 250 - 61% open · ⏱️ 10.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/fast-bert) (📥 2.1K / month · 📦 2 · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/deepset-ai/FARM) (👨‍💻 37 · 🔀 210 · 📋 430 - 8% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/farm) (📥 4.8K / month · 📦 2 · ⏱️ 10.06.2021):
	```
	pip install farm
	```
- [Conda](https://anaconda.org/conda-forge/farm) (📥 920 · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/anhaidgroup/deepmatcher) (👨‍💻 7 · 🔀 1.5K · 📦 14 · 📋 78 - 71% open · ⏱️ 13.06.2021):
...
<details><summary><b><a href="https://github.com/thunlp/OpenPrompt">OpenPrompt</a></b> (🥉21 ·  ⭐ 1.2K · 🐣) - An Open-Source Framework for Prompt-Learning. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/thunlp/OpenPrompt) (👨‍💻 11 · 🔀 120 · 📦 7 · 📋 98 - 22% open · ⏱️ 21.02.2022):

	```
	git clone https://github.com/thunlp/OpenPrompt
	```
- [PyPi](https://pypi.org/project/openprompt) (📥 420 / month · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/IndicoDataSolutions/finetune) (👨‍💻 19 · 🔀 71 · 📦 9 · 📋 140 - 15% open · ⏱️ 20.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/finetune) (📥 420 / month · 📦 2 · ⏱️ 20.12.2021):
	```
...
- [GitHub](https://github.com/qdrant/qdrant) (👨‍💻 22 · 🔀 73 · 📋 110 - 30% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/qdrant/qdrant
	```
</details>
<details><summary><b><a href="https://github.com/unitaryai/detoxify">detoxify</a></b> (🥉20 ·  ⭐ 380) - Trained models & code to predict toxic comments on all 3 Jigsaw.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/unitaryai/detoxify) (👨‍💻 4 · 🔀 42 · 📥 34K · 📦 41 · 📋 25 - 44% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/unitaryai/detoxify
	```
- [PyPi](https://pypi.org/project/detoxify) (📥 5.7K / month · 📦 1 · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/RUCAIBox/TextBox) (👨‍💻 13 · 🔀 59 · 📦 5 · 📋 18 - 16% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/textbox) (📥 62 / month · ⏱️ 15.04.2021):
	```
	pip install textbox
	```
</details>
...
- [GitHub](https://github.com/PKSHATechnology-Research/camphr) (👨‍💻 7 · 🔀 17 · 📋 28 - 7% open · ⏱️ 18.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/camphr) (📥 1.9K / month · 📦 2 · ⏱️ 28.07.2021):
	```
	pip install camphr
	```
</details>
<details><summary><b><a href="https://github.com/thunlp/OpenNRE">OpenNRE</a></b> (🥉16 ·  ⭐ 3.5K) - An Open-Source Package for Neural Relation Extraction (NRE). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/facebookresearch/vizseq">VizSeq</a></b> (🥉16 ·  ⭐ 380) - An Analysis Toolkit for Natural Language Generation (Translation,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/vizseq) (👨‍💻 3 · 🔀 46 · 📦 5 · 📋 16 - 43% open · ⏱️ 28.02.2022):
...
<details><summary><b><a href="https://github.com/facebookresearch/BLINK">BLINK</a></b> (🥉15 ·  ⭐ 820 · 💤) - Entity Linker solution. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pytorch/translate) (👨‍💻 87 · 🔀 180 · 📋 93 - 70% open · ⏱️ 06.10.2021):
...
- <b><a href="https://github.com/Ki6an/fastT5">fastT5</a></b> (🥉18 ·  ⭐ 260) - boost inference speed of T5 models by 5x & reduce the model size by 3x. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/MartinoMensio/spacy-dbpedia-spotlight">spacy-dbpedia-spotlight</a></b> (🥉9 ·  ⭐ 52) - A spaCy wrapper for DBpedia Spotlight. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>spacy</code>
</details>
<br>
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 390 · 🔀 1.8K · 📋 2.5K - 6% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/scikit-image/scikit-image) (👨‍💻 540 · 🔀 2K · 📦 95K · 📋 2.3K - 14% open · ⏱️ 01.03.2022):
...
- [GitHub](https://github.com/pytorch/vision) (👨‍💻 460 · 🔀 5.6K · 📋 2.3K - 28% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pytorch/vision
	```
- [PyPi](https://pypi.org/project/torchvision) (📥 3.3M / month · 📦 3.5K · ⏱️ 27.01.2022):
	```
...
- [GitHub](https://github.com/open-mmlab/mmdetection) (👨‍💻 320 · 🔀 6.7K · 📦 270 · 📋 5.3K - 9% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/open-mmlab/mmdetection
	```
- [PyPi](https://pypi.org/project/mmdet) (📥 39K / month · 📦 8 · ⏱️ 26.02.2022):
	```
	pip install mmdet
	```
</details>
...
- [GitHub](https://github.com/rwightman/pytorch-image-models) (👨‍💻 65 · 🔀 2.7K · 📥 950K · 📦 2.1K · 📋 470 - 14% open · ⏱️ 02.02.2022):

	```
	git clone https://github.com/rwightman/pytorch-image-models
	```
- [PyPi](https://pypi.org/project/timm) (📥 880K / month · 📦 67 · ⏱️ 17.01.2022):
	```
	pip install timm
	```
...
<details><summary><b><a href="https://github.com/Zulko/moviepy">MoviePy</a></b> (🥇36 ·  ⭐ 9K) - Video editing with Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Zulko/moviepy) (👨‍💻 140 · 🔀 1.2K · 📦 14K · 📋 1.2K - 28% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/moviepy) (📥 4M / month · 📦 720 · ⏱️ 15.12.2021):
	```
	pip install moviepy
	```
...
- [GitHub](https://github.com/imageio/imageio) (👨‍💻 87 · 🔀 200 · 📥 170 · 📦 57K · 📋 430 - 16% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/imageio/imageio
	```
- [PyPi](https://pypi.org/project/imageio) (📥 14M / month · 📦 2.6K · ⏱️ 28.02.2022):
	```
	pip install imageio
	```
...
<details><summary><b><a href="https://github.com/albumentations-team/albumentations">Albumentations</a></b> (🥈35 ·  ⭐ 9.8K) - Fast image augmentation library and an easy-to-use wrapper.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/albumentations-team/albumentations) (👨‍💻 100 · 🔀 1.2K · 📦 6.8K · 📋 580 - 40% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/albumentations-team/albumentations
	```
- [PyPi](https://pypi.org/project/albumentations) (📥 300K / month · 📦 180 · ⏱️ 04.10.2021):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥈35 ·  ⭐ 6K) - Open Source Differentiable Computer Vision Library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/kornia/kornia) (👨‍💻 150 · 🔀 590 · 📥 200 · 📦 1K · 📋 540 - 25% open · ⏱️ 28.02.2022):
...
- [PyPi](https://pypi.org/project/kornia) (📥 290K / month · 📦 44 · ⏱️ 31.01.2022):
	...
	pip install kornia
	```
- [Conda](https://anaconda.org/conda-forge/kornia) (📥 12K · ⏱️ 01.02.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/detectron2) (👨‍💻 200 · 🔀 5.4K · 📦 510 · 📋 2.9K - 5% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/opencv/opencv-python) (👨‍💻 36 · 🔀 500 · 📋 520 - 7% open · ⏱️ 25.01.2022):
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 97 · 🔀 190 · 📥 6.3K · 📦 9.5K · 📋 360 - 4% open · ⏱️ 31.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/wand) (📥 470K / month · 📦 680 · ⏱️ 17.08.2021):
	```
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 9K · ⏱️ 30.11.2020):
	```
	conda install -c conda-forge wand
	```
</details>
<details><summary><b><a href="https://github.com/ageitgey/face_recognition">Face Recognition</a></b> (🥈32 ·  ⭐ 43K · 💤) - The worlds simplest facial recognition api for Python.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 47 · 🔀 12K · 📥 450 · 📋 1.2K - 54% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 45K / month · 📦 210 · ⏱️ 21.08.2018):
	```
	pip install face_recognition
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 4.4K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/dmlc/gluon-cv) (👨‍💻 120 · 🔀 1.1K · 📦 680 · 📋 810 - 7% open · ⏱️ 18.02.2022):

	```
	git clone https://github.com/dmlc/gluon-cv
	```
- [PyPi](https://pypi.org/project/gluoncv) (📥 590K / month · 📦 59 · ⏱️ 03.03.2022):
	```
	pip install gluoncv
	```
</details>
...
- [GitHub](https://github.com/PaddlePaddle/PaddleSeg) (👨‍💻 75 · 🔀 850 · 📦 510 · 📋 910 - 50% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/paddleseg) (📥 1.7K / month · 📦 2 · ⏱️ 20.01.2022):
	```
	pip install paddleseg
	```
</details>
<details><summary><b><a href="https://github.com/serengil/deepface">deepface</a></b> (🥈31 ·  ⭐ 3.3K) - A Lightweight Face Recognition and Facial Attribute Analysis (Age,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/serengil/deepface) (👨‍💻 21 · 🔀 740 · 📦 440 · 📋 400 - 0% open · ⏱️ 16.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/deepface) (📥 27K / month · 📦 3 · ⏱️ 16.02.2022):
	```
...
- [GitHub](https://github.com/OlafenwaMoses/ImageAI) (👨‍💻 15 · 🔀 1.9K · 📥 720K · 📦 1K · 📋 680 - 36% open · ⏱️ 08.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/imageai) (📥 8.3K / month · 📦 16 · ⏱️ 05.01.2021):
	```
	pip install imageai
	```
...
<details><summary><b><a href="https://github.com/PaddlePaddle/PaddleDetection">PaddleDetection</a></b> (🥈30 ·  ⭐ 6.4K) - Object Detection toolkit based on PaddlePaddle. It.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/JohannesBuchner/imagehash) (👨‍💻 20 · 🔀 290 · 📦 4.4K · 📋 110 - 12% open · ⏱️ 07.09.2021):
...
<details><summary><b><a href="https://github.com/lucidrains/vit-pytorch">vit-pytorch</a></b> (🥉29 ·  ⭐ 8.8K) - Implementation of Vision Transformer, a simple way to achieve.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/lucidrains/vit-pytorch) (👨‍💻 14 · 🔀 1.4K · 📦 71 · 📋 170 - 48% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/vit-pytorch) (📥 13K / month · 📦 1 · ⏱️ 02.03.2022):
	```
...
- [GitHub](https://github.com/mdbloice/Augmentor) (👨‍💻 22 · 🔀 830 · 📦 420 · 📋 190 - 63% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/Augmentor) (📥 9.5K / month · 📦 29 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 9 · 🔀 170 · 📥 540 · 📦 170 · 📋 200 - 0% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 5.3K / month · 📦 5 · ⏱️ 11.02.2022):
	```
	pip install vidgear
	```
</details>
<details><summary><b><a href="https://github.com/obss/sahi">sahi</a></b> (🥉27 ·  ⭐ 1.2K) - A lightweight vision library for performing large scale object detection/.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/obss/sahi) (👨‍💻 8 · 🔀 160 · 📥 1 · 📦 22 · 📋 100 - 10% open · ⏱️ 22.02.2022):

	```
	git clone https://github.com/obss/sahi
	```
- [PyPi](https://pypi.org/project/sahi) (📥 14K / month · 📦 5 · ⏱️ 12.02.2022):
	```
	pip install sahi
	```
- [Conda](https://anaconda.org/conda-forge/sahi) (📥 1.5K · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/1adrianb/face-alignment) (👨‍💻 23 · 🔀 1.2K · 📋 270 - 19% open · ⏱️ 04.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/face-alignment) (📥 8.3K / month · 📦 8 · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/mmf) (👨‍💻 93 · 🔀 800 · 📦 11 · 📋 610 - 31% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/facebookresearch/mmf
	```
- [PyPi](https://pypi.org/project/mmf) (📥 1.3K / month · 📦 1 · ⏱️ 12.06.2020):
	```
	pip install mmf
	```
</details>
...
- [GitHub](https://github.com/ipazc/mtcnn) (👨‍💻 15 · 🔀 440 · 📦 2K · 📋 100 - 62% open · ⏱️ 09.07.2021):
...
- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 15 · 🔀 100 · 📦 31 · 📋 300 - 21% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/lightly) (📥 3.9K / month · 📦 1 · ⏱️ 01.03.2022):
	```
	pip install lightly
	```
</details>
...
- [GitHub](https://github.com/luispedro/mahotas) (👨‍💻 32 · 🔀 140 · 📦 770 · 📋 77 - 20% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/CellProfiler/CellProfiler) (👨‍💻 130 · 🔀 300 · 📥 2.3K · 📦 7 · 📋 3K - 6% open · ⏱️ 18.02.2022):
...
- [GitHub](https://github.com/facebookresearch/vissl) (👨‍💻 31 · 🔀 240 · 📦 5 · 📋 140 - 32% open · ⏱️ 28.02.2022):
...
- [GitHub](https://github.com/facebookresearch/pytorchvideo) (👨‍💻 27 · 🔀 220 · 📋 130 - 41% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/lucidrains/deep-daze) (👨‍💻 13 · 🔀 290 · 📦 34 · 📋 160 - 54% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/deep-daze) (📥 9.4K / month · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/idealo/image-super-resolution) (👨‍💻 10 · 🔀 600 · 📦 73 · 📋 190 - 43% open · ⏱️ 02.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/ISR) (📥 5.5K / month · 📦 5 · ⏱️ 08.01.2020):
	```
	pip install ISR
	```
...
- [GitHub](https://github.com/Layout-Parser/layout-parser) (👨‍💻 8 · 🔀 270 · 📦 48 · 📋 80 - 52% open · ⏱️ 02.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/layoutparser) (📥 5.5K / month · 📦 1 · ⏱️ 23.09.2021):
	```
...
- [GitHub](https://github.com/timesler/facenet-pytorch) (👨‍💻 14 · 🔀 580 · 📥 210K · 📦 660 · 📋 150 - 38% open · ⏱️ 13.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/facenet-pytorch) (📥 15K / month · 📦 7 · ⏱️ 10.03.2021):
	```
...
<details><summary><b><a href="https://github.com/airctic/icevision">icevision</a></b> (🥉24 ·  ⭐ 620) - An Agnostic Computer Vision Framework - Pluggable to any Training.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/airctic/icevision) (👨‍💻 36 · 🔀 86 · 📋 620 - 21% open · ⏱️ 26.02.2022):
...
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉23 ·  ⭐ 390) - python binding for libvips using cffi. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/facebookresearch/ClassyVision) (👨‍💻 69 · 🔀 240 · 📋 110 - 46% open · ⏱️ 03.03.2022):
...
- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 10 · 🔀 110 · 📥 27 · 📋 45 - 28% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/tryolabs/norfair
	```
- [PyPi](https://pypi.org/project/norfair) (📥 4.1K / month · 📦 1 · ⏱️ 15.02.2022):
	```
	pip install norfair
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/SlowFast">PySlowFast</a></b> (🥉20 ·  ⭐ 4.6K) - PySlowFast: video understanding codebase from FAIR for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/facebookresearch/SlowFast) (👨‍💻 25 · 🔀 880 · 📦 6 · 📋 490 - 50% open · ⏱️ 28.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyslowfast) (📥 26 / month · ⏱️ 15.01.2020):
	```
...
- [GitHub](https://github.com/facebookresearch/pycls) (👨‍💻 13 · 🔀 210 · 📦 5 · 📋 77 - 27% open · ⏱️ 19.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/pycls) (📥 610 / month · ⏱️ 05.09.2020):
	```
	pip install pycls
	```
</details>
...
<details><summary><b><a href="https://github.com/jasmcaus/caer">Caer</a></b> (🥉18 ·  ⭐ 600) - A lightweight Computer Vision library. Scale your models, not boilerplate. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jasmcaus/caer) (👨‍💻 8 · 🔀 100 · 📥 19 · 📋 15 - 13% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/caer) (📥 5.5K / month · 📦 1 · ⏱️ 13.10.2021):
	```
	pip install caer
	```
</details>
<details><summary><b><a href="https://github.com/google-research/scenic">scenic</a></b> (🥉17 ·  ⭐ 750) - Scenic: A Jax Library for Computer Vision Research and Beyond. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google-research/scenic) (👨‍💻 24 · 🔀 83 · 📦 9 · 📋 25 - 24% open · ⏱️ 03.03.2022):
...
- <b><a href="https://github.com/glfw/glfw">glfw</a></b> (🥈34 ·  ⭐ 8.7K) - A multi-platform library for OpenGL, OpenGL ES, Vulkan, window and input. <code><a href="https://tldrlegal.com/search?q=Zlib">❗️Zlib</a></code>
- <b><a href="https://github.com/uploadcare/pillow-simd">Pillow-SIMD</a></b> (🥈31 ·  ⭐ 1.8K) - The friendly PIL fork. <code><a href="https://tldrlegal.com/search?q=PIL">❗️PIL</a></code>
- <b><a href="https://github.com/facebookresearch/pytorch3d">PyTorch3D</a></b> (🥉28 ·  ⭐ 5.7K) - PyTorch3D is FAIRs library of reusable components for.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/hhatto/nude.py">nude.py</a></b> (🥉22 ·  ⭐ 840 · 💀) - Nudity detection with Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/qanastek/HugsVision">HugsVision</a></b> (🥉15 ·  ⭐ 150) - HugsVision is a easy to use huggingface wrapper for state-of-the-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>huggingface</code>
...
<details><summary><b><a href="https://github.com/networkx/networkx">networkx</a></b> (🥇43 ·  ⭐ 10K · 📉) - Network Analysis in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/networkx/networkx) (👨‍💻 570 · 🔀 2.5K · 📥 57 · 📦 100K · 📋 2.8K - 11% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/networkx/networkx
	```
- [PyPi](https://pypi.org/project/networkx) (📥 16M / month · 📦 13K · ⏱️ 28.02.2022):
	```
	pip install networkx
	```
- [Conda](https://anaconda.org/conda-forge/networkx) (📥 5.6M · ⏱️ 01.03.2022):
	```
	conda install -c conda-forge networkx
	```
</details>
<details><summary><b><a href="https://github.com/dmlc/dgl">dgl</a></b> (🥇36 ·  ⭐ 9K) - Python package built to ease deep learning on graph, on top of existing DL.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dmlc/dgl) (👨‍💻 190 · 🔀 2K · 📋 1.4K - 22% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/dmlc/dgl
	```
- [PyPi](https://pypi.org/project/dgl) (📥 72K / month · 📦 40 · ⏱️ 27.05.2021):
	```
	pip install dgl
	```
</details>
...
- [GitHub](https://github.com/pyg-team/pytorch_geometric) (👨‍💻 250 · 🔀 2.5K · 📋 2.5K - 38% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pyg-team/pytorch_geometric
	```
- [PyPi](https://pypi.org/project/torch-geometric) (📥 49K / month · 📦 36 · ⏱️ 22.12.2021):
	```
	pip install torch-geometric
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_geometric) (📥 5.7K · ⏱️ 19.01.2022):
	```
...
- [GitHub](https://github.com/stellargraph/stellargraph) (👨‍💻 36 · 🔀 340 · 📦 120 · 📋 990 - 25% open · ⏱️ 29.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/stellargraph) (📥 19K / month · 📦 3 · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 19 · 🔀 270 · 📦 240 · 📋 190 - 2% open · ⏱️ 23.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ogb) (📥 41K / month · 📦 13 · ⏱️ 23.02.2022):
	```
	pip install ogb
	```
- [Conda](https://anaconda.org/conda-forge/ogb) (📥 6.7K · ⏱️ 23.02.2022):
	```
	conda install -c conda-forge ogb
	```
</details>
<details><summary><b><a href="https://github.com/pykeen/pykeen">PyKEEN</a></b> (🥈26 ·  ⭐ 730) - A Python library for learning and evaluating knowledge graph embeddings. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pykeen/pykeen) (👨‍💻 24 · 🔀 100 · 📥 93 · 📋 360 - 31% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pykeen/pykeen
	```
- [PyPi](https://pypi.org/project/pykeen) (📥 1.5K / month · 📦 3 · ⏱️ 11.01.2022):
	```
	pip install pykeen
	```
</details>
...
- [GitHub](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) (👨‍💻 19 · 🔀 200 · 📋 84 - 3% open · ⏱️ 19.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/torch-geometric-temporal) (📥 1.9K / month · 📦 1 · ⏱️ 10.02.2022):
	```
	pip install torch-geometric-temporal
	```
</details>
<details><summary><b><a href="https://github.com/PaddlePaddle/PGL">Paddle Graph Learning</a></b> (🥈25 ·  ⭐ 1.2K) - Paddle Graph Learning (PGL) is an efficient and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PaddlePaddle/PGL) (👨‍💻 21 · 🔀 200 · 📦 24 · 📋 100 - 36% open · ⏱️ 29.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pgl) (📥 2.5K / month · 📦 2 · ⏱️ 20.12.2021):
	```
	pip install pgl
	```
</details>
<details><summary><b><a href="https://github.com/graph4ai/graph4nlp">graph4nlp</a></b> (🥈25 ·  ⭐ 1.2K) - Graph4nlp is the library for the easy use of Graph Neural.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/graph4ai/graph4nlp) (👨‍💻 23 · 🔀 150 · 📋 120 - 10% open · ⏱️ 19.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/graph4nlp) (📥 360 / month · ⏱️ 20.01.2022):
	```
	pip install graph4nlp
	```
</details>
<details><summary><b><a href="https://github.com/graphistry/pygraphistry">pygraphistry</a></b> (🥈24 ·  ⭐ 1.5K) - PyGraphistry is a Python library to quickly load, shape,.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/graphistry/pygraphistry) (👨‍💻 19 · 🔀 150 · 📦 60 · 📋 190 - 41% open · ⏱️ 22.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/graphistry) (📥 3.7K / month · 📦 4 · ⏱️ 07.12.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/PyTorch-BigGraph) (👨‍💻 25 · 🔀 400 · 📥 120 · 📋 190 - 28% open · ⏱️ 07.02.2022):

	```
	git clone https://github.com/facebookresearch/PyTorch-BigGraph
	```
- [PyPi](https://pypi.org/project/torchbiggraph) (📥 9.6K / month · 📦 3 · ⏱️ 01.05.2019):
	```
...
- [GitHub](https://github.com/eliorc/node2vec) (👨‍💻 9 · 🔀 190 · ⏱️ 09.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/node2vec) (📥 160K / month · 📦 14 · ⏱️ 09.10.2021):
	```
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_cluster">torch-cluster</a></b> (🥉21 ·  ⭐ 480) - PyTorch Extension Library of Optimized Graph Cluster.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/rusty1s/pytorch_cluster) (👨‍💻 20 · 🔀 90 · 📋 96 - 10% open · ⏱️ 03.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/torch-cluster) (📥 8.2K / month · 📦 26 · ⏱️ 01.03.2021):
	```
...
<details><summary><b><a href="https://github.com/deepmind/jraph">jraph</a></b> (🥉19 ·  ⭐ 850) - A Graph Neural Network Library in Jax. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepmind/jraph) (👨‍💻 13 · 🔀 49 · 📦 12 · 📋 18 - 50% open · ⏱️ 07.02.2022):
...
- [PyPi](https://pypi.org/project/jraph) (📥 1.5K / month · 📦 2 · ⏱️ 19.11.2021):
	...
	pip install jraph
	```
- [Conda](https://anaconda.org/conda-forge/jraph) (📥 300 · ⏱️ 31.10.2021):
	```
	conda install -c conda-forge jraph
	```
</details>
<details><summary><b><a href="https://github.com/THUMNLab/AutoGL">AutoGL</a></b> (🥉19 ·  ⭐ 770) - An autoML framework & toolkit for machine learning on graphs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/THUMNLab/AutoGL) (👨‍💻 13 · 🔀 81 · 📋 18 - 27% open · ⏱️ 31.12.2021):

	```
	git clone https://github.com/THUMNLab/AutoGL
	```
- [PyPi](https://pypi.org/project/auto-graph-learning) (📥 67 / month · ⏱️ 23.12.2020):
	```
	pip install auto-graph-learning
	```
</details>
<details><summary><b><a href="https://github.com/snap-stanford/deepsnap">deepsnap</a></b> (🥉19 ·  ⭐ 390) - Python library assists deep learning on graphs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/snap-stanford/deepsnap) (👨‍💻 15 · 🔀 43 · 📥 8 · 📦 17 · 📋 39 - 38% open · ⏱️ 19.09.2021):
...
- [GitHub](https://github.com/vaticle/kglib) (👨‍💻 7 · 🔀 85 · 📥 210 · 📋 61 - 19% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/grakn-kglib) (📥 220 / month · ⏱️ 19.08.2020):
	```
	pip install grakn-kglib
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/ptgnn">ptgnn</a></b> (🥉16 ·  ⭐ 310) - A PyTorch Graph Neural Network Library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/microsoft/ptgnn) (👨‍💻 7 · 🔀 36 · 📦 1 · 📋 7 - 28% open · ⏱️ 01.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ptgnn) (📥 420 / month · ⏱️ 21.10.2021):
	```
	pip install ptgnn
	```
</details>
...
<details><summary><b><a href="https://github.com/snap-stanford/GraphGym">GraphGym</a></b> (🥉13 ·  ⭐ 910) - Platform for designing and evaluating Graph Neural Networks (GNN). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/snap-stanford/GraphGym) (👨‍💻 5 · 🔀 100 · 📥 8 · 📦 2 · 📋 25 - 12% open · ⏱️ 11.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/graphgym) (📥 150 / month · ⏱️ 29.06.2021):
	```
...
- [GitHub](https://github.com/espnet/espnet) (👨‍💻 240 · 🔀 1.5K · 📥 74 · 📦 36 · 📋 1.7K - 18% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/espnet/espnet
	```
- [PyPi](https://pypi.org/project/espnet) (📥 4.4K / month · 📦 1 · ⏱️ 08.02.2022):
	```
	pip install espnet
	```
</details>
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 93 · 🔀 790 · 📋 950 - 3% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 580K / month · 📦 1.2K · ⏱️ 15.02.2022):
	```
	pip install librosa
	```
...
- [GitHub](https://github.com/pytorch/audio) (👨‍💻 150 · 🔀 380 · 📋 600 - 24% open · ⏱️ 27.02.2022):

	```
	git clone https://github.com/pytorch/audio
	```
- [PyPi](https://pypi.org/project/torchaudio) (📥 350K / month · 📦 120 · ⏱️ 27.01.2022):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.5K · 📦 340 · 📋 890 - 36% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/magenta) (📥 5.8K / month · 📦 36 · ⏱️ 12.11.2020):
	```
	pip install magenta
	```
</details>
...
- [GitHub](https://github.com/Uberi/speech_recognition) (👨‍💻 42 · 🔀 2K · 📋 520 - 45% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/SpeechRecognition) (📥 220K / month · 📦 670 · ⏱️ 05.12.2017):
	```
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 26 · 🔀 1.1K · 📦 260 · 📋 290 - 60% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/tyiannak/pyAudioAnalysis
	```
- [PyPi](https://pypi.org/project/pyAudioAnalysis) (📥 9.3K / month · 📦 19 · ⏱️ 07.02.2022):
	```
...
- [GitHub](https://github.com/deezer/spleeter) (👨‍💻 19 · 🔀 2.1K · 📥 1.4M · 📋 640 - 18% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/spleeter) (📥 11K / month · 📦 3 · ⏱️ 03.09.2021):
	```
...
<details><summary><b><a href="https://github.com/coqui-ai/TTS">Coqui TTS</a></b> (🥈28 ·  ⭐ 4.1K) - - a deep learning toolkit for Text-to-Speech, battle-.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/coqui-ai/TTS) (👨‍💻 82 · 🔀 380 · 📥 80K · 📋 240 - 8% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/tts) (📥 4.5K / month · ⏱️ 14.07.2017):
	```
	pip install tts
	```
...
- [GitHub](https://github.com/Picovoice/porcupine) (👨‍💻 31 · 🔀 390 · 📦 8 · 📋 360 - 1% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/Picovoice/Porcupine
	```
- [PyPi](https://pypi.org/project/pvporcupine) (📥 2.3K / month · 📦 8 · ⏱️ 04.02.2022):
	```
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 21 · 🔀 90 · 📦 7.5K · 📋 77 - 40% open · ⏱️ 03.12.2021):
...
- [GitHub](https://github.com/CPJKU/madmom) (👨‍💻 20 · 🔀 150 · 📦 180 · 📋 260 - 21% open · ⏱️ 06.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/madmom) (📥 6.2K / month · 📦 27 · ⏱️ 14.11.2018):
	```
	pip install madmom
	```
</details>
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 21 · 🔀 87 · 📦 490 · 📋 88 - 13% open · ⏱️ 17.12.2021):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 42K / month · 📦 67 · ⏱️ 14.12.2021):
	```
	pip install tinytag
	```
</details>
...
- [GitHub](https://github.com/magenta/ddsp) (👨‍💻 29 · 🔀 220 · 📦 21 · 📋 130 - 15% open · ⏱️ 19.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ddsp) (📥 3.7K / month · 📦 1 · ⏱️ 15.02.2022):
	```
	pip install ddsp
	```
...
<details><summary><b><a href="https://github.com/iver56/audiomentations">audiomentations</a></b> (🥉25 ·  ⭐ 880) - A Python library for audio data augmentation. Inspired by.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/iver56/audiomentations) (👨‍💻 21 · 🔀 110 · 📦 120 · 📋 98 - 21% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/audiomentations) (📥 3.4K / month · ⏱️ 18.02.2022):
	```
...
- [GitHub](https://github.com/bastibe/python-soundfile) (👨‍💻 24 · 🔀 64 · 📥 3K · 📋 160 - 39% open · ⏱️ 23.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/soundfile) (📥 970K / month · 📦 540 · ⏱️ 27.11.2019):
	```
...
- [GitHub](https://github.com/mozilla/DeepSpeech) (👨‍💻 140 · 🔀 3.3K):
	...
	```
- [PyPi](https://pypi.org/project/deepspeech) (📥 25K / month · 📦 35 · ⏱️ 19.12.2020):
	```
	pip install deepspeech
	```
- [Conda](https://anaconda.org/conda-forge/deepspeech) (📥 360 · ⏱️ 29.07.2021):
	```
...
- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 190 · 🔀 1.7K · 📦 3.7K · 📋 2.4K - 5% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/visgl/deck.gl
	```
- [PyPi](https://pypi.org/project/pydeck) (📥 820K / month · 📦 17 · ⏱️ 25.10.2021):
	```
	pip install pydeck
	```
- [Conda](https://anaconda.org/conda-forge/pydeck) (📥 71K · ⏱️ 26.10.2021):
	...
	```
- [npm](https://www.npmjs.com/package/deck.gl) (📥 300K / month · 📦 380 · ⏱️ 25.02.2022):
	```
	npm install deck.gl
	```
</details>
<details><summary><b><a href="https://github.com/geopandas/geopandas">GeoPandas</a></b> (🥇37 ·  ⭐ 3K) - Python tools for geographic data. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/geopandas/geopandas) (👨‍💻 160 · 🔀 680 · 📥 1.4K · 📦 12K · 📋 1.3K - 30% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/shapely/shapely) (👨‍💻 130 · 🔀 450 · 📥 6 · 📦 27K · 📋 850 - 17% open · ⏱️ 24.02.2022):

	```
	git clone https://github.com/shapely/shapely
	```
- [PyPi](https://pypi.org/project/shapely) (📥 8.7M / month · 📦 3.7K · ⏱️ 18.02.2022):
	```
	pip install shapely
	```
...
- [GitHub](https://github.com/rasterio/rasterio) (👨‍💻 120 · 🔀 460 · 📥 750 · 📦 4.4K · 📋 1.5K - 10% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/rasterio/rasterio
	```
- [PyPi](https://pypi.org/project/rasterio) (📥 820K / month · 📦 740 · ⏱️ 04.02.2022):
	```
...
<details><summary><b><a href="https://github.com/pyproj4/pyproj">pyproj</a></b> (🥈35 ·  ⭐ 720) - Python interface to PROJ (cartographic projections and coordinate.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/Toblerity/Fiona">Fiona</a></b> (🥈34 ·  ⭐ 890) - Fiona reads and writes geographic data files. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Toblerity/Fiona) (👨‍💻 66 · 🔀 180 · 📦 7.9K · 📋 670 - 11% open · ⏱️ 01.03.2022):
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 120 · 🔀 560 · 📦 34K · 📋 250 - 10% open · ⏱️ 26.09.2021):
...
- [GitHub](https://github.com/Esri/arcgis-python-api) (👨‍💻 77 · 🔀 870 · 📥 2.1K · 📋 430 - 28% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/Esri/arcgis-python-api
	```
- [PyPi](https://pypi.org/project/arcgis) (📥 46K / month · 📦 22 · ⏱️ 03.02.2022):
	```
	pip install arcgis
	```
...
<details><summary><b><a href="https://github.com/pysal/pysal">PySAL</a></b> (🥉28 ·  ⭐ 980) - PySAL: Python Spatial Analysis Library Meta-Package. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 46 · 🔀 90 · 📦 8.7K · 📋 81 - 27% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/holoviz/geoviews) (👨‍💻 26 · 🔀 68 · 📋 300 - 34% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/holoviz/geoviews
	```
- [PyPi](https://pypi.org/project/geoviews) (📥 10K / month · 📦 26 · ⏱️ 17.02.2022):
	```
...
<details><summary><b><a href="https://github.com/earthlab/earthpy">EarthPy</a></b> (🥉26 ·  ⭐ 340) - A package built to support working with spatial data using open source.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- <b><a href="https://github.com/marceloprates/prettymaps">prettymaps</a></b> (🥉18 ·  ⭐ 7.8K) - A small set of Python functions to draw pretty maps from.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
</details>
<br>
...
<details><summary><b><a href="https://github.com/microsoft/qlib">Qlib</a></b> (🥇32 ·  ⭐ 8.1K) - Qlib is an AI-oriented quantitative investment platform, which aims to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/microsoft/qlib) (👨‍💻 81 · 🔀 1.4K · 📥 270 · 📦 12 · 📋 480 - 32% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/microsoft/qlib
	```
- [PyPi](https://pypi.org/project/pyqlib) (📥 3.2K / month · ⏱️ 19.01.2022):
	```
	pip install pyqlib
	```
</details>
<details><summary><b><a href="https://github.com/bukosabino/ta">ta</a></b> (🥈30 ·  ⭐ 2.8K) - Technical Analysis Library using Pandas and Numpy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/bukosabino/ta) (👨‍💻 26 · 🔀 660 · 📦 1K · 📋 200 - 53% open · ⏱️ 27.01.2022):

	```
	git clone https://github.com/bukosabino/ta
	```
- [PyPi](https://pypi.org/project/ta) (📥 58K / month · 📦 27 · ⏱️ 09.01.2022):
	```
	pip install ta
	```
...
- [GitHub](https://github.com/erdewit/ib_insync) (👨‍💻 29 · 🔀 470 · 📋 380 - 1% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ib_insync) (📥 12K / month · 📦 19 · ⏱️ 28.11.2021):
	```
...
- [GitHub](https://github.com/tensortrade-org/tensortrade) (👨‍💻 61 · 🔀 860 · 📦 30 · 📋 220 - 13% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensortrade) (📥 1.6K / month · 📦 1 · ⏱️ 10.05.2021):
	```
	pip install tensortrade
	```
- [Conda](https://anaconda.org/conda-forge/tensortrade) (📥 950 · ⏱️ 10.05.2021):
	```
...
- [GitHub](https://github.com/RomelTorres/alpha_vantage) (👨‍💻 39 · 🔀 640 · 📋 260 - 5% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/alpha_vantage) (📥 24K / month · 📦 100 · ⏱️ 26.08.2018):
	```
	pip install alpha_vantage
	```
- [Conda](https://anaconda.org/conda-forge/alpha_vantage) (📥 960 · ⏱️ 14.01.2021):
	```
...
- [GitHub](https://github.com/pmorissette/bt) (👨‍💻 25 · 🔀 300 · 📦 96 · 📋 280 - 18% open · ⏱️ 09.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/bt) (📥 4.7K / month · 📦 21 · ⏱️ 21.04.2021):
	```
	pip install bt
	```
- [Conda](https://anaconda.org/conda-forge/bt) (📥 3.1K · ⏱️ 18.01.2022):
	```
...
- [PyPi](https://pypi.org/project/ffn) (📥 27K / month · 📦 25 · ⏱️ 21.04.2021):
	...
	pip install ffn
	```
- [Conda](https://anaconda.org/conda-forge/ffn) (📥 680 · ⏱️ 22.04.2021):
	```
...
- [GitHub](https://github.com/jealous/stockstats) (👨‍💻 8 · 🔀 250 · 📦 400 · 📋 80 - 3% open · ⏱️ 07.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/stockstats) (📥 9.6K / month · 📦 29 · ⏱️ 07.01.2022):
	```
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 36 · 🔀 410 · 📋 38 - 50% open · ⏱️ 24.02.2022):
...
- [GitHub](https://github.com/cuemacro/finmarketpy) (👨‍💻 14 · 🔀 450 · 📥 40 · 📦 4 · 📋 26 - 88% open · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/finmarketpy) (📥 350 / month · ⏱️ 07.10.2021):
	```
...
- <b><a href="https://github.com/mementum/backtrader">backtrader</a></b> (🥈29 ·  ⭐ 8.3K · 💤) - Python Backtesting library for trading strategies. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
- <b><a href="https://github.com/bashtage/arch">arch</a></b> (🥈29 ·  ⭐ 870) - ARCH models in Python. <code><a href="https://tldrlegal.com/search?q=NCSA">❗️NCSA</a></code>
...
- [GitHub](https://github.com/alan-turing-institute/sktime) (👨‍💻 150 · 🔀 770 · 📥 64 · 📦 360 · 📋 1K - 37% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/alan-turing-institute/sktime
	```
- [PyPi](https://pypi.org/project/sktime) (📥 130K / month · 📦 19 · ⏱️ 20.02.2022):
	```
	pip install sktime
	```
- [Conda](https://anaconda.org/conda-forge/sktime-all-extras) (📥 2K · ⏱️ 24.02.2022):
	```
...
- [GitHub](https://github.com/facebook/prophet) (👨‍💻 140 · 🔀 4K · 📥 640 · 📋 1.8K - 10% open · ⏱️ 25.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/fbprophet) (📥 1.2M / month · 📦 120 · ⏱️ 05.09.2020):
	```
	pip install fbprophet
	```
- [Conda](https://anaconda.org/conda-forge/prophet) (📥 31K · ⏱️ 23.08.2021):
	```
...
- [GitHub](https://github.com/alkaline-ml/pmdarima) (👨‍💻 19 · 🔀 200 · 📦 1.8K · 📋 270 - 10% open · ⏱️ 22.02.2022):

	```
	git clone https://github.com/alkaline-ml/pmdarima
	```
- [PyPi](https://pypi.org/project/pmdarima) (📥 1M / month · 📦 51 · ⏱️ 22.02.2022):
	```
	pip install pmdarima
	```
- [Conda](https://anaconda.org/conda-forge/pmdarima) (📥 31K · ⏱️ 24.02.2022):
	```
	conda install -c conda-forge pmdarima
	```
</details>
<details><summary><b><a href="https://github.com/blue-yonder/tsfresh">tsfresh</a></b> (🥈30 ·  ⭐ 6.2K) - Automatic extraction of relevant features from time series:. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/blue-yonder/tsfresh) (👨‍💻 82 · 🔀 960 · 📋 480 - 8% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/tsfresh) (📥 430K / month · 📦 55 · ⏱️ 21.12.2021):
	```
	pip install tsfresh
	```
...
- [GitHub](https://github.com/TDAmeritrade/stumpy) (👨‍💻 29 · 🔀 210 · 📋 300 - 10% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/TDAmeritrade/stumpy
	```
- [PyPi](https://pypi.org/project/stumpy) (📥 320K / month · 📦 4 · ⏱️ 24.12.2021):
	```
	pip install stumpy
	```
...
- [GitHub](https://github.com/jdb78/pytorch-forecasting) (👨‍💻 28 · 🔀 270 · 📋 400 - 40% open · ⏱️ 23.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-forecasting) (📥 28K / month · 📦 4 · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/unit8co/darts) (👨‍💻 48 · 🔀 350 · 📦 36 · 📋 360 - 34% open · ⏱️ 01.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/u8darts) (📥 6.8K / month · 📦 2 · ⏱️ 17.02.2022):
	```
	pip install u8darts
	```
- [Conda](https://anaconda.org/conda-forge/u8darts-all) (📥 2.3K · ⏱️ 18.02.2022):
	```
...
- [GitHub](https://github.com/awslabs/gluon-ts) (👨‍💻 84 · 🔀 530 · 📋 720 - 39% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/awslabs/gluon-ts
	```
- [PyPi](https://pypi.org/project/gluonts) (📥 89K / month · 📦 6 · ⏱️ 28.02.2022):
	```
	pip install gluonts
	```
...
- [GitHub](https://github.com/python-streamz/streamz) (👨‍💻 45 · 🔀 130 · 📦 270 · 📋 250 - 41% open · ⏱️ 24.12.2021):
...
<details><summary><b><a href="https://github.com/dmbee/seglearn">seglearn</a></b> (🥉21 ·  ⭐ 490 · 💤) - Python module for machine learning time series:. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/AutoViML/Auto_TS) (👨‍💻 6 · 🔀 73 · 📋 65 - 9% open · ⏱️ 13.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/auto-ts) (📥 2.6K / month · ⏱️ 31.01.2022):
	```
	pip install auto-ts
	```
</details>
<details><summary><b><a href="https://github.com/firmai/atspy">atspy</a></b> (🥉15 ·  ⭐ 420) - AtsPy: Automated Time Series Models in Python (by @firmai). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/firmai/atspy) (👨‍💻 5 · 🔀 82 · 📦 5 · 📋 20 - 90% open · ⏱️ 18.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/atspy) (📥 2K / month · ⏱️ 24.04.2020):
	```
	pip install atspy
	```
</details>
...
- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 280 · 🔀 970 · 📦 1.4K · 📋 4K - 8% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/mne-tools/mne-python
	```
- [PyPi](https://pypi.org/project/mne) (📥 34K / month · 📦 190 · ⏱️ 01.12.2021):
	```
	pip install mne
	```
...
<details><summary><b><a href="https://github.com/nilearn/nilearn">Nilearn</a></b> (🥇35 ·  ⭐ 820) - Machine learning for NeuroImaging in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/nilearn/nilearn) (👨‍💻 180 · 🔀 440 · 📥 25 · 📦 1.4K · 📋 1.6K - 17% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/nilearn/nilearn
	```
- [PyPi](https://pypi.org/project/nilearn) (📥 38K / month · 📦 230 · ⏱️ 28.01.2022):
	```
	pip install nilearn
	```
...
- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 90 · 🔀 540 · 📦 220 · 📋 1.5K - 10% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/Project-MONAI/MONAI
	```
- [PyPi](https://pypi.org/project/monai) (📥 52K / month · 📦 13 · ⏱️ 16.02.2022):
	```
	pip install monai
	```
- [Conda](https://anaconda.org/conda-forge/monai) (📥 150 · ⏱️ 09.01.2022):
	```
	conda install -c conda-forge monai
	```
</details>
<details><summary><b><a href="https://github.com/nipy/nibabel">NiBabel</a></b> (🥈34 ·  ⭐ 460) - Python package to access a cacophony of neuro-imaging file formats. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nipy/nibabel) (👨‍💻 93 · 🔀 230 · 📦 6.4K · 📋 460 - 30% open · ⏱️ 25.02.2022):
...
- [GitHub](https://github.com/hail-is/hail) (👨‍💻 77 · 🔀 200 · 📦 49 · 📋 2K - 2% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/hail-is/hail
	```
- [PyPi](https://pypi.org/project/hail) (📥 50K / month · 📦 7 · ⏱️ 01.03.2022):
	```
	pip install hail
	```
</details>
...
- [GitHub](https://github.com/CamDavidsonPilon/lifelines) (👨‍💻 99 · 🔀 460 · 📦 780 · 📋 850 - 26% open · ⏱️ 19.01.2022):

	```
	git clone https://github.com/CamDavidsonPilon/lifelines
	```
- [PyPi](https://pypi.org/project/lifelines) (📥 390K / month · 📦 100 · ⏱️ 30.11.2021):
	```
...
<details><summary><b><a href="https://github.com/nipy/nipype">NIPYPE</a></b> (🥈32 ·  ⭐ 620) - Workflows and interfaces for neuroimaging packages. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/nipy/nipype) (👨‍💻 230 · 🔀 480 · 📦 860 · 📋 1.3K - 28% open · ⏱️ 19.02.2022):

	```
	git clone https://github.com/nipy/nipype
	```
- [PyPi](https://pypi.org/project/nipype) (📥 46K / month · 📦 150 · ⏱️ 20.10.2021):
	```
	pip install nipype
	```
...
- [GitHub](https://github.com/dipy/dipy) (👨‍💻 130 · 🔀 330 · 📦 510 · 📋 770 - 15% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/dipy/dipy
	```
- [PyPi](https://pypi.org/project/dipy) (📥 12K / month · 📦 80 · ⏱️ 06.05.2021):
	```
	pip install dipy
	```
- [Conda](https://anaconda.org/conda-forge/dipy) (📥 280K · ⏱️ 24.02.2022):
	```
...
- [GitHub](https://github.com/nipy/nipy) (👨‍💻 63 · 🔀 130 · 📋 160 - 28% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/nipy) (📥 2.4K / month · 📦 47 · ⏱️ 19.02.2018):
	```
	pip install nipy
	```
...
<details><summary><b><a href="https://github.com/manujosephv/pytorch_tabular">pytorch_tabular</a></b> (🥇19 ·  ⭐ 550 · 📉) - A standard framework for modelling Deep Learning.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/manujosephv/pytorch_tabular) (👨‍💻 8 · 🔀 55 · 📋 52 - 30% open · ⏱️ 05.02.2022):

	```
	git clone https://github.com/manujosephv/pytorch_tabular
	```
- [PyPi](https://pypi.org/project/pytorch_tabular) (📥 1.7K / month · ⏱️ 01.09.2021):
	```
...
- [GitHub](https://github.com/carefree0910/carefree-learn) (👨‍💻 1 · 🔀 30 · 📦 2 · ⏱️ 03.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/carefree-learn) (📥 320 / month · ⏱️ 29.10.2021):
	```
...
- [GitHub](https://github.com/firmai/deltapy) (👨‍💻 4 · 🔀 41 · 📦 2 · 📋 3 - 66% open · ⏱️ 01.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/deltapy) (📥 230 / month · ⏱️ 09.04.2020):
	```
	pip install deltapy
	```
</details>
...
- [GitHub](https://github.com/PaddlePaddle/PaddleOCR) (👨‍💻 90 · 🔀 3.9K · 📦 550 · 📋 4.1K - 25% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/PaddlePaddle/PaddleOCR
	```
- [PyPi](https://pypi.org/project/paddleocr) (📥 38K / month · 📦 4 · ⏱️ 10.01.2022):
	```
	pip install paddleocr
	```
</details>
<details><summary><b><a href="https://github.com/JaidedAI/EasyOCR">EasyOCR</a></b> (🥇34 ·  ⭐ 14K) - Ready-to-use OCR with 80+ supported languages and all popular writing.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 95 · 🔀 1.8K · 📥 1.2M · 📦 910 · 📋 560 - 21% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 580 · 📋 290 - 4% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/madmaze/pytesseract
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 490K / month · 📦 920 · ⏱️ 19.02.2022):
	```
...
<details><summary><b><a href="https://github.com/ocrmypdf/OCRmyPDF">OCRmyPDF</a></b> (🥈30 ·  ⭐ 6K) - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/ocrmypdf/OCRmyPDF) (👨‍💻 61 · 🔀 550 · 📋 830 - 11% open · ⏱️ 19.02.2022):

	```
	git clone https://github.com/ocrmypdf/OCRmyPDF
	```
- [PyPi](https://pypi.org/project/ocrmypdf) (📥 28K / month · 📦 12 · ⏱️ 19.02.2022):
	```
	pip install ocrmypdf
	```
- [Conda](https://anaconda.org/conda-forge/ocrmypdf) (📥 8.6K · ⏱️ 19.02.2022):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 26 · 🔀 210 · 📦 620 · 📋 240 - 32% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 60K / month · 📦 61 · ⏱️ 19.06.2021):
	```
...
<details><summary><b><a href="https://github.com/Calamari-OCR/calamari">calamari</a></b> (🥉23 ·  ⭐ 900) - Line based ATR Engine based on OCRopy. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/faustomorales/keras-ocr">keras-ocr</a></b> (🥉22 ·  ⭐ 980) - A packaged and flexible version of the CRAFT text detector and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/faustomorales/keras-ocr) (👨‍💻 12 · 🔀 240 · 📥 230K · 📋 160 - 34% open · ⏱️ 24.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/keras-ocr) (📥 7.1K / month · 📦 2 · ⏱️ 24.11.2021):
	```
...
- [GitHub](https://github.com/emedvedev/attention-ocr) (👨‍💻 27 · 🔀 240 · 📦 18 · 📋 150 - 15% open · ⏱️ 29.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/aocr) (📥 700 / month · ⏱️ 19.04.2019):
	```
	pip install aocr
	```
</details>
...
- [GitHub](https://github.com/pandas-dev/pandas) (👨‍💻 2.9K · 🔀 14K · 📥 140K · 📦 650K · 📋 22K - 15% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pandas-dev/pandas
	```
- [PyPi](https://pypi.org/project/pandas) (📥 76M / month · 📦 58K · ⏱️ 22.01.2022):
	```
	pip install pandas
	```
...
- [GitHub](https://github.com/numpy/numpy) (👨‍💻 1.4K · 🔀 6.5K · 📥 470K · 📦 990K · 📋 11K - 21% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/numpy/numpy
	```
- [PyPi](https://pypi.org/project/numpy) (📥 99M / month · 📦 120K · ⏱️ 04.02.2022):
	```
	pip install numpy
	```
...
<details><summary><b><a href="https://github.com/apache/arrow">Arrow</a></b> (🥇43 ·  ⭐ 9.2K) - Apache Arrow is a multi-language toolbox for accelerated data.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/apache/arrow) (👨‍💻 810 · 🔀 2.2K · 📦 64 · 📋 920 - 23% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/apache/arrow
	```
- [PyPi](https://pypi.org/project/pyarrow) (📥 55M / month · 📦 1.4K · ⏱️ 03.02.2022):
	```
	pip install pyarrow
	```
...
- [GitHub](https://github.com/h5py/h5py) (👨‍💻 180 · 🔀 430 · 📥 1.7K · 📦 150K · 📋 1.3K - 17% open · ⏱️ 28.02.2022):
...
- [GitHub](https://github.com/pydata/xarray) (👨‍💻 370 · 🔀 780 · 📦 9.3K · 📋 3.2K - 29% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pydata/xarray
	```
- [PyPi](https://pypi.org/project/xarray) (📥 1.1M / month · 📦 1.3K · ⏱️ 02.03.2022):
	```
	pip install xarray
	```
...
- [GitHub](https://github.com/PyTables/PyTables) (👨‍💻 100 · 🔀 220 · 📥 170 · 📋 680 - 26% open · ⏱️ 03.03.2022):
...
<details><summary><b><a href="https://github.com/modin-project/modin">Modin</a></b> (🥈34 ·  ⭐ 6.9K) - Modin: Speed up your Pandas workflows by changing a single line of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/modin-project/modin) (👨‍💻 88 · 🔀 480 · 📥 200K · 📦 570 · 📋 2.5K - 32% open · ⏱️ 02.03.2022):
...
- [PyPi](https://pypi.org/project/modin) (📥 210K / month · 📦 22 · ⏱️ 10.02.2022):
	...
	pip install modin
	```
- [Conda](https://anaconda.org/conda-forge/modin-core) (📥 24K · ⏱️ 11.02.2022):
	```
...
<details><summary><b><a href="https://github.com/pydata/bottleneck">Bottleneck</a></b> (🥈33 ·  ⭐ 710 · 📈) - Fast NumPy array functions written in C. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pydata/bottleneck) (👨‍💻 25 · 🔀 84 · 📦 31K · 📋 220 - 18% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/pydata/bottleneck
	```
- [PyPi](https://pypi.org/project/Bottleneck) (📥 400K / month · 📦 1.6K · ⏱️ 22.02.2022):
	```
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 75 · 🔀 430 · 📋 280 - 2% open · ⏱️ 19.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 290K / month · 📦 790 · ⏱️ 19.02.2022):
	```
	pip install tinydb
	```
...
<details><summary><b><a href="https://github.com/pola-rs/polars">polars</a></b> (🥈31 ·  ⭐ 4.8K) - Fast multi-threaded DataFrame library in Rust | Python | Node.js. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pola-rs/polars) (👨‍💻 71 · 🔀 260 · 📦 2 · 📋 1.1K - 9% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pola-rs/polars
	```
- [PyPi](https://pypi.org/project/polars) (📥 40K / month · 📦 11 · ⏱️ 02.03.2022):
	```
	pip install polars
	```
</details>
...
- [GitHub](https://github.com/databricks/koalas) (👨‍💻 51 · 🔀 330 · 📥 1K · 📦 170 · 📋 580 - 16% open · ⏱️ 21.10.2021):

	```
	git clone https://github.com/databricks/koalas
	```
- [PyPi](https://pypi.org/project/koalas) (📥 2.3M / month · 📦 7 · ⏱️ 19.10.2021):
	```
	pip install koalas
	```
...
<details><summary><b><a href="https://github.com/ekzhu/datasketch">datasketch</a></b> (🥈31 ·  ⭐ 1.7K) - MinHash, LSH, LSH Forest, Weighted MinHash, HyperLogLog,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ekzhu/datasketch) (👨‍💻 21 · 🔀 230 · 📥 19 · 📦 350 · 📋 130 - 22% open · ⏱️ 04.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/datasketch) (📥 450K / month · 📦 54 · ⏱️ 04.02.2022):
	```
	pip install datasketch
	```
</details>
<details><summary><b><a href="https://github.com/zarr-developers/zarr-python">zarr</a></b> (🥈31 ·  ⭐ 860) - An implementation of chunked, compressed, N-dimensional arrays for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/zarr-developers/zarr-python) (👨‍💻 55 · 🔀 140 · 📦 1.1K · 📋 490 - 42% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/zarr-developers/zarr-python
	```
- [PyPi](https://pypi.org/project/zarr) (📥 86K / month · 📦 190 · ⏱️ 07.02.2022):
	```
	pip install zarr
	```
...
- [GitHub](https://github.com/vaexio/vaex) (👨‍💻 63 · 🔀 530 · 📥 230 · 📋 1K - 35% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/vaexio/vaex
	```
- [PyPi](https://pypi.org/project/vaex) (📥 32K / month · 📦 16 · ⏱️ 07.02.2022):
	```
	pip install vaex
	```
...
- [GitHub](https://github.com/man-group/arctic) (👨‍💻 75 · 🔀 520 · 📥 180 · 📦 150 · 📋 540 - 17% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/arctic) (📥 7.8K / month · 📦 34 · ⏱️ 24.01.2022):
	```
	pip install arctic
	```
...
- [GitHub](https://github.com/h2oai/datatable) (👨‍💻 33 · 🔀 130 · 📥 1.2K · 📋 1.4K - 9% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/datatable) (📥 84K / month · 📦 12 · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/jmcarpenter2/swifter) (👨‍💻 15 · 🔀 88 · 📦 500 · 📋 110 - 20% open · ⏱️ 07.02.2022):

	```
	git clone https://github.com/jmcarpenter2/swifter
	```
- [PyPi](https://pypi.org/project/swifter) (📥 130K / month · 📦 28 · ⏱️ 07.02.2022):
	```
	pip install swifter
	```
...
<details><summary><b><a href="https://github.com/pandera-dev/pandera">pandera</a></b> (🥉28 ·  ⭐ 1.1K) - A light-weight, flexible, and expressive data validation library for.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pandera-dev/pandera) (👨‍💻 48 · 🔀 84 · 📦 160 · 📋 370 - 23% open · ⏱️ 08.02.2022):

	```
	git clone https://github.com/pandera-dev/pandera
	```
- [PyPi](https://pypi.org/project/pandera) (📥 220K / month · 📦 21 · ⏱️ 09.02.2022):
	```
	pip install pandera
	```
- [Conda](https://anaconda.org/conda-forge/pandera-core) (📥 6K · ⏱️ 15.02.2022):
	```
...
- [PyPi](https://pypi.org/project/pandarallel) (📥 220K / month · 📦 19 · ⏱️ 06.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pandarallel) (📥 1.7K · ⏱️ 06.02.2022):
	```
	conda install -c conda-forge pandarallel
	```
</details>
<details><summary><b><a href="https://github.com/jina-ai/docarray">docarray</a></b> (🥉26 ·  ⭐ 550 · 🐣) - The data structure for unstructured data. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/jina-ai/docarray) (👨‍💻 18 · 🔀 37 · 📦 12 · 📋 43 - 25% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/jina-ai/docarray
	```
- [PyPi](https://pypi.org/project/docarray) (📥 77K / month · ⏱️ 03.03.2022):
	```
	pip install docarray
	```
- [Conda](https://anaconda.org/conda-forge/docarray) (📥 250 · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/RaRe-Technologies/bounter) (👨‍💻 8 · 🔀 48 · 📦 25 · 📋 25 - 64% open · ⏱️ 24.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/bounter) (📥 230 / month · 📦 8 · ⏱️ 17.08.2020):
	```
	pip install bounter
	```
</details>
...
- [GitHub](https://github.com/firmai/pandapy) (👨‍💻 3 · 🔀 57 · 📦 1 · 📋 3 - 66% open · ⏱️ 20.10.2021):

	```
	git clone https://github.com/firmai/pandapy
	```
- [PyPi](https://pypi.org/project/pandapy) (📥 370 / month · ⏱️ 25.01.2020):
	```
	pip install pandapy
	```
</details>
...
- <b><a href="https://github.com/InvestmentSystems/static-frame">StaticFrame</a></b> (🥉27 ·  ⭐ 260) - Immutable and grow-only Pandas-like DataFrames with a more explicit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/celery/celery) (👨‍💻 1.2K · 🔀 4.2K · 📦 66K · 📋 4.7K - 11% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/celery/celery
	```
- [PyPi](https://pypi.org/project/celery) (📥 5.5M / month · 📦 15K · ⏱️ 29.12.2021):
	```
	pip install celery
	```
- [Conda](https://anaconda.org/conda-forge/celery) (📥 790K · ⏱️ 07.02.2022):
	```
	conda install -c conda-forge celery
	```
</details>
<details><summary><b><a href="https://github.com/apache/airflow">Airflow</a></b> (🥇45 ·  ⭐ 25K) - Platform to programmatically author, schedule, and monitor workflows. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/apache/airflow) (👨‍💻 2.3K · 🔀 10K · 📥 260K · 📋 5.1K - 17% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/apache/airflow
	```
- [PyPi](https://pypi.org/project/apache-airflow) (📥 5.7M / month · 📦 450 · ⏱️ 22.02.2022):
	```
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇39 ·  ⭐ 8.2K) - Simple job queues for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 250 · 🔀 1.3K · 📦 9.7K · 📋 950 - 17% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/apache/beam) (👨‍💻 1.2K · 🔀 3.4K · ⏱️ 03.03.2022):

	```
	git clone https://github.com/apache/beam
	```
- [PyPi](https://pypi.org/project/apache-beam) (📥 20M / month · 📦 150 · ⏱️ 01.03.2022):
	```
	pip install apache-beam
	```
- [Conda](https://anaconda.org/conda-forge/apache-beam-with-aws) (📥 4.3K · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 580 · 🔀 2.3K · 📦 1.7K · 📋 970 - 10% open · ⏱️ 16.01.2022):

	```
	git clone https://github.com/spotify/luigi
	```
- [PyPi](https://pypi.org/project/luigi) (📥 640K / month · 📦 400 · ⏱️ 23.09.2020):
	```
	pip install luigi
	```
...
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥇38 ·  ⭐ 8.4K) - The easiest way to automate your data. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 300 · 🔀 810 · 📦 630 · 📋 2.1K - 20% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 190K / month · 📦 43 · ⏱️ 01.03.2022):
	```
	pip install prefect
	```
...
<details><summary><b><a href="https://github.com/dagster-io/dagster">Dagster</a></b> (🥈37 ·  ⭐ 4.4K) - An orchestration platform for the development, production, and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dagster-io/dagster) (👨‍💻 190 · 🔀 540 · 📦 320 · 📋 3.8K - 24% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/dagster-io/dagster
	```
- [PyPi](https://pypi.org/project/dagster) (📥 200K / month · 📦 85 · ⏱️ 24.02.2022):
	```
	pip install dagster
	```
...
<details><summary><b><a href="https://github.com/great-expectations/great_expectations">Great Expectations</a></b> (🥈36 ·  ⭐ 6.2K) - Always know what to expect from your data. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/great-expectations/great_expectations) (👨‍💻 270 · 🔀 850 · 📋 1.2K - 13% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/great-expectations/great_expectations
	```
- [PyPi](https://pypi.org/project/great_expectations) (📥 3.7M / month · 📦 27 · ⏱️ 24.02.2022):
	```
	pip install great_expectations
	```
- [Conda](https://anaconda.org/conda-forge/great-expectations) (📥 360K · ⏱️ 24.02.2022):
	```
	conda install -c conda-forge great-expectations
	```
</details>
<details><summary><b><a href="https://github.com/dbt-labs/dbt-core">dbt</a></b> (🥈36 ·  ⭐ 4.3K) - dbt enables data analysts and engineers to transform their data using the.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dbt-labs/dbt-core) (👨‍💻 200 · 🔀 780 · 📥 190 · 📦 320 · 📋 2.6K - 12% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/dbt-labs/dbt-core
	```
- [PyPi](https://pypi.org/project/dbt) (📥 710K / month · 📦 29 · ⏱️ 06.12.2021):
	```
	pip install dbt
	```
...
<details><summary><b><a href="https://github.com/kedro-org/kedro">Kedro</a></b> (🥈33 ·  ⭐ 6.7K) - A Python framework for creating reproducible, maintainable and modular.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/kedro-org/kedro) (👨‍💻 140 · 🔀 620 · 📦 760 · 📋 630 - 9% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/kedro) (📥 340K / month · 📦 35 · ⏱️ 22.02.2022):
	```
	pip install kedro
	```
</details>
<details><summary><b><a href="https://github.com/petl-developers/petl">petl</a></b> (🥈32 ·  ⭐ 980) - Python Extract Transform and Load Tables of Data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/activeloopai/Hub">Activeloop</a></b> (🥈31 ·  ⭐ 4.3K) - Dataset format for AI. Build, manage, query & visualize datasets.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/activeloopai/Hub) (👨‍💻 91 · 🔀 350 · 📋 340 - 19% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/activeloopai/Hub
	```
- [PyPi](https://pypi.org/project/hub) (📥 5.9K / month · 📦 52 · ⏱️ 21.02.2022):
	```
	pip install hub
	```
</details>
...
- [GitHub](https://github.com/combust/mleap) (👨‍💻 71 · 🔀 290 · 📦 180 · 📋 440 - 20% open · ⏱️ 22.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/mleap) (📥 180K / month · 📦 25 · ⏱️ 12.01.2022):
	```
	pip install mleap
	```
...
- [GitHub](https://github.com/tensorflow/tfx) (👨‍💻 130 · 🔀 530 · 📋 750 - 33% open · ⏱️ 03.03.2022):
...
<details><summary><b><a href="https://github.com/ploomber/ploomber">ploomber</a></b> (🥉28 ·  ⭐ 1.4K) - The fastest way to build data pipelines. Develop iteratively,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ploomber/ploomber) (👨‍💻 36 · 🔀 99 · 📦 29 · 📋 560 - 27% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/ploomber/ploomber
	```
- [PyPi](https://pypi.org/project/ploomber) (📥 7.6K / month · 📦 4 · ⏱️ 28.02.2022):
	```
	pip install ploomber
	```
- [Conda](https://anaconda.org/conda-forge/ploomber) (📥 4.3K · ⏱️ 28.02.2022):
	```
...
- [GitHub](https://github.com/zenml-io/zenml) (👨‍💻 26 · 🔀 110 · 📋 59 - 16% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/zenml-io/zenml
	```
- [PyPi](https://pypi.org/project/zenml) (📥 1.8K / month · ⏱️ 23.02.2022):
	```
	pip install zenml
	```
</details>
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 25 · 🔀 210 · 📋 230 - 14% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/hi-primus/optimus
	```
- [PyPi](https://pypi.org/project/optimuspyspark) (📥 30K / month · ⏱️ 30.05.2019):
	```
...
- [GitHub](https://github.com/EntilZha/PyFunctional) (👨‍💻 25 · 🔀 110 · 📦 400 · 📋 130 - 5% open · ⏱️ 05.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyfunctional) (📥 89K / month · 📦 12 · ⏱️ 12.01.2021):
	```
...
- [GitHub](https://github.com/python-bonobo/bonobo) (👨‍💻 37 · 🔀 120 · 📦 130 · 📋 200 - 46% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bonobo) (📥 8.3K / month · 📦 33 · ⏱️ 20.07.2019):
	```
	pip install bonobo
	```
</details>
...
- [GitHub](https://github.com/samuelcolvin/arq) (👨‍💻 35 · 🔀 88 · 📦 200 · 📋 130 - 26% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/arq) (📥 21K / month · 📦 10 · ⏱️ 02.09.2021):
	```
	pip install arq
	```
...
<details><summary><b><a href="https://github.com/whylabs/whylogs">whylogs</a></b> (🥉24 ·  ⭐ 810) - Open standard for end-to-end data and ML monitoring for any scale in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/whylabs/whylogs) (👨‍💻 27 · 🔀 42 · 📥 49 · 📋 110 - 42% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/whylabs/whylogs
	```
- [PyPi](https://pypi.org/project/whylogs) (📥 9.5K / month · 📦 2 · ⏱️ 02.03.2022):
	```
	pip install whylogs
	```
</details>
...
- [PyPi](https://pypi.org/project/pypeln) (📥 16K / month · 📦 9 · ⏱️ 06.01.2022):
	...
	pip install pypeln
	```
- [Conda](https://anaconda.org/conda-forge/pypeln) (📥 5K · ⏱️ 06.01.2022):
	```
...
- [GitHub](https://github.com/pdpipe/pdpipe) (👨‍💻 10 · 🔀 33 · 📦 40 · 📋 42 - 30% open · ⏱️ 23.02.2022):

	```
	git clone https://github.com/pdpipe/pdpipe
	```
- [PyPi](https://pypi.org/project/pdpipe) (📥 3.1K / month · 📦 5 · ⏱️ 23.02.2022):
	```
	pip install pdpipe
	```
- [Conda](https://anaconda.org/conda-forge/pdpipe) (📥 3.2K · ⏱️ 21.02.2022):
	```
...
- [GitHub](https://github.com/d6t/d6tflow) (👨‍💻 12 · 🔀 69 · 📦 20 · 📋 23 - 43% open · ⏱️ 28.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/d6tflow) (📥 500 / month · ⏱️ 06.10.2021):
	```
	pip install d6tflow
	```
</details>
...
- [GitHub](https://github.com/kubeflow-kale/kale) (👨‍💻 10 · 🔀 97 · 📋 160 - 53% open · ⏱️ 20.10.2021):
...
- [GitHub](https://github.com/mara/mara-pipelines) (👨‍💻 16 · 🔀 87 · 📦 8 · 📋 24 - 45% open · ⏱️ 18.09.2021):
...
- <b><a href="https://github.com/bodywork-ml/bodywork-core">bodywork-core</a></b> (🥉19 ·  ⭐ 320) - ML pipeline orchestration and model deployments on.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
- <b><a href="https://github.com/vincentclaes/datajob">datajob</a></b> (🥉15 ·  ⭐ 83) - Build and deploy a serverless data pipeline on AWS with no effort. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
</details>
<br>
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 640 · 🔀 3.3K · 📦 4K · 📋 9.6K - 24% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/ray-project/ray
	```
- [PyPi](https://pypi.org/project/ray) (📥 920K / month · 📦 240 · ⏱️ 01.03.2022):
	```
	pip install ray
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 520 · 🔀 1.4K · 📦 34K · 📋 4.2K - 17% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 6M / month · 📦 2.6K · ⏱️ 25.02.2022):
	```
	pip install dask
	```
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 260 · 🔀 590 · 📦 22K · 📋 2.7K - 34% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/dask/distributed
	```
- [PyPi](https://pypi.org/project/distributed) (📥 5.3M / month · 📦 1.2K · ⏱️ 25.02.2022):
	```
...
<details><summary><b><a href="https://github.com/horovod/horovod">horovod</a></b> (🥇37 ·  ⭐ 12K · 📈) - Distributed training framework for TensorFlow, Keras, PyTorch,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/horovod/horovod) (👨‍💻 140 · 🔀 2K · 📦 520 · 📋 2K - 14% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/horovod/horovod
	```
- [PyPi](https://pypi.org/project/horovod) (📥 63K / month · 📦 29 · ⏱️ 02.03.2022):
	```
	pip install horovod
	```
</details>
...
- [GitHub](https://github.com/intel-analytics/BigDL) (👨‍💻 130 · 🔀 970 · 📦 34 · 📋 1.2K - 30% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/intel-analytics/BigDL
	```
- [PyPi](https://pypi.org/project/bigdl) (📥 19K / month · 📦 1 · ⏱️ 03.03.2022):
	```
	pip install bigdl
	```
...
<details><summary><b><a href="https://github.com/microsoft/DeepSpeed">DeepSpeed</a></b> (🥈31 ·  ⭐ 6.4K) - DeepSpeed is a deep learning optimization library that makes.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/microsoft/DeepSpeed) (👨‍💻 90 · 🔀 700 · 📦 180 · 📋 790 - 48% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/deepspeed) (📥 85K / month · 📦 9 · ⏱️ 19.01.2022):
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/fairscale">FairScale</a></b> (🥈31 ·  ⭐ 1.6K) - PyTorch extensions for high performance and large scale training. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/facebookresearch/fairscale) (👨‍💻 56 · 🔀 150 · 📦 180 · 📋 280 - 21% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/fairscale) (📥 71K / month · 📦 13 · ⏱️ 14.01.2022):
	```
	pip install fairscale
	```
- [Conda](https://anaconda.org/conda-forge/fairscale) (📥 5.6K · ⏱️ 05.02.2022):
	```
	conda install -c conda-forge fairscale
	```
</details>
<details><summary><b><a href="https://github.com/PyTorchLightning/metrics">metrics</a></b> (🥈31 ·  ⭐ 730) - Machine learning metrics for distributed, scalable PyTorch.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyTorchLightning/metrics) (👨‍💻 120 · 🔀 150 · 📥 470 · 📦 2K · 📋 300 - 17% open · ⏱️ 03.03.2022):
...
- [GitHub](https://github.com/intel-analytics/analytics-zoo) (👨‍💻 100 · 🔀 710 · 📦 3 · 📋 1.4K - 40% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/intel-analytics/analytics-zoo
	```
- [PyPi](https://pypi.org/project/analytics-zoo) (📥 12K / month · 📦 1 · ⏱️ 02.03.2022):
	```
...
- [GitHub](https://github.com/uber/petastorm) (👨‍💻 43 · 🔀 230 · 📥 310 · 📦 55 · 📋 280 - 50% open · ⏱️ 19.02.2022):
...
- [GitHub](https://github.com/dask/dask-ml) (👨‍💻 71 · 🔀 220 · 📦 560 · 📋 470 - 49% open · ⏱️ 20.01.2022):

	```
	git clone https://github.com/dask/dask-ml
	```
- [PyPi](https://pypi.org/project/dask-ml) (📥 74K / month · 📦 55 · ⏱️ 22.01.2022):
	```
	pip install dask-ml
	```
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 84 · 🔀 640 · 📋 540 - 42% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/mmlspark) (📥 54K / month · ⏱️ 18.03.2020):
	```
...
- [GitHub](https://github.com/yahoo/TensorFlowOnSpark) (👨‍💻 34 · 🔀 960 · 📋 360 - 1% open · ⏱️ 10.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflowonspark) (📥 420K / month · 📦 5 · ⏱️ 25.05.2021):
	```
...
<details><summary><b><a href="https://github.com/microsoft/SynapseML">SynapseML</a></b> (🥉26 ·  ⭐ 3.2K) - Simple and Distributed Machine Learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 84 · 🔀 640 · 📋 540 - 42% open · ⏱️ 28.02.2022):
	...
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/synapseml) (📥 7.4K / month · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/tensorflow/mesh) (👨‍💻 45 · 🔀 200 · 📦 640 · 📋 100 - 86% open · ⏱️ 18.02.2022):
...
- [GitHub](https://github.com/maxpumperla/elephas) (👨‍💻 27 · 🔀 290 · 📦 53 · 📋 160 - 15% open · ⏱️ 17.08.2021):

	```
	git clone https://github.com/maxpumperla/elephas
	```
- [PyPi](https://pypi.org/project/elephas) (📥 35K / month · 📦 3 · ⏱️ 17.08.2021):
	```
	pip install elephas
	```
...
<details><summary><b><a href="https://github.com/learning-at-home/hivemind">Hivemind</a></b> (🥉21 ·  ⭐ 980) - Decentralized deep learning in PyTorch. Built to train models on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 20 · 🔀 58 · 📦 4 · 📋 120 - 35% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/learning-at-home/hivemind
	```
- [PyPi](https://pypi.org/project/hivemind) (📥 680 / month · 📦 1 · ⏱️ 20.12.2021):
	```
...
<details><summary><b><a href="https://github.com/facebookincubator/submitit">Submit it</a></b> (🥉20 ·  ⭐ 570) - Python 3.6+ toolbox for submitting jobs to Slurm. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookincubator/submitit) (👨‍💻 17 · 🔀 56 · 📋 58 - 43% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/facebookincubator/submitit
	```
- [PyPi](https://pypi.org/project/submitit) (📥 17K / month · 📦 6 · ⏱️ 30.11.2021):
	```
...
- [GitHub](https://github.com/uber/fiber) (👨‍💻 5 · 🔀 110 · 📦 31 · 📋 28 - 71% open · ⏱️ 15.03.2021):
...
- [GitHub](https://github.com/tunib-ai/parallelformers) (👨‍💻 4 · 🔀 23 · 📦 4 · 📋 13 - 23% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/kingoflolz/mesh-transformer-jax) (👨‍💻 23 · 🔀 480 · 📋 160 - 10% open · ⏱️ 28.01.2022):
...
- [GitHub](https://github.com/optuna/optuna) (👨‍💻 180 · 🔀 660 · 📦 2.7K · 📋 1.1K - 12% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/optuna/optuna
	```
- [PyPi](https://pypi.org/project/optuna) (📥 1M / month · 📦 180 · ⏱️ 14.02.2022):
	```
	pip install optuna
	```
...
- [GitHub](https://github.com/microsoft/nni) (👨‍💻 160 · 🔀 1.6K · 📦 200 · 📋 1.5K - 18% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/microsoft/nni
	```
- [PyPi](https://pypi.org/project/nni) (📥 30K / month · 📦 28 · ⏱️ 18.02.2022):
	```
	pip install nni
	```
</details>
...
- [GitHub](https://github.com/alteryx/featuretools) (👨‍💻 63 · 🔀 790 · 📦 940 · 📋 740 - 22% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/alteryx/featuretools
	```
- [PyPi](https://pypi.org/project/featuretools) (📥 540K / month · 📦 62 · ⏱️ 17.02.2022):
	```
...
- [GitHub](https://github.com/keras-team/autokeras) (👨‍💻 130 · 🔀 1.3K · 📥 2.9K · 📦 280 · 📋 810 - 9% open · ⏱️ 19.02.2022):

	```
	git clone https://github.com/keras-team/autokeras
	```
- [PyPi](https://pypi.org/project/autokeras) (📥 44K / month · 📦 10 · ⏱️ 18.02.2022):
	```
...
- [GitHub](https://github.com/hyperopt/hyperopt) (👨‍💻 93 · 🔀 920 · 📦 5.9K · 📋 600 - 60% open · ⏱️ 29.11.2021):
...
- [PyPi](https://pypi.org/project/hyperopt) (📥 2M / month · 📦 400 · ⏱️ 17.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hyperopt) (📥 360K · ⏱️ 14.10.2020):
	```
...
- [GitHub](https://github.com/automl/auto-sklearn) (👨‍💻 79 · 🔀 1.1K · 📥 20 · 📦 260 · 📋 850 - 12% open · ⏱️ 18.02.2022):

	```
	git clone https://github.com/automl/auto-sklearn
	```
- [PyPi](https://pypi.org/project/auto-sklearn) (📥 32K / month · 📦 30 · ⏱️ 18.02.2022):
	```
	pip install auto-sklearn
	```
- [Conda](https://anaconda.org/conda-forge/auto-sklearn) (📥 3.2K · ⏱️ 18.02.2022):
	```
...
- [GitHub](https://github.com/keras-team/keras-tuner) (👨‍💻 43 · 🔀 320 · 📦 1.2K · 📋 370 - 43% open · ⏱️ 01.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/keras-tuner) (📥 540K / month · 📦 38 · ⏱️ 01.03.2022):
	```
	pip install keras-tuner
	```
- [Conda](https://anaconda.org/conda-forge/keras-tuner) (📥 5.2K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/scikit-optimize/scikit-optimize) (👨‍💻 76 · 🔀 420 · 📦 2.4K · 📋 620 - 37% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/pytorch/botorch) (👨‍💻 68 · 🔀 250 · 📦 210 · 📋 240 - 23% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/pytorch/botorch
	```
- [PyPi](https://pypi.org/project/botorch) (📥 160K / month · 📦 13 · ⏱️ 28.02.2022):
	```
	pip install botorch
	```
- [Conda](https://anaconda.org/conda-forge/botorch) (📥 19K · ⏱️ 01.03.2022):
	```
...
- [GitHub](https://github.com/facebook/Ax) (👨‍💻 110 · 🔀 180 · 📦 240 · 📋 370 - 10% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/facebook/Ax
	```
- [PyPi](https://pypi.org/project/ax-platform) (📥 120K / month · 📦 14 · ⏱️ 16.12.2021):
	```
	pip install ax-platform
	```
- [Conda](https://anaconda.org/conda-forge/ax-platform) (📥 740 · ⏱️ 22.06.2021):
	```
	conda install -c conda-forge ax-platform
	```
</details>
<details><summary><b><a href="https://github.com/awslabs/autogluon">AutoGluon</a></b> (🥈30 ·  ⭐ 4.2K) - AutoGluon: AutoML for Image, Text, and Tabular Data. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1X" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/awslabs/autogluon) (👨‍💻 66 · 🔀 560 · 📦 100 · 📋 630 - 21% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/awslabs/autogluon
	```
- [PyPi](https://pypi.org/project/autogluon) (📥 70K / month · 📦 4 · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/nevergrad) (👨‍💻 47 · 🔀 310 · 📦 290 · 📋 260 - 41% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/facebookresearch/nevergrad
	```
- [PyPi](https://pypi.org/project/nevergrad) (📥 20K / month · 📦 18 · ⏱️ 21.02.2022):
	```
...
- [GitHub](https://github.com/mljar/mljar-supervised) (👨‍💻 17 · 🔀 250 · 📦 39 · 📋 460 - 16% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/mljar/mljar-supervised
	```
- [PyPi](https://pypi.org/project/mljar-supervised) (📥 22K / month · 📦 2 · ⏱️ 02.03.2022):
	```
	pip install mljar-supervised
	```
- [Conda](https://anaconda.org/conda-forge/mljar-supervised) (📥 1.1K · ⏱️ 02.03.2022):
	```
...
- [GitHub](https://github.com/autonomio/talos) (👨‍💻 21 · 🔀 250 · 📦 140 · 📋 400 - 8% open · ⏱️ 28.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/talos) (📥 1.5K / month · 📦 6 · ⏱️ 28.01.2022):
	```
	pip install talos
	```
</details>
...
- [GitHub](https://github.com/automl/SMAC3) (👨‍💻 38 · 🔀 170 · 📋 360 - 19% open · ⏱️ 17.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/smac) (📥 26K / month · 📦 34 · ⏱️ 17.02.2022):
	```
	pip install smac
	```
- [Conda](https://anaconda.org/conda-forge/smac) (📥 2.3K · ⏱️ 21.10.2021):
	```
...
- [GitHub](https://github.com/tensorflow/adanet) (👨‍💻 27 · 🔀 520 · 📦 42 · 📋 110 - 57% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/adanet) (📥 2.3K / month · 📦 2 · ⏱️ 09.07.2020):
	```
	pip install adanet
	```
</details>
...
- [GitHub](https://github.com/SimonBlanke/Hyperactive) (👨‍💻 4 · 🔀 32 · 📥 98 · 📦 11 · 📋 44 - 15% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/SimonBlanke/Hyperactive
	```
- [PyPi](https://pypi.org/project/hyperactive) (📥 1.3K / month · 📦 3 · ⏱️ 05.12.2021):
	```
...
- [GitHub](https://github.com/Neuraxio/Neuraxle) (👨‍💻 7 · 🔀 53 · 📦 28 · 📋 350 - 40% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/Neuraxio/Neuraxle
	```
- [PyPi](https://pypi.org/project/neuraxle) (📥 560 / month · 📦 1 · ⏱️ 17.10.2021):
	```
	pip install neuraxle
	```
</details>
<details><summary><b><a href="https://github.com/shankarpandala/lazypredict">lazypredict</a></b> (🥉21 ·  ⭐ 300) - Lazy Predict help build a lot of basic models without much code.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/shankarpandala/lazypredict) (👨‍💻 17 · 🔀 46 · 📦 240 · 📋 62 - 46% open · ⏱️ 29.01.2022):
...
- [PyPi](https://pypi.org/project/lazypredict) (📥 7.9K / month · ⏱️ 17.02.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/lazypredict) (📥 280 · ⏱️ 24.08.2021):
	```
...
- [GitHub](https://github.com/ScottfreeLLC/AlphaPy) (👨‍💻 3 · 🔀 150 · 📦 3 · 📋 41 - 29% open · ⏱️ 23.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/alphapy) (📥 670 / month · ⏱️ 29.08.2020):
	```
	pip install alphapy
	```
</details>
...
- [GitHub](https://github.com/rsteca/sklearn-deap) (👨‍💻 22 · 🔀 110 · 📦 31 · 📋 55 - 38% open · ⏱️ 30.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-deap) (📥 750 / month · 📦 2 · ⏱️ 30.07.2021):
	```
...
- [GitHub](https://github.com/AutoViML/Auto_ViML) (👨‍💻 6 · 🔀 70 · 📦 15 · 📋 18 - 22% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/autoviml) (📥 3.6K / month · 📦 2 · ⏱️ 06.12.2021):
	```
...
- [GitHub](https://github.com/google/model_search) (👨‍💻 1 · 🔀 330 · 📋 50 - 70% open · ⏱️ 09.02.2022):
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 350 · 🔀 7.6K · 📦 27K · 📋 1.5K - 6% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 420K / month · 📦 2.4K · ⏱️ 18.02.2022):
	```
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 92K · ⏱️ 08.02.2022):
	```
	conda install -c conda-forge gym
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/agents">TF-Agents</a></b> (🥇32 ·  ⭐ 2.2K) - TF-Agents: A reliable, scalable and easy to use TensorFlow.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 120 · 🔀 600 · 📦 720 · 📋 540 - 21% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/tensorlayer/TensorLayer) (👨‍💻 130 · 🔀 1.5K · 📥 1.4K · 📋 470 - 6% open · ⏱️ 29.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/tensorlayer) (📥 3.2K / month · 📦 40 · ⏱️ 15.02.2022):
	```
...
- [GitHub](https://github.com/AI4Finance-Foundation/FinRL) (👨‍💻 56 · 🔀 940 · 📦 10 · 📋 380 - 20% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/AI4Finance-Foundation/FinRL
	```
- [PyPi](https://pypi.org/project/finrl) (📥 660 / month · ⏱️ 08.01.2022):
	```
	pip install finrl
	```
</details>
...
- [GitHub](https://github.com/deepmind/acme) (👨‍💻 62 · 🔀 310 · 📦 59 · 📋 170 - 25% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/dm-acme) (📥 5.2K / month · 📦 2 · ⏱️ 10.02.2022):
	```
	pip install dm-acme
	```
...
<details><summary><b><a href="https://github.com/PaddlePaddle/PARL">PARL</a></b> (🥈28 ·  ⭐ 2.4K) - A high-performance distributed training framework for Reinforcement.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PaddlePaddle/PARL) (👨‍💻 29 · 🔀 630 · 📦 87 · 📋 310 - 22% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/PaddlePaddle/PARL
	```
- [PyPi](https://pypi.org/project/parl) (📥 1.2K / month · ⏱️ 30.12.2021):
	```
	pip install parl
	```
</details>
...
- [GitHub](https://github.com/mwydmuch/ViZDoom) (👨‍💻 46 · 🔀 320 · 📥 11K · 📦 120 · 📋 440 - 20% open · ⏱️ 20.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/vizdoom) (📥 1.7K / month · 📦 14 · ⏱️ 22.11.2021):
	```
	pip install vizdoom
	```
</details>
...
- [GitHub](https://github.com/tensorforce/tensorforce) (👨‍💻 82 · 🔀 510 · 📋 630 - 1% open · ⏱️ 10.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorforce) (📥 2.6K / month · 📦 26 · ⏱️ 07.09.2019):
	```
	pip install tensorforce
	```
</details>
<details><summary><b><a href="https://github.com/google/dopamine">Dopamine</a></b> (🥉26 ·  ⭐ 9.7K · 📉) - Dopamine is a research framework for fast prototyping of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/google/dopamine) (👨‍💻 14 · 🔀 1.3K · 📋 160 - 49% open · ⏱️ 14.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/dopamine-rl) (📥 35K / month · 📦 37 · ⏱️ 13.12.2021):
	```
...
- [GitHub](https://github.com/hill-a/stable-baselines) (👨‍💻 110 · 🔀 670 · 📋 930 - 13% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stable-baselines) (📥 9.5K / month · 📦 34 · ⏱️ 06.04.2021):
	```
...
- [GitHub](https://github.com/rlworkgroup/garage) (👨‍💻 78 · 🔀 240 · 📦 31 · 📋 1K - 20% open · ⏱️ 20.10.2021):
...
- [GitHub](https://github.com/chainer/chainerrl) (👨‍💻 29 · 🔀 210 · 📦 110 · 📋 220 - 33% open · ⏱️ 17.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/chainerrl) (📥 700 / month · 📦 8 · ⏱️ 14.02.2020):
	```
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 130 · 🔀 440 · 📋 120 - 35% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/facebookresearch/ReAgent
	```
- [PyPi](https://pypi.org/project/reagent) (📥 51 / month · ⏱️ 27.05.2020):
	```
	pip install reagent
	```
</details>
...
- [GitHub](https://github.com/deepmind/trfl) (👨‍💻 13 · 🔀 370 · 📦 73 · 📋 22 - 27% open · ⏱️ 16.08.2021):
...
<details><summary><b><a href="https://github.com/deepmind/rlax">RLax</a></b> (🥉21 ·  ⭐ 750) - A library of reinforcement learning building blocks in JAX. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepmind/rlax) (👨‍💻 17 · 🔀 58 · 📦 37 · 📋 22 - 54% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/deepmind/rlax
	```
- [PyPi](https://pypi.org/project/rlax) (📥 3.6K / month · 📦 1 · ⏱️ 24.02.2022):
	```
	pip install rlax
	```
</details>
...
- [GitHub](https://github.com/pfnet/pfrl) (👨‍💻 15 · 🔀 110 · 📦 33 · 📋 61 - 44% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/pfnet/pfrl
	```
- [PyPi](https://pypi.org/project/pfrl) (📥 660 / month · 📦 1 · ⏱️ 07.07.2021):
	```
	pip install pfrl
	```
</details>
<details><summary><b><a href="https://github.com/google-research/rliable">rliable</a></b> (🥉11 ·  ⭐ 340) - [NeurIPS21 Outstanding Paper] Library for reliable evaluation on RL.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google-research/rliable) (👨‍💻 2 · 🔀 19 · 📦 6 · ⏱️ 28.02.2022):
...
- <b><a href="https://github.com/enlite-ai/maze">Maze</a></b> (🥉17 ·  ⭐ 200) - Maze Applied Reinforcement Learning Framework. <code><a href="https://tldrlegal.com/search?q=Custom">❗️Custom</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/microsoft/recommenders) (👨‍💻 100 · 🔀 2.1K · 📥 130 · 📦 11 · 📋 660 - 19% open · ⏱️ 13.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/recommenders) (📥 7.6K / month · 📦 2 · ⏱️ 14.03.2021):
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 30 · 🔀 530 · 📦 560 · 📋 380 - 17% open · ⏱️ 20.02.2022):
...
<details><summary><b><a href="https://github.com/lyst/lightfm">lightfm</a></b> (🥈29 ·  ⭐ 3.9K) - A Python implementation of LightFM, a hybrid recommendation algorithm. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 610 · 📦 650 · 📋 440 - 21% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/lightfm) (📥 290K / month · 📦 45 · ⏱️ 27.11.2020):
	```
	pip install lightfm
	```
...
- [GitHub](https://github.com/tensorflow/recommenders) (👨‍💻 30 · 🔀 170 · 📦 74 · 📋 240 - 54% open · ⏱️ 01.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-recommenders) (📥 490K / month · 📦 1 · ⏱️ 23.08.2021):
	```
...
- [GitHub](https://github.com/tensorflow/ranking) (👨‍💻 25 · 🔀 410 · 📋 280 - 17% open · ⏱️ 22.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow_ranking) (📥 44K / month · 📦 11 · ⏱️ 16.11.2021):
	```
	pip install tensorflow_ranking
	```
</details>
<details><summary><b><a href="https://github.com/RUCAIBox/RecBole">RecBole</a></b> (🥉26 ·  ⭐ 1.6K) - A unified, comprehensive and efficient recommendation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/RUCAIBox/RecBole) (👨‍💻 46 · 🔀 300 · 📋 340 - 15% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/RUCAIBox/RecBole
	```
- [PyPi](https://pypi.org/project/recbole) (📥 930 / month · ⏱️ 25.02.2022):
	```
	pip install recbole
	```
...
- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 13 · 🔀 87 · 📦 76 · 📋 88 - 4% open · ⏱️ 19.02.2022):

	```
	git clone https://github.com/PreferredAI/cornac
	```
- [PyPi](https://pypi.org/project/cornac) (📥 18K / month · 📦 15 · ⏱️ 19.02.2022):
	```
	pip install cornac
	```
...
<details><summary><b><a href="https://github.com/ibayer/fastFM">fastFM</a></b> (🥉22 ·  ⭐ 970 · 💤) - fastFM: A Library for Factorization Machines. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 190 · 📥 430 · 📦 95 · 📋 110 - 43% open · ⏱️ 24.03.2021):

	```
	git clone https://github.com/ibayer/fastFM
	```
- [PyPi](https://pypi.org/project/fastfm) (📥 1.2K / month · 📦 8 · ⏱️ 23.11.2017):
	```
	pip install fastfm
	```
</details>
...
<details><summary><b><a href="https://github.com/statisticianinstilettos/recmetrics">recmetrics</a></b> (🥉19 ·  ⭐ 350) - A library of metrics for evaluating recommender systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/statisticianinstilettos/recmetrics) (👨‍💻 13 · 🔀 82 · 📦 23 · 📋 17 - 41% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/recmetrics) (📥 1.5K / month · ⏱️ 24.09.2021):
	```
...
<details><summary><b><a href="https://github.com/OpenMined/PySyft">PySyft</a></b> (🥇34 ·  ⭐ 8K) - A library for answering questions using data you cannot see. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/OpenMined/PySyft) (👨‍💻 430 · 🔀 1.8K · 📋 3.1K - 10% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/OpenMined/PySyft
	```
- [PyPi](https://pypi.org/project/syft) (📥 5.1K / month · 📦 5 · ⏱️ 27.02.2022):
	```
	pip install syft
	```
</details>
<details><summary><b><a href="https://github.com/FederatedAI/FATE">FATE</a></b> (🥈27 ·  ⭐ 4K · 📈) - An Industrial Grade Federated Learning Framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/tensorflow/privacy) (👨‍💻 45 · 🔀 350 · 📥 68 · 📋 150 - 43% open · ⏱️ 01.03.2022):
...
- [GitHub](https://github.com/pytorch/opacus) (👨‍💻 44 · 🔀 180 · 📥 43 · 📦 82 · 📋 140 - 19% open · ⏱️ 03.03.2022):
...
- [PyPi](https://pypi.org/project/opacus) (📥 4.6K / month · 📦 11 · ⏱️ 09.02.2022):
	...
	pip install opacus
	```
- [Conda](https://anaconda.org/conda-forge/opacus) (📥 180 · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/CrypTen) (👨‍💻 26 · 🔀 160 · 📦 14 · 📋 140 - 17% open · ⏱️ 24.02.2022):

	```
	git clone https://github.com/facebookresearch/CrypTen
	```
- [PyPi](https://pypi.org/project/crypten) (📥 350 / month · ⏱️ 09.09.2021):
	```
	pip install crypten
	```
</details>
...
- <b><a href="https://github.com/tf-encrypted/tf-encrypted">TFEncrypted</a></b> (🥉25 ·  ⭐ 990 · 💀) - A Framework for Encrypted Machine Learning in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 280 · 🔀 1.5K · 📦 97K · 📋 1.7K - 33% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 360 · 🔀 2.5K · 📋 2.2K - 45% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/mlflow/mlflow
	```
- [PyPi](https://pypi.org/project/mlflow) (📥 9.9M / month · 📦 280 · ⏱️ 28.02.2022):
	```
	pip install mlflow
	```
...
<details><summary><b><a href="https://github.com/pycaret/pycaret">PyCaret</a></b> (🥇37 ·  ⭐ 5.2K) - An open-source, low-code machine learning library in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/pycaret) (📥 320K / month · 📦 12 · ⏱️ 12.01.2022):
	...
	pip install pycaret
	```
- [Conda](https://anaconda.org/conda-forge/pycaret) (📥 7.5K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 250 · 🔀 750 · 📦 1.2K · 📋 990 - 34% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/aws/sagemaker-python-sdk
	```
- [PyPi](https://pypi.org/project/sagemaker) (📥 3.9M / month · 📦 46 · ⏱️ 25.02.2022):
	```
	pip install sagemaker
	```
- [Conda](https://anaconda.org/conda-forge/sagemaker-python-sdk) (📥 240K · ⏱️ 25.02.2022):
	```
	conda install -c conda-forge sagemaker-python-sdk
	```
</details>
<details><summary><b><a href="https://github.com/iterative/dvc">DVC</a></b> (🥈36 ·  ⭐ 9.4K) - Data Version Control | Git for Data & Models | ML Experiments Management. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/iterative/dvc) (👨‍💻 260 · 🔀 900 · 📥 64K · 📋 3.6K - 17% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/iterative/dvc
	```
- [PyPi](https://pypi.org/project/dvc) (📥 340K / month · 📦 46 · ⏱️ 21.02.2022):
	```
	pip install dvc
	```
...
- [GitHub](https://github.com/wandb/client) (👨‍💻 100 · 🔀 300 · 📋 1.7K - 21% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/wandb/client
	```
- [PyPi](https://pypi.org/project/wandb) (📥 1.1M / month · 📦 210 · ⏱️ 01.03.2022):
	```
	pip install wandb
	```
- [Conda](https://anaconda.org/conda-forge/wandb) (📥 45K · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/lanpa/tensorboardX) (👨‍💻 70 · 🔀 850 · 📥 340 · 📦 17K · 📋 440 - 16% open · ⏱️ 19.02.2022):

	```
	git clone https://github.com/lanpa/tensorboardX
	```
- [PyPi](https://pypi.org/project/tensorboardX) (📥 1M / month · 📦 880 · ⏱️ 22.02.2022):
	```
...
- [GitHub](https://github.com/Azure/MachineLearningNotebooks) (👨‍💻 59 · 🔀 2K · 📥 430 · 📋 1.2K - 17% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/azureml-sdk) (📥 1.9M / month · 📦 45 · ⏱️ 28.02.2022):
	```
...
- [GitHub](https://github.com/allegroai/clearml) (👨‍💻 46 · 🔀 410 · 📥 410 · 📦 200 · 📋 470 - 36% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/allegroai/clearml
	```
- [PyPi](https://pypi.org/project/clearml) (📥 73K / month · 📦 4 · ⏱️ 02.03.2022):
	```
	pip install clearml
	```
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 240 · 🔀 300 · 📦 1K · 📋 860 - 61% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/snakemake) (📥 48K / month · 📦 210 · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 47 · 🔀 470 · 📦 250 · 📋 430 - 52% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/Netflix/metaflow
	```
- [PyPi](https://pypi.org/project/metaflow) (📥 51K / month · 📦 6 · ⏱️ 17.02.2022):
	```
...
- [GitHub](https://github.com/catalyst-team/catalyst) (👨‍💻 100 · 🔀 360 · 📦 490 · 📋 330 - 0% open · ⏱️ 27.02.2022):

	```
	git clone https://github.com/catalyst-team/catalyst
	```
- [PyPi](https://pypi.org/project/catalyst) (📥 280K / month · 📦 29 · ⏱️ 27.02.2022):
	```
...
- [GitHub](https://github.com/aimhubio/aim) (👨‍💻 29 · 🔀 130 · 📦 54 · 📋 370 - 29% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/aim) (📥 23K / month · 📦 2 · ⏱️ 02.03.2022):
	```
	pip install aim
	```
- [Conda](https://anaconda.org/conda-forge/aim) (📥 7.5K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 31 · 🔀 580 · 📥 170 · 📦 990 · 📋 390 - 15% open · ⏱️ 30.12.2021):

	```
	git clone https://github.com/PaddlePaddle/VisualDL
	```
- [PyPi](https://pypi.org/project/visualdl) (📥 56K / month · 📦 23 · ⏱️ 06.01.2022):
	```
...
- [PyPi](https://pypi.org/project/sacred) (📥 29K / month · 📦 100 · ⏱️ 14.12.2020):
	...
	pip install sacred
	```
- [Conda](https://anaconda.org/conda-forge/sacred) (📥 160 · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/google/ml-metadata) (👨‍💻 13 · 🔀 90 · 📥 1.7K · 📦 190 · 📋 82 - 26% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/google/ml-metadata
	```
- [PyPi](https://pypi.org/project/ml-metadata) (📥 440K / month · 📦 18 · ⏱️ 28.02.2022):
	```
	pip install ml-metadata
	```
</details>
<details><summary><b><a href="https://github.com/Kaggle/kaggle-api">kaggle</a></b> (🥉27 ·  ⭐ 4.6K · 💤) - Official Kaggle API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Kaggle/kaggle-api) (👨‍💻 36 · 🔀 890 · 📋 340 - 56% open · ⏱️ 15.03.2021):
...
- [GitHub](https://github.com/guildai/guildai) (👨‍💻 18 · 🔀 59 · 📦 46 · 📋 300 - 38% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/guildai/guildai
	```
- [PyPi](https://pypi.org/project/guildai) (📥 6.5K / month · ⏱️ 07.02.2022):
	```
	pip install guildai
	```
</details>
...
- [GitHub](https://github.com/labmlai/labml) (👨‍💻 6 · 🔀 71 · 📦 42 · 📋 25 - 52% open · ⏱️ 27.02.2022):

	```
	git clone https://github.com/labmlai/labml
	```
- [PyPi](https://pypi.org/project/labml) (📥 7.7K / month · 📦 6 · ⏱️ 18.01.2022):
	```
	pip install labml
	```
</details>
<details><summary><b><a href="https://github.com/instacart/lore">lore</a></b> (🥉23 ·  ⭐ 1.5K) - Lore makes machine learning approachable for Software Engineers and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/instacart/lore) (👨‍💻 24 · 🔀 130 · 📦 18 · 📋 44 - 59% open · ⏱️ 18.02.2022):

	```
	git clone https://github.com/instacart/lore
	```
- [PyPi](https://pypi.org/project/lore) (📥 10K / month · 📦 1 · ⏱️ 02.02.2022):
	```
	pip install lore
	```
</details>
...
- [GitHub](https://github.com/studioml/studio) (👨‍💻 21 · 🔀 52 · 📦 5 · 📋 250 - 22% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/studioml) (📥 3.3K / month · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/replicate/keepsake) (👨‍💻 16 · 🔀 61 · 📋 190 - 65% open · ⏱️ 07.05.2021):

	```
	git clone https://github.com/replicate/keepsake
	```
- [PyPi](https://pypi.org/project/keepsake) (📥 800 / month · ⏱️ 11.03.2021):
	```
...
- <b><a href="https://github.com/m3dev/gokart">gokart</a></b> (🥉23 ·  ⭐ 230) - Gokart solves reproducibility, task dependencies, constraints of good code,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/gradsflow/chitra">chitra</a></b> (🥉20 ·  ⭐ 180) - A multi-functional library for full-stack Deep Learning. Simplifies.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/google/caliban">caliban</a></b> (🥉16 ·  ⭐ 410 · 💀) - Research workflows made easy, locally and in the Cloud. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 220 · 🔀 2.5K · 📥 17K · 📦 5.7K · 📋 1.9K - 27% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/onnx/onnx
	```
- [PyPi](https://pypi.org/project/onnx) (📥 1.4M / month · 📦 350 · ⏱️ 17.02.2022):
	```
	pip install onnx
	```
...
- [GitHub](https://github.com/apple/coremltools) (👨‍💻 120 · 🔀 400 · 📥 4.1K · 📦 780 · 📋 890 - 37% open · ⏱️ 22.02.2022):

	```
	git clone https://github.com/apple/coremltools
	```
- [PyPi](https://pypi.org/project/coremltools) (📥 89K / month · 📦 140 · ⏱️ 22.02.2022):
	```
...
- [GitHub](https://github.com/pytorch/serve) (👨‍💻 99 · 🔀 480 · 📥 960 · 📋 800 - 15% open · ⏱️ 03.03.2022):
...
<details><summary><b><a href="https://github.com/huggingface/huggingface_hub">huggingface_hub</a></b> (🥈29 ·  ⭐ 350) - All the open source things related to the Hugging Face Hub. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/huggingface/huggingface_hub) (👨‍💻 58 · 🔀 80 · 📋 230 - 48% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/huggingface_hub) (📥 3M / month · 📦 51 · ⏱️ 11.01.2022):
	```
...
- [GitHub](https://github.com/openai/triton) (👨‍💻 34 · 🔀 260 · 📦 70 · 📋 180 - 33% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/openai/triton
	```
- [PyPi](https://pypi.org/project/triton) (📥 60K / month · 📦 2 · ⏱️ 25.02.2022):
	```
	pip install triton
	```
</details>
...
- [GitHub](https://github.com/bentoml/BentoML) (👨‍💻 100 · 🔀 380 · 📥 930 · 📋 560 - 10% open · ⏱️ 03.03.2022):
...
- [GitHub](https://github.com/microsoft/hummingbird) (👨‍💻 28 · 🔀 210 · 📥 160 · 📦 22 · 📋 240 - 22% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/microsoft/hummingbird
	```
- [PyPi](https://pypi.org/project/hummingbird-ml) (📥 3K / month · ⏱️ 14.12.2021):
	```
	pip install hummingbird-ml
	```
- [Conda](https://anaconda.org/conda-forge/hummingbird-ml) (📥 5.6K · ⏱️ 14.12.2021):
	```
...
- [GitHub](https://github.com/BayesWitnesses/m2cgen) (👨‍💻 13 · 🔀 170 · 📦 17 · 📋 100 - 35% open · ⏱️ 20.02.2022):

	```
	git clone https://github.com/BayesWitnesses/m2cgen
	```
- [PyPi](https://pypi.org/project/m2cgen) (📥 36K / month · ⏱️ 18.09.2020):
	```
	pip install m2cgen
	```
</details>
...
<details><summary><b><a href="https://github.com/slundberg/shap">shap</a></b> (🥇38 ·  ⭐ 16K) - A game theoretic approach to explain the output of any machine learning model. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/marcotcr/lime) (👨‍💻 61 · 🔀 1.5K · 📦 2K · 📋 550 - 5% open · ⏱️ 29.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/lime) (📥 720K / month · 📦 110 · ⏱️ 26.06.2020):
	```
	pip install lime
	```
...
- [GitHub](https://github.com/arviz-devs/arviz) (👨‍💻 110 · 🔀 260 · 📥 110 · 📦 2K · 📋 760 - 25% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/pytorch/captum) (👨‍💻 81 · 🔀 310 · 📦 420 · 📋 340 - 23% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/pytorch/captum
	```
- [PyPi](https://pypi.org/project/captum) (📥 42K / month · 📦 17 · ⏱️ 02.11.2021):
	```
	pip install captum
	```
- [Conda](https://anaconda.org/conda-forge/captum) (📥 250 · ⏱️ 27.01.2022):
	```
...
- [GitHub](https://github.com/bmabey/pyLDAvis) (👨‍💻 32 · 🔀 320 · 📦 3.1K · 📋 160 - 52% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyldavis) (📥 640K / month · 📦 130 · ⏱️ 24.03.2021):
	```
...
- [GitHub](https://github.com/tensorflow/model-analysis) (👨‍💻 38 · 🔀 240 · 📋 74 - 36% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/tensorflow/model-analysis
	```
- [PyPi](https://pypi.org/project/tensorflow-model-analysis) (📥 960K / month · 📦 21 · ⏱️ 24.01.2022):
	```
	pip install tensorflow-model-analysis
	```
</details>
<details><summary><b><a href="https://github.com/DistrictDataLabs/yellowbrick">yellowbrick</a></b> (🥈29 ·  ⭐ 3.5K · 📈) - Visual analysis and diagnostic tools to facilitate.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/DistrictDataLabs/yellowbrick) (👨‍💻 100 · 🔀 510 · 📋 660 - 14% open · ⏱️ 26.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/yellowbrick) (📥 400K / month · 📦 62 · ⏱️ 19.02.2022):
	```
...
<details><summary><b><a href="https://github.com/microsoft/dowhy">DoWhy</a></b> (🥈28 ·  ⭐ 3.7K) - DoWhy is a Python library for causal inference that supports explicit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/dowhy) (👨‍💻 48 · 🔀 560 · 📥 24 · 📦 88 · 📋 180 - 28% open · ⏱️ 16.02.2022):

	```
	git clone https://github.com/Microsoft/dowhy
	```
- [PyPi](https://pypi.org/project/dowhy) (📥 120K / month · 📦 4 · ⏱️ 10.01.2022):
	```
	pip install dowhy
	```
...
- [GitHub](https://github.com/parrt/dtreeviz) (👨‍💻 17 · 🔀 260 · 📦 310 · 📋 120 - 18% open · ⏱️ 21.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/dtreeviz) (📥 82K / month · 📦 14 · ⏱️ 09.02.2022):
	```
	pip install dtreeviz
	```
- [Conda](https://anaconda.org/conda-forge/dtreeviz) (📥 7.7K · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/MAIF/shapash) (👨‍💻 31 · 🔀 210 · 📦 66 · 📋 100 - 12% open · ⏱️ 25.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/shapash) (📥 18K / month · ⏱️ 14.01.2022):
	```
	pip install shapash
	```
</details>
...
- [GitHub](https://github.com/SeldonIO/alibi) (👨‍💻 18 · 🔀 180 · 📦 140 · 📋 270 - 41% open · ⏱️ 04.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/alibi) (📥 42K / month · 📦 22 · ⏱️ 28.01.2022):
	```
	pip install alibi
	```
</details>
<details><summary><b><a href="https://github.com/fairlearn/fairlearn">fairlearn</a></b> (🥈27 ·  ⭐ 1.2K) - A Python package to assess and improve fairness of machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/fairlearn/fairlearn) (👨‍💻 64 · 🔀 290 · 📋 330 - 40% open · ⏱️ 28.02.2022):
...
- [GitHub](https://github.com/tensorflow/lucid) (👨‍💻 40 · 🔀 590 · 📦 610 · 📋 170 - 41% open · ⏱️ 19.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/lucid) (📥 2K / month · 📦 6 · ⏱️ 19.03.2021):
	```
	pip install lucid
	```
</details>
...
- [GitHub](https://github.com/marcotcr/checklist) (👨‍💻 12 · 🔀 150 · 📦 91 · 📋 92 - 13% open · ⏱️ 28.09.2021):
...
- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 12 · 🔀 140 · 📦 65 · 📋 150 - 10% open · ⏱️ 10.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/explainerdashboard) (📥 19K / month · 📦 2 · ⏱️ 10.02.2022):
	```
...
<details><summary><b><a href="https://github.com/microsoft/responsible-ai-toolbox">responsible-ai-widgets</a></b> (🥈25 ·  ⭐ 440) - This project provides responsible AI user interfaces.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/PAIR-code/lit">LIT</a></b> (🥉24 ·  ⭐ 2.9K) - The Language Interpretability Tool: Interactively analyze NLP models for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/PAIR-code/lit) (👨‍💻 18 · 🔀 280 · 📦 7 · 📋 130 - 50% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/lit-nlp) (📥 1.6K / month · ⏱️ 21.12.2021):
	```
	pip install lit-nlp
	```
...
<details><summary><b><a href="https://github.com/csinva/imodels">imodels</a></b> (🥉24 ·  ⭐ 690) - Interpretable ML package for concise, transparent, and accurate predictive.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/csinva/imodels) (👨‍💻 8 · 🔀 62 · 📦 12 · 📋 28 - 25% open · ⏱️ 25.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/imodels) (📥 3.4K / month · ⏱️ 19.02.2022):
	```
	pip install imodels
	```
</details>
...
- [GitHub](https://github.com/Trusted-AI/AIX360) (👨‍💻 29 · 🔀 220 · 📦 39 · 📋 64 - 59% open · ⏱️ 18.02.2022):
...
- [GitHub](https://github.com/philipperemy/keract) (👨‍💻 16 · 🔀 180 · 📦 120 · 📋 84 - 3% open · ⏱️ 24.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/keract) (📥 2.9K / month · 📦 5 · ⏱️ 19.06.2021):
	```
	pip install keract
	```
</details>
...
- [GitHub](https://github.com/jalammar/ecco) (👨‍💻 10 · 🔀 85 · 📥 16 · 📦 4 · 📋 36 - 41% open · ⏱️ 18.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/ecco) (📥 1K / month · 📦 1 · ⏱️ 09.01.2022):
	```
	pip install ecco
	```
- [Conda](https://anaconda.org/conda-forge/ecco) (📥 180 · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/sicara/tf-explain) (👨‍💻 16 · 🔀 92 · 📦 100 · 📋 90 - 43% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/sicara/tf-explain
	```
- [PyPi](https://pypi.org/project/tf-explain) (📥 2.7K / month · 📦 6 · ⏱️ 18.11.2021):
	```
...
<details><summary><b><a href="https://github.com/interpretml/DiCE">DiCE</a></b> (🥉21 ·  ⭐ 780) - Generate Diverse Counterfactual Explanations for any machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/edublancas/sklearn-evaluation) (👨‍💻 7 · 🔀 28 · 📦 41 · 📋 37 - 21% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/edublancas/sklearn-evaluation
	```
- [PyPi](https://pypi.org/project/sklearn-evaluation) (📥 1.2K / month · 📦 2 · ⏱️ 17.10.2021):
	```
...
- [GitHub](https://github.com/tensorflow/tcav) (👨‍💻 19 · 🔀 120 · 📦 11 · 📋 60 - 11% open · ⏱️ 16.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/tcav) (📥 220 / month · 📦 3 · ⏱️ 23.02.2021):
	```
	pip install tcav
	```
</details>
<details><summary><b><a href="https://github.com/EthicalML/xai">XAI</a></b> (🥉18 ·  ⭐ 790) - XAI - An eXplainability toolbox for machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/marcotcr/anchor) (👨‍💻 10 · 🔀 97 · 📋 69 - 26% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/marcotcr/anchor
	```
- [PyPi](https://pypi.org/project/anchor_exp) (📥 1.4K / month · ⏱️ 26.06.2020):
	```
...
- [GitHub](https://github.com/aerdem4/lofo-importance) (👨‍💻 3 · 🔀 53 · 📦 7 · 📋 18 - 27% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/lofo-importance) (📥 530 / month · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/MisaOgura/flashtorch) (👨‍💻 2 · 🔀 81 · 📦 9 · 📋 32 - 31% open · ⏱️ 27.04.2021):
...
- [GitHub](https://github.com/interpretml/interpret-text) (👨‍💻 17 · 🔀 54 · 📋 74 - 78% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/interpret-text) (📥 220 / month · ⏱️ 07.12.2021):
	```
...
<details><summary><b><a href="https://github.com/milvus-io/milvus">Milvus</a></b> (🥇39 ·  ⭐ 9.6K) - An open-source vector database for scalable similarity search and AI.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/milvus-io/milvus) (👨‍💻 190 · 🔀 1.4K · 📥 9.7K · 📋 4.6K - 6% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/milvus-io/milvus
	```
- [PyPi](https://pypi.org/project/pymilvus) (📥 33K / month · 📦 15 · ⏱️ 23.02.2022):
	```
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 80 · 🔀 970 · 📦 1.9K · 📋 340 - 11% open · ⏱️ 03.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/annoy) (📥 830K / month · 📦 240 · ⏱️ 18.09.2020):
	```
	pip install annoy
	```
...
- [GitHub](https://github.com/nmslib/hnswlib) (👨‍💻 56 · 🔀 360 · 📦 200 · 📋 240 - 50% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/nmslib/hnswlib
	```
- [PyPi](https://pypi.org/project/hnswlib) (📥 62K / month · 📦 20 · ⏱️ 14.02.2022):
	```
	pip install hnswlib
	```
- [Conda](https://anaconda.org/conda-forge/hnswlib) (📥 36K · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/nmslib/nmslib) (👨‍💻 45 · 🔀 380 · 📦 560 · 📋 390 - 15% open · ⏱️ 19.09.2021):
...
<details><summary><b><a href="https://github.com/lmcinnes/pynndescent">PyNNDescent</a></b> (🥉28 ·  ⭐ 590) - A Python nearest neighbor descent for approximate nearest neighbors. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/lmcinnes/pynndescent) (👨‍💻 18 · 🔀 78 · 📦 1.3K · 📋 97 - 46% open · ⏱️ 10.02.2022):
...
- [GitHub](https://github.com/kakao/n2) (👨‍💻 18 · 🔀 61 · 📦 22 · 📋 37 - 45% open · ⏱️ 20.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/n2) (📥 810 / month · 📦 3 · ⏱️ 16.10.2020):
	```
	pip install n2
	```
</details>
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 370 · 🔀 1.5K · 📥 1.9K · 📦 590 · 📋 2.6K - 8% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/pymc-devs/pymc
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 310K / month · 📦 230 · ⏱️ 24.08.2021):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 440 · 🔀 970 · 📋 1.2K - 46% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/tensorflow/probability
	```
- [PyPi](https://pypi.org/project/tensorflow-probability) (📥 760K / month · 📦 310 · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 120 · 🔀 880 · 📦 630 · 📋 930 - 19% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/pyro-ppl/pyro
	```
- [PyPi](https://pypi.org/project/pyro-ppl) (📥 82K / month · 📦 49 · ⏱️ 14.12.2021):
	```
	pip install pyro-ppl
	```
- [Conda](https://anaconda.org/conda-forge/pyro-ppl) (📥 4.4K · ⏱️ 14.12.2021):
	```
...
- [PyPi](https://pypi.org/project/gpytorch) (📥 180K / month · 📦 30 · ⏱️ 04.12.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gpytorch) (📥 27K · ⏱️ 14.12.2021):
	```
...
- [GitHub](https://github.com/hmmlearn/hmmlearn) (👨‍💻 38 · 🔀 690 · 📦 1.2K · 📋 380 - 14% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/hmmlearn) (📥 370K / month · 📦 130 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/pgmpy/pgmpy) (👨‍💻 100 · 🔀 630 · 📥 130 · 📦 330 · 📋 770 - 28% open · ⏱️ 21.01.2022):

	```
	git clone https://github.com/pgmpy/pgmpy
	```
- [PyPi](https://pypi.org/project/pgmpy) (📥 70K / month · 📦 9 · ⏱️ 30.12.2021):
	```
	pip install pgmpy
	```
</details>
...
- [GitHub](https://github.com/GPflow/GPflow) (👨‍💻 76 · 🔀 420 · 📦 330 · 📋 750 - 16% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/GPflow/GPflow
	```
- [PyPi](https://pypi.org/project/gpflow) (📥 9K / month · 📦 28 · ⏱️ 01.03.2022):
	```
	pip install gpflow
	```
...
<details><summary><b><a href="https://github.com/rlabbe/filterpy">filterpy</a></b> (🥈30 ·  ⭐ 2.1K · 💤) - Python Kalman filtering and optimal estimation library. Implements.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rlabbe/filterpy) (👨‍💻 36 · 🔀 480 · 📦 1.3K · 📋 200 - 23% open · ⏱️ 04.05.2021):

	```
	git clone https://github.com/rlabbe/filterpy
	```
- [PyPi](https://pypi.org/project/filterpy) (📥 640K / month · 📦 130 · ⏱️ 10.10.2018):
	```
...
<details><summary><b><a href="https://github.com/jmschrei/pomegranate">pomegranate</a></b> (🥈29 ·  ⭐ 2.8K) - Fast, flexible and easy to use probabilistic modelling in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jmschrei/pomegranate) (👨‍💻 65 · 🔀 510 · 📦 640 · 📋 670 - 8% open · ⏱️ 21.02.2022):

	```
	git clone https://github.com/jmschrei/pomegranate
	```
- [PyPi](https://pypi.org/project/pomegranate) (📥 40K / month · 📦 46 · ⏱️ 21.02.2022):
	```
...
- [GitHub](https://github.com/pydata/patsy) (👨‍💻 16 · 🔀 94 · 📦 48K · 📋 140 - 51% open · ⏱️ 26.09.2021):

	```
	git clone https://github.com/pydata/patsy
	```
- [PyPi](https://pypi.org/project/patsy) (📥 5.9M / month · 📦 2.6K · ⏱️ 26.09.2021):
	```
	pip install patsy
	```
- [Conda](https://anaconda.org/conda-forge/patsy) (📥 4.3M · ⏱️ 26.09.2021):
	```
	conda install -c conda-forge patsy
	```
</details>
<details><summary><b><a href="https://github.com/twopirllc/pandas-ta">pandas-ta</a></b> (🥉27 ·  ⭐ 2.2K) - Technical Analysis Indicators - Pandas TA is an easy to use.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/twopirllc/pandas-ta) (👨‍💻 44 · 🔀 500 · 📦 480 · 📋 360 - 15% open · ⏱️ 31.01.2022):

	```
	git clone https://github.com/twopirllc/pandas-ta
	```
- [PyPi](https://pypi.org/project/pandas-ta) (📥 58K / month · 📦 10 · ⏱️ 28.07.2021):
	```
	pip install pandas-ta
	```
- [Conda](https://anaconda.org/conda-forge/pandas-ta) (📥 360 · ⏱️ 05.10.2021):
	```
	conda install -c conda-forge pandas-ta
	```
</details>
<details><summary><b><a href="https://github.com/SALib/SALib">SALib</a></b> (🥉27 ·  ⭐ 570) - Sensitivity Analysis Library in Python. Contains Sobol, Morris, FAST, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/SALib/SALib) (👨‍💻 35 · 🔀 170 · 📋 270 - 17% open · ⏱️ 06.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/salib) (📥 140K / month · 📦 54 · ⏱️ 06.02.2022):
	```
	pip install salib
	```
...
<details><summary><b><a href="https://github.com/bambinos/bambi">bambi</a></b> (🥉25 ·  ⭐ 750) - BAyesian Model-Building Interface (Bambi) in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 23 · 🔀 77 · 📦 23 · 📋 230 - 16% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/bambi) (📥 2.7K / month · 📦 3 · ⏱️ 15.01.2022):
	```
	pip install bambi
	```
- [Conda](https://anaconda.org/conda-forge/bambi) (📥 6.6K · ⏱️ 18.01.2022):
	```
...
- [GitHub](https://github.com/uber/orbit) (👨‍💻 16 · 🔀 86 · 📦 6 · 📋 340 - 16% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/uber/orbit
	```
- [PyPi](https://pypi.org/project/orbit-ml) (📥 8K / month · 📦 1 · ⏱️ 12.01.2022):
	```
	pip install orbit-ml
	```
</details>
<details><summary><b><a href="https://github.com/ElementAI/baal">Baal</a></b> (🥉21 ·  ⭐ 550) - Library to enable Bayesian active learning in your research or labeling.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/ElementAI/baal) (👨‍💻 11 · 🔀 51 · 📋 67 - 32% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/baal) (📥 1.7K / month · 📦 1 · ⏱️ 17.12.2021):
	```
	pip install baal
	```
- [Conda](https://anaconda.org/conda-forge/baal) (📥 1.1K · ⏱️ 06.08.2021):
	```
...
- [GitHub](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (👨‍💻 91 · 🔀 770 · 📦 190 · 📋 640 - 12% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/adversarial-robustness-toolbox) (📥 7K / month · 📦 6 · ⏱️ 07.01.2022):
	```
	pip install adversarial-robustness-toolbox
	```
- [Conda](https://anaconda.org/conda-forge/adversarial-robustness-toolbox) (📥 8K · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 47 · 🔀 220 · 📦 64 · 📋 200 - 20% open · ⏱️ 28.02.2022):
...
- [GitHub](https://github.com/bethgelab/foolbox) (👨‍💻 32 · 🔀 380 · 📦 270 · 📋 360 - 16% open · ⏱️ 12.02.2022):

	```
	git clone https://github.com/bethgelab/foolbox
	```
- [PyPi](https://pypi.org/project/foolbox) (📥 2.6K / month · 📦 13 · ⏱️ 23.02.2021):
	```
	pip install foolbox
	```
...
- <b><a href="https://github.com/BorealisAI/advertorch">advertorch</a></b> (🥉20 ·  ⭐ 1K · 💤) - A Toolbox for Adversarial Robustness Research. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/cupy/cupy) (👨‍💻 300 · 🔀 580 · 📥 25K · 📦 940 · 📋 1.7K - 23% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/cupy/cupy
	```
- [PyPi](https://pypi.org/project/cupy) (📥 66K / month · 📦 150 · ⏱️ 25.02.2022):
	```
	pip install cupy
	```
...
<details><summary><b><a href="https://github.com/rapidsai/cudf">cuDF</a></b> (🥇31 ·  ⭐ 4.5K) - cuDF - GPU DataFrame Library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 230 · 🔀 590 · 📋 4.4K - 15% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/rapidsai/cudf
	```
- [PyPi](https://pypi.org/project/cudf) (📥 1.2K / month · 📦 3 · ⏱️ 01.06.2020):
	```
	pip install cudf
	```
</details>
...
- [PyPi](https://pypi.org/project/pycuda) (📥 32K / month · 📦 190 · ⏱️ 03.04.2021):
	...
	pip install pycuda
	```
- [Conda](https://anaconda.org/conda-forge/pycuda) (📥 56K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/wookayin/gpustat) (👨‍💻 12 · 🔀 210 · 📦 1.7K · 📋 79 - 27% open · ⏱️ 13.08.2021):

	```
	git clone https://github.com/wookayin/gpustat
	```
- [PyPi](https://pypi.org/project/gpustat) (📥 470K / month · 📦 99 · ⏱️ 02.01.2021):
	```
	pip install gpustat
	```
...
- [GitHub](https://github.com/arrayfire/arrayfire) (👨‍💻 81 · 🔀 490 · 📥 2K · 📋 1.5K - 15% open · ⏱️ 21.02.2022):

	```
	git clone https://github.com/arrayfire/arrayfire
	```
- [PyPi](https://pypi.org/project/arrayfire) (📥 1.2K / month · 📦 5 · ⏱️ 22.02.2022):
	```
...
- [GitHub](https://github.com/rapidsai/cuml) (👨‍💻 150 · 🔀 380 · 📋 2K - 33% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/rapidsai/cuml
	```
- [PyPi](https://pypi.org/project/cuml) (📥 630 / month · 📦 2 · ⏱️ 01.06.2020):
	```
	pip install cuml
	```
</details>
...
- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 76 · 🔀 180 · 📋 760 - 11% open · ⏱️ 01.03.2022):
...
- [PyPi](https://pypi.org/project/cugraph) (📥 200 / month · 📦 1 · ⏱️ 01.06.2020):
	...
	pip install cugraph
	```
- [Conda](https://anaconda.org/conda-forge/libcugraph) (📥 6.3K · ⏱️ 29.04.2021):
	```
...
- [GitHub](https://github.com/lebedov/scikit-cuda) (👨‍💻 45 · 🔀 170 · 📦 170 · 📋 220 - 22% open · ⏱️ 13.07.2021):

	```
	git clone https://github.com/lebedov/scikit-cuda
	```
- [PyPi](https://pypi.org/project/scikit-cuda) (📥 750 / month · 📦 44 · ⏱️ 27.05.2019):
	```
...
<details><summary><b><a href="https://github.com/KomputeProject/kompute">Vulkan Kompute</a></b> (🥉19 ·  ⭐ 760) - General purpose GPU compute framework built on Vulkan to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/KomputeProject/kompute) (👨‍💻 16 · 🔀 54 · 📥 130 · 📦 2 · 📋 170 - 33% open · ⏱️ 30.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/kp) (📥 260 / month · ⏱️ 15.09.2021):
	```
	pip install kp
	```
</details>
<details><summary><b><a href="https://github.com/KomputeProject/kompute">kompute</a></b> (🥉19 ·  ⭐ 760) - General purpose GPU compute framework built on Vulkan to support.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/rapidsai/cusignal) (👨‍💻 37 · 🔀 83 · 📋 130 - 11% open · ⏱️ 28.02.2022):
...
- <b><a href="https://github.com/anderskm/gputil">GPUtil</a></b> (🥉23 ·  ⭐ 830 · 💀) - A Python module for getting the GPU status from NVIDA GPUs using.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/tensorflow/datasets) (👨‍💻 240 · 🔀 1.2K · 📋 1.1K - 46% open · ⏱️ 03.03.2022):
...
- [PyPi](https://pypi.org/project/tensorflow-datasets) (📥 1.3M / month · 📦 150 · ⏱️ 31.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-datasets) (📥 3.2K · ⏱️ 17.08.2021):
	```
...
- [GitHub](https://github.com/tensorflow/addons) (👨‍💻 190 · 🔀 500 · 📦 5.5K · 📋 920 - 23% open · ⏱️ 24.02.2022):

	```
	git clone https://github.com/tensorflow/addons
	```
- [PyPi](https://pypi.org/project/tensorflow-addons) (📥 2.4M / month · 📦 160 · ⏱️ 15.02.2022):
	```
...
- [GitHub](https://github.com/tensorflow/hub) (👨‍💻 85 · 🔀 1.6K · 📦 11K · 📋 640 - 2% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 65 · 🔀 270 · 📦 1.6K · 📋 300 - 50% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/tensorflow/model-optimization
	```
- [PyPi](https://pypi.org/project/tensorflow-model-optimization) (📥 170K / month · 📦 19 · ⏱️ 09.02.2022):
	```
	pip install tensorflow-model-optimization
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/transform">TensorFlow Transform</a></b> (🥈31 ·  ⭐ 910) - Input pipeline framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tensorflow/transform) (👨‍💻 27 · 🔀 180 · 📦 760 · 📋 180 - 13% open · ⏱️ 27.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-transform) (📥 3M / month · 📦 56 · ⏱️ 21.01.2022):
	```
...
- [GitHub](https://github.com/keras-team/keras-preprocessing) (👨‍💻 51 · 🔀 440 · 📋 190 - 48% open · ⏱️ 17.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/keras-preprocessing) (📥 8.7M / month · 📦 1.5K · ⏱️ 14.05.2020):
	```
...
- [GitHub](https://github.com/tensorflow/io) (👨‍💻 89 · 🔀 220 · 📋 500 - 33% open · ⏱️ 15.02.2022):
...
- [GitHub](https://github.com/qubvel/efficientnet) (👨‍💻 10 · 🔀 440 · 📥 210K · 📦 920 · 📋 120 - 50% open · ⏱️ 16.07.2021):

	```
	git clone https://github.com/qubvel/efficientnet
	```
- [PyPi](https://pypi.org/project/efficientnet) (📥 89K / month · 📦 7 · ⏱️ 15.09.2020):
	```
...
- [GitHub](https://github.com/tensorflow/neural-structured-learning) (👨‍💻 32 · 🔀 170 · 📦 180 · 📋 61 - 4% open · ⏱️ 23.02.2022):

	```
	git clone https://github.com/tensorflow/neural-structured-learning
	```
- [PyPi](https://pypi.org/project/neural-structured-learning) (📥 12K / month · 📦 2 · ⏱️ 18.08.2020):
	```
...
- [GitHub](https://github.com/tensorflow/compression) (👨‍💻 11 · 🔀 210 · 📋 80 - 2% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/tensorflow/compression
	```
- [PyPi](https://pypi.org/project/tensorflow-compression) (📥 1.6K / month · 📦 1 · ⏱️ 02.03.2022):
	```
...
- [GitHub](https://github.com/PAIR-code/saliency) (👨‍💻 14 · 🔀 160 · 📦 21 · 📋 40 - 35% open · ⏱️ 28.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/saliency) (📥 1K / month · 📦 3 · ⏱️ 03.05.2021):
	```
...
- <b><a href="https://github.com/patrick-kidger/equinox">equinox</a></b> (🥇19 ·  ⭐ 280) - Callable PyTrees and filtered JIT/grad transformations = neural.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/ucl-bug/jaxdf">jaxdf</a></b> (🥉9 ·  ⭐ 43 · 🐣) - A JAX-based research framework for writing differentiable.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/scikit-learn-contrib/imbalanced-learn) (👨‍💻 62 · 🔀 1.2K · 📦 9.5K · 📋 510 - 12% open · ⏱️ 25.01.2022):

	```
	git clone https://github.com/scikit-learn-contrib/imbalanced-learn
	```
- [PyPi](https://pypi.org/project/imbalanced-learn) (📥 2.7M / month · 📦 240 · ⏱️ 11.01.2022):
	```
...
- [GitHub](https://github.com/rasbt/mlxtend) (👨‍💻 87 · 🔀 740 · 📦 5.3K · 📋 400 - 24% open · ⏱️ 28.02.2022):
...
- [GitHub](https://github.com/scikit-learn-contrib/category_encoders) (👨‍💻 49 · 🔀 340 · 📦 3.1K · 📋 240 - 32% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/scikit-learn-contrib/category_encoders
	```
- [PyPi](https://pypi.org/project/category_encoders) (📥 1.3M / month · 📦 23 · ⏱️ 14.10.2018):
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/lightning) (👨‍💻 17 · 🔀 200 · 📥 170 · 📦 99 · 📋 92 - 55% open · ⏱️ 30.01.2022):

	```
	git clone https://github.com/scikit-learn-contrib/lightning
	```
- [PyPi](https://pypi.org/project/sklearn-contrib-lightning) (📥 4.2K / month · 📦 6 · ⏱️ 30.01.2022):
	```
...
<details><summary><b><a href="https://github.com/koaning/scikit-lego">scikit-lego</a></b> (🥉24 ·  ⭐ 760) - Extra blocks for scikit-learn pipelines. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/koaning/scikit-lego) (👨‍💻 48 · 🔀 77 · 📦 40 · 📋 240 - 13% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/scikit-lego) (📥 19K / month · 📦 6 · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/trent-b/iterative-stratification) (👨‍💻 6 · 🔀 57 · 📦 190 · 📋 19 - 21% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/iterative-stratification) (📥 370K / month · 📦 8 · ⏱️ 03.10.2021):
	```
...
- [GitHub](https://github.com/yzhao062/combo) (👨‍💻 1 · 🔀 96 · 📦 440 · 📋 12 - 75% open · ⏱️ 02.10.2021):

	```
	git clone https://github.com/yzhao062/combo
	```
- [PyPi](https://pypi.org/project/combo) (📥 41K / month · 📦 1 · ⏱️ 23.12.2020):
	```
	pip install combo
	```
</details>
<details><summary><b><a href="https://github.com/scikit-learn-contrib/DESlib">DESlib</a></b> (🥉21 ·  ⭐ 380) - A Python library for dynamic classifier and ensemble selection. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/scikit-tda/scikit-tda) (👨‍💻 3 · 🔀 40 · 📦 25 · 📋 18 - 77% open · ⏱️ 03.08.2021):

	```
	git clone https://github.com/scikit-tda/scikit-tda
	```
- [PyPi](https://pypi.org/project/scikit-tda) (📥 7.1K / month · ⏱️ 03.08.2021):
	```
...
<details><summary><b><a href="https://github.com/KevinMusgrave/pytorch-metric-learning">PML</a></b> (🥇32 ·  ⭐ 4.2K) - The easiest way to use deep metric learning in your application. Modular,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/KevinMusgrave/pytorch-metric-learning) (👨‍💻 24 · 🔀 520 · 📦 210 · 📋 330 - 12% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/KevinMusgrave/pytorch-metric-learning
	```
- [PyPi](https://pypi.org/project/pytorch-metric-learning) (📥 380K / month · 📦 8 · ⏱️ 01.03.2022):
	```
...
- [GitHub](https://github.com/jettify/pytorch-optimizer) (👨‍💻 25 · 🔀 220 · 📦 480 · 📋 44 - 36% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/jettify/pytorch-optimizer
	```
- [PyPi](https://pypi.org/project/torch_optimizer) (📥 78K / month · 📦 23 · ⏱️ 31.10.2021):
	```
	pip install torch_optimizer
	```
- [Conda](https://anaconda.org/conda-forge/torch-optimizer) (📥 840 · ⏱️ 31.10.2021):
	```
...
- [GitHub](https://github.com/PyTorchLightning/lightning-flash) (👨‍💻 64 · 🔀 150 · 📦 54 · 📋 430 - 9% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/PyTorchLightning/lightning-flash
	```
- [PyPi](https://pypi.org/project/lightning-flash) (📥 3.5K / month · 📦 2 · ⏱️ 01.03.2022):
	```
	pip install lightning-flash
	```
- [Conda](https://anaconda.org/conda-forge/lightning-flash) (📥 800 · ⏱️ 01.03.2022):
	```
...
- [GitHub](https://github.com/huggingface/accelerate) (👨‍💻 37 · 🔀 140 · 📦 340 · 📋 170 - 33% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/accelerate) (📥 320K / month · 📦 4 · ⏱️ 27.09.2021):
	```
	pip install accelerate
	```
- [Conda](https://anaconda.org/conda-forge/accelerate) (📥 830 · ⏱️ 11.10.2021):
	```
...
- [GitHub](https://github.com/lukemelas/EfficientNet-PyTorch) (👨‍💻 24 · 🔀 1.4K · 📥 1.3M · 📋 270 - 49% open · ⏱️ 15.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/efficientnet-pytorch) (📥 730K / month · 📦 30 · ⏱️ 15.04.2021):
	```
...
- [GitHub](https://github.com/sksq96/pytorch-summary) (👨‍💻 11 · 🔀 380 · 📦 4.4K · 📋 160 - 74% open · ⏱️ 10.05.2021):

	```
	git clone https://github.com/sksq96/pytorch-summary
	```
- [PyPi](https://pypi.org/project/torchsummary) (📥 76K / month · 📦 71 · ⏱️ 26.09.2018):
	```
...
- [GitHub](https://github.com/rtqichen/torchdiffeq) (👨‍💻 20 · 🔀 690 · 📦 210 · 📋 160 - 19% open · ⏱️ 17.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/torchdiffeq) (📥 6.9K / month · 📦 6 · ⏱️ 02.06.2021):
	```
...
- [GitHub](https://github.com/asappresearch/sru) (👨‍💻 21 · 🔀 300 · 📦 17 · 📋 120 - 45% open · ⏱️ 19.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/sru) (📥 4K / month · 📦 3 · ⏱️ 17.06.2021):
	```
	pip install sru
	```
</details>
...
- [GitHub](https://github.com/dreamquark-ai/tabnet) (👨‍💻 19 · 🔀 330 · 📋 210 - 17% open · ⏱️ 27.12.2021):
...
- [PyPi](https://pypi.org/project/pytorch-tabnet) (📥 21K / month · 📦 7 · ⏱️ 02.02.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch-tabnet) (📥 170 · ⏱️ 30.12.2021):
	```
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_scatter">torch-scatter</a></b> (🥈23 ·  ⭐ 910) - PyTorch Extension Library of Optimized Scatter Operations. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_scatter) (👨‍💻 19 · 🔀 100 · 📋 240 - 9% open · ⏱️ 03.02.2022):

	```
	git clone https://github.com/rusty1s/pytorch_scatter
	```
- [PyPi](https://pypi.org/project/torch-scatter) (📥 27K / month · 📦 43 · ⏱️ 22.10.2021):
	```
	pip install torch-scatter
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_scatter) (📥 68K · ⏱️ 22.02.2022):
	```
...
- [GitHub](https://github.com/BloodAxe/pytorch-toolbelt) (👨‍💻 7 · 🔀 89 · 📋 23 - 21% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytorch_toolbelt) (📥 16K / month · 📦 6 · ⏱️ 12.08.2021):
	```
	pip install pytorch_toolbelt
	```
</details>
<details><summary><b><a href="https://github.com/rusty1s/pytorch_sparse">PyTorch Sparse</a></b> (🥉22 ·  ⭐ 580) - PyTorch Extension Library of Optimized Autograd Sparse.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_sparse) (👨‍💻 21 · 🔀 80 · 📋 200 - 30% open · ⏱️ 09.02.2022):
...
<details><summary><b><a href="https://github.com/google-research/torchsde">torchsde</a></b> (🥉20 ·  ⭐ 940 · 💤) - Differentiable SDE solvers with GPU support and efficient.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/szagoruyko/pytorchviz) (👨‍💻 6 · 🔀 220 · 📦 590 · 📋 52 - 36% open · ⏱️ 15.06.2021):
...
- [GitHub](https://github.com/parrt/tensor-sensor) (👨‍💻 4 · 🔀 33 · 📦 7 · 📋 23 - 34% open · ⏱️ 13.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/tensor-sensor) (📥 2.4K / month · ⏱️ 11.12.2021):
	```
	pip install tensor-sensor
	```
- [Conda](https://anaconda.org/conda-forge/tensor-sensor) (📥 170 · ⏱️ 11.12.2021):
	```
...
- [GitHub](https://github.com/abhishekkrthakur/tez) (👨‍💻 1 · 🔀 120 · 📦 20 · 📋 30 - 66% open · ⏱️ 28.12.2021):

	```
	git clone https://github.com/abhishekkrthakur/tez
	```
- [PyPi](https://pypi.org/project/tez) (📥 4.1K / month · 📦 2 · ⏱️ 28.12.2021):
	```
	pip install tez
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/madgrad) (👨‍💻 2 · 🔀 54 · 📦 23 · 📋 9 - 22% open · ⏱️ 22.02.2022):

	```
	git clone https://github.com/facebookresearch/madgrad
	```
- [PyPi](https://pypi.org/project/madgrad) (📥 5.8K / month · ⏱️ 01.04.2021):
	```
	pip install madgrad
	```
</details>
...
- <b><a href="https://github.com/GRAAL-Research/poutyne">Poutyne</a></b> (🥉22 ·  ⭐ 510) - A simplified framework and utilities for PyTorch. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/scipy/scipy">scipy</a></b> (🥇49 ·  ⭐ 9.3K) - Ecosystem of open-source software for mathematics, science, and engineering. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.2K · 🔀 4.1K · 📥 340K · 📦 470K · 📋 8.3K - 22% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/scipy/scipy
	```
- [PyPi](https://pypi.org/project/scipy) (📥 37M / month · 📦 56K · ⏱️ 05.02.2022):
	```
	pip install scipy
	```
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.5K · 📥 450K · 📦 40K · 📋 12K - 35% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 2M / month · 📦 4.1K · ⏱️ 26.02.2022):
	```
	pip install sympy
	```
...
<details><summary><b><a href="https://github.com/gradio-app/gradio">Gradio</a></b> (🥇34 ·  ⭐ 5.3K) - Wrap UIs around any model, share with anyone. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 64 · 🔀 340 · 📦 580 · 📋 400 - 21% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/gradio) (📥 87K / month · 📦 16 · ⏱️ 02.03.2022):
	```
	pip install gradio
	```
</details>
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 33 · 🔀 1K · 📦 1.1K · 📋 240 - 50% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyod) (📥 520K / month · 📦 28 · ⏱️ 04.01.2022):
	```
	pip install pyod
	```
- [Conda](https://anaconda.org/conda-forge/pyod) (📥 17K · ⏱️ 04.01.2022):
	```
	conda install -c conda-forge pyod
	```
</details>
<details><summary><b><a href="https://github.com/deepchem/deepchem">DeepChem</a></b> (🥇34 ·  ⭐ 3.5K) - Democratizing Deep-Learning for Drug Discovery, Quantum Chemistry,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 180 · 🔀 1.3K · 📦 75 · 📋 1.4K - 31% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 16K / month · 📦 4 · ⏱️ 02.03.2022):
	```
	pip install deepchem
	```
- [Conda](https://anaconda.org/conda-forge/deepchem) (📥 8.4K · ⏱️ 19.01.2022):
	```
...
- [GitHub](https://github.com/simonw/datasette) (👨‍💻 61 · 🔀 390 · 📥 34 · 📦 600 · 📋 1.3K - 27% open · ⏱️ 27.02.2022):
...
- [PyPi](https://pypi.org/project/datasette) (📥 270K / month · 📦 140 · ⏱️ 07.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/datasette) (📥 2.9K · ⏱️ 08.02.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleHub) (👨‍💻 55 · 🔀 1.5K · 📥 560 · 📦 720 · 📋 1K - 38% open · ⏱️ 24.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/paddlehub) (📥 11K / month · 📦 4 · ⏱️ 28.12.2021):
	```
...
- [GitHub](https://github.com/HIPS/autograd) (👨‍💻 51 · 🔀 780 · 📦 3K · 📋 390 - 42% open · ⏱️ 03.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/autograd) (📥 1.4M / month · 📦 270 · ⏱️ 25.07.2019):
	```
...
<details><summary><b><a href="https://github.com/carla-simulator/carla">carla</a></b> (🥈31 ·  ⭐ 7.4K) - Open-source simulator for autonomous driving research. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/carla-simulator/carla) (👨‍💻 140 · 🔀 2.1K · 📦 140 · 📋 3.7K - 14% open · ⏱️ 19.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/carla) (📥 4.7K / month · 📦 3 · ⏱️ 17.11.2021):
	```
	pip install carla
	```
</details>
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 64 · 🔀 170 · 📦 110 · 📋 750 - 15% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/serge-sans-paille/pythran
	```
- [PyPi](https://pypi.org/project/pythran) (📥 430K / month · 📦 14 · ⏱️ 14.12.2021):
	```
	pip install pythran
	```
...
- [GitHub](https://github.com/tensorly/tensorly) (👨‍💻 51 · 🔀 220 · 📦 230 · 📋 180 - 26% open · ⏱️ 01.03.2022):
...
- [GitHub](https://github.com/PennyLaneAI/pennylane) (👨‍💻 90 · 🔀 350 · 📥 60 · 📋 630 - 24% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/PennyLaneAI/PennyLane
	```
- [PyPi](https://pypi.org/project/pennylane) (📥 14K / month · 📦 28 · ⏱️ 08.02.2022):
	```
	pip install pennylane
	```
- [Conda](https://anaconda.org/conda-forge/pennylane) (📥 410 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/wireservice/agate) (👨‍💻 49 · 🔀 140 · 📦 800 · 📋 680 - 7% open · ⏱️ 15.07.2021):
...
<details><summary><b><a href="https://github.com/inducer/pyopencl">pyopencl</a></b> (🥈30 ·  ⭐ 880) - OpenCL integration for Python, plus shiny features. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/inducer/pyopencl) (👨‍💻 90 · 🔀 220 · 📦 640 · 📋 300 - 22% open · ⏱️ 18.02.2022):

	```
	git clone https://github.com/inducer/pyopencl
	```
- [PyPi](https://pypi.org/project/pyopencl) (📥 27K / month · 📦 180 · ⏱️ 10.02.2022):
	```
	pip install pyopencl
	```
- [Conda](https://anaconda.org/conda-forge/pyopencl) (📥 560K · ⏱️ 24.02.2022):
	```
	conda install -c conda-forge pyopencl
	```
</details>
<details><summary><b><a href="https://github.com/online-ml/river">River</a></b> (🥈29 ·  ⭐ 3.2K) - Online machine learning in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 73 · 🔀 350 · 📦 81 · 📋 350 - 2% open · ⏱️ 18.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/river) (📥 7.1K / month · 📦 6 · ⏱️ 04.02.2022):
	```
	pip install river
	```
- [Conda](https://anaconda.org/conda-forge/river) (📥 6.8K · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/uber/causalml) (👨‍💻 37 · 🔀 430 · 📦 37 · 📋 240 - 17% open · ⏱️ 18.02.2022):

	```
	git clone https://github.com/uber/causalml
	```
- [PyPi](https://pypi.org/project/causalml) (📥 44K / month · 📦 1 · ⏱️ 18.02.2022):
	```
...
- [GitHub](https://github.com/tableau/TabPy) (👨‍💻 46 · 🔀 450 · 📦 83 · 📋 290 - 3% open · ⏱️ 01.03.2022):
...
- [PyPi](https://pypi.org/project/tabpy) (📥 20K / month · 📦 2 · ⏱️ 20.01.2022):
	...
	pip install tabpy
	```
- [Conda](https://anaconda.org/anaconda/tabpy-client) (📥 2.5K · ⏱️ 20.01.2022):
	```
	conda install -c anaconda tabpy-client
	```
</details>
<details><summary><b><a href="https://github.com/nicodv/kmodes">kmodes</a></b> (🥈29 ·  ⭐ 970 · 📈) - Python implementations of the k-modes and k-prototypes clustering.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/kmodes) (📥 320K / month · 📦 26 · ⏱️ 08.10.2021):
	...
	pip install kmodes
	```
- [Conda](https://anaconda.org/conda-forge/kmodes) (📥 6.2K · ⏱️ 26.01.2022):
	```
	conda install -c conda-forge kmodes
	```
</details>
<details><summary><b><a href="https://github.com/pyjanitor-devs/pyjanitor">pyjanitor</a></b> (🥈28 ·  ⭐ 830) - Clean APIs for data cleaning. Python implementation of R package Janitor. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/Adapter-Hub/adapter-transformers">adapter-transformers</a></b> (🥈28 ·  ⭐ 690) - Huggingface Transformers + Adapters =. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>huggingface</code></summary>

- [GitHub](https://github.com/Adapter-Hub/adapter-transformers) (👨‍💻 1.1K · 🔀 110 · 📦 46 · 📋 140 - 27% open · ⏱️ 09.02.2022):

	```
	git clone https://github.com/Adapter-Hub/adapter-transformers
	```
- [PyPi](https://pypi.org/project/adapter-transformers) (📥 54K / month · 📦 4 · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/mars-project/mars) (👨‍💻 42 · 🔀 300 · 📋 990 - 16% open · ⏱️ 02.03.2022):

	```
	git clone https://github.com/mars-project/mars
	```
- [PyPi](https://pypi.org/project/pymars) (📥 15K / month · 📦 1 · ⏱️ 21.02.2022):
	```
	pip install pymars
	```
</details>
...
- [GitHub](https://github.com/SeldonIO/alibi-detect) (👨‍💻 15 · 🔀 120 · 📦 62 · 📋 220 - 38% open · ⏱️ 04.02.2022):

	```
	git clone https://github.com/SeldonIO/alibi-detect
	```
- [PyPi](https://pypi.org/project/alibi-detect) (📥 18K / month · 📦 5 · ⏱️ 18.01.2022):
	```
	pip install alibi-detect
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/AugLy">AugLy</a></b> (🥉25 ·  ⭐ 4.3K) - A data augmentations library for audio, image, text, and video. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/AugLy) (👨‍💻 15 · 🔀 220 · 📦 26 · 📋 57 - 24% open · ⏱️ 24.02.2022):

	```
	git clone https://github.com/facebookresearch/AugLy
	```
- [PyPi](https://pypi.org/project/augly) (📥 2.3K / month · 📦 3 · ⏱️ 17.12.2021):
	```
	pip install augly
	```
</details>
<details><summary><b><a href="https://github.com/ljvmiranda921/pyswarms">PySwarms</a></b> (🥉25 ·  ⭐ 880 · 💤) - A research toolkit for particle swarm optimization in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ljvmiranda921/pyswarms) (👨‍💻 43 · 🔀 290 · 📦 150 · 📋 200 - 8% open · ⏱️ 23.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyswarms) (📥 34K / month · 📦 6 · ⏱️ 03.01.2021):
	```
	pip install pyswarms
	```
</details>
<details><summary><b><a href="https://github.com/astroML/astroML">AstroML</a></b> (🥉25 ·  ⭐ 800) - Machine learning, statistics, and data mining for astronomy and.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/astroML/astroML) (👨‍💻 30 · 🔀 280 · 📋 150 - 41% open · ⏱️ 01.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/astroML) (📥 2.6K / month · 📦 33 · ⏱️ 01.03.2022):
	```
	pip install astroML
	```
...
- [GitHub](https://github.com/trevorstephens/gplearn) (👨‍💻 11 · 🔀 190 · 📦 220 · 📋 180 - 26% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/gplearn) (📥 3.1K / month · 📦 10 · ⏱️ 01.06.2019):
	```
	pip install gplearn
	```
- [Conda](https://anaconda.org/conda-forge/gplearn) (📥 1.9K · ⏱️ 18.06.2020):
	```
	conda install -c conda-forge gplearn
	```
</details>
<details><summary><b><a href="https://github.com/ContinualAI/avalanche">avalanche</a></b> (🥉24 ·  ⭐ 770) - Avalanche: an End-to-End Library for Continual Learning. Among other.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ContinualAI/avalanche) (👨‍💻 49 · 🔀 120 · 📋 470 - 15% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/ContinualAI/avalanche
	```
- [PyPi](https://pypi.org/project/avalanche-lib) (📥 320 / month · ⏱️ 16.12.2021):
	```
...
<details><summary><b><a href="https://github.com/MaxHalford/prince">Prince</a></b> (🥉21 ·  ⭐ 760 · 📉) - Python factor analysis library (PCA, CA, MCA, MFA, FAMD). <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/MaxHalford/prince) (👨‍💻 12 · 🔀 140 · 📦 180 · 📋 100 - 33% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/prince) (📥 34K / month · 📦 5 · ⏱️ 06.10.2020):
	```
	pip install prince
	```
...
- [GitHub](https://github.com/ml-tooling/opyrator) (👨‍💻 4 · 🔀 120 · 📦 31 · 📋 25 - 8% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/opyrator) (📥 400 / month · ⏱️ 04.05.2021):
	```
	pip install opyrator
	```
- [Conda](https://anaconda.org/conda-forge/opyrator) (📥 46 · ⏱️ 08.01.2022):
	```
	conda install -c conda-forge opyrator
	```
</details>
<details><summary><b><a href="https://github.com/rasbt/biopandas">BioPandas</a></b> (🥉20 ·  ⭐ 420) - Working with molecular structures in pandas DataFrames. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/rasbt/biopandas) (👨‍💻 8 · 🔀 91 · 📦 91 · 📋 39 - 38% open · ⏱️ 04.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/biopandas) (📥 4.4K / month · 📦 9 · ⏱️ 24.09.2021):
	```
...
<details><summary><b><a href="https://github.com/pykale/pykale">pykale</a></b> (🥉20 ·  ⭐ 320) - Knowledge-Aware machine LEarning (KALE): accessible machine learning.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pykale/pykale) (👨‍💻 16 · 🔀 40 · 📋 80 - 12% open · ⏱️ 20.01.2022):

	```
	git clone https://github.com/pykale/pykale
	```
- [PyPi](https://pypi.org/project/pykale) (📥 250 / month · ⏱️ 13.10.2021):
	```
	pip install pykale
	```
</details>
...
- [GitHub](https://github.com/alegonz/baikal) (👨‍💻 2 · 🔀 29 · 📦 3 · 📋 20 - 30% open · ⏱️ 11.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/baikal) (📥 620 / month · 📦 1 · ⏱️ 15.11.2020):
	```
	pip install baikal
	```
...
- [GitHub](https://github.com/jmschrei/apricot) (👨‍💻 4 · 🔀 40 · 📥 10 · 📦 22 · 📋 24 - 25% open · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/apricot-select) (📥 730 / month · 📦 3 · ⏱️ 28.09.2020):
	```
...
- <b><a href="https://github.com/annoviko/pyclustering">pyclustering</a></b> (🥉27 ·  ⭐ 930 · 💀) - pyclustring is a Python, C++ data mining library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/cleanlab/cleanlab">cleanlab</a></b> (🥉24 ·  ⭐ 2.7K) - The standard package for data-centric AI and machine learning.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
- <b><a href="https://github.com/Project-MONAI/MONAILabel">MONAILabel</a></b> (🥉23 ·  ⭐ 210) - MONAI Label is an intelligent open source image labeling and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/EpistasisLab/scikit-rebate">scikit-rebate</a></b> (🥉19 ·  ⭐ 340 · 💀) - A scikit-learn-compatible Python implementation of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/solegalli/feature_engine">Feature Engine</a></b> (🥉18 ·  ⭐ 14 · 💤) - Feature engineering package with sklearn like functionality. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
