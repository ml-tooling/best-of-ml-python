...
- [GitHub](https://github.com/microsoft/LightGBM) (👨‍💻 280 · 🔀 3.7K · 📥 190K · 📦 22K · 📋 3K - 8% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/microsoft/LightGBM
	```
- [PyPi](https://pypi.org/project/lightgbm) (📥 5.9M / month · 📦 770 · ⏱️ 24.01.2023):
	```
...
- [GitHub](https://github.com/Lightning-AI/lightning) (👨‍💻 880 · 🔀 2.9K · 📥 12K · 📋 6.2K - 11% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/Lightning-AI/lightning
	```
- [PyPi](https://pypi.org/project/pytorch-lightning) (📥 4.2M / month · 📦 640 · ⏱️ 18.01.2023):
	```
...
<details><summary><b><a href="https://github.com/catboost/catboost">Catboost</a></b> (🥈41 ·  ⭐ 7.2K · 📈) - A fast, scalable, high performance Gradient Boosting on.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/catboost/catboost) (👨‍💻 1.1K · 🔀 1.1K · 📥 150K · 📋 2.1K - 24% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/catboost/catboost
	```
- [PyPi](https://pypi.org/project/catboost) (📥 5.4M / month · 📦 310 · ⏱️ 01.11.2022):
	```
...
- [GitHub](https://github.com/fastai/fastai) (👨‍💻 650 · 🔀 7.4K · 📦 14K · 📋 1.7K - 8% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/fastai/fastai
	```
- [PyPi](https://pypi.org/project/fastai) (📥 300K / month · 📦 330 · ⏱️ 15.02.2023):
	```
	pip install fastai
	```
</details>
...
- [PyPi](https://pypi.org/project/mxnet) (📥 340K / month):
	...
	pip install mxnet
	```
- [Conda](https://anaconda.org/anaconda/mxnet) (📥 9.5K · 📦 5 · ⏱️ 24.10.2022):
	```
...
<details><summary><b><a href="https://github.com/mlpack/mlpack">mlpack</a></b> (🥉32 ·  ⭐ 4.4K) - mlpack: a fast, header-only C++ machine learning library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mlpack/mlpack) (👨‍💻 300 · 🔀 1.5K · 📋 1.5K - 3% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/mlpack/mlpack
	```
- [PyPi](https://pypi.org/project/mlpack) (📥 1.2K / month · 📦 1 · ⏱️ 29.12.2022):
	```
	pip install mlpack
	```
...
- [GitHub](https://github.com/pytorch/ignite) (👨‍💻 190 · 🔀 600 · 📋 1.3K - 12% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) (👨‍💻 4.4K · 🔀 77 · 📥 21 · 📋 360 - 23% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/ROCmSoftwarePlatform/tensorflow-upstream
	```
- [PyPi](https://pypi.org/project/tensorflow-rocm) (📥 3.4K / month · 📦 5 · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/skorch-dev/skorch) (👨‍💻 58 · 🔀 350 · 📦 860 · 📋 480 - 10% open · ⏱️ 22.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/skorch) (📥 44K / month · 📦 49 · ⏱️ 18.11.2022):
	```
	pip install skorch
	```
...
- [GitHub](https://github.com/sony/nnabla) (👨‍💻 72 · 🔀 330 · 📥 640 · 📋 88 - 35% open · ⏱️ 24.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/nnabla) (📥 4K / month · 📦 53 · ⏱️ 14.02.2023):
	```
	pip install nnabla
	```
</details>
...
- [GitHub](https://github.com/geomstats/geomstats) (👨‍💻 81 · 🔀 210 · 📦 67 · 📋 550 - 42% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/geomstats/geomstats
	```
- [PyPi](https://pypi.org/project/geomstats) (📥 1.8K / month · 📦 2 · ⏱️ 22.04.2022):
	```
...
- [GitHub](https://github.com/towhee-io/towhee) (👨‍💻 30 · 🔀 200 · 📥 1.1K · 📋 600 - 0% open · ⏱️ 01.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/towhee) (📥 2.2K / month · ⏱️ 02.12.2022):
	```
	pip install towhee
	```
</details>
...
- [GitHub](https://github.com/pyRiemann/pyRiemann) (👨‍💻 25 · 🔀 150 · 📦 250 · 📋 94 - 6% open · ⏱️ 28.05.2023):
...
- [GitHub](https://github.com/aksnzhy/xlearn) (👨‍💻 30 · 🔀 530 · 📥 3.9K · 📦 120 · 📋 310 - 62% open · ⏱️ 05.06.2022):
...
<details><summary><b><a href="https://github.com/serengil/chefboost">chefboost</a></b> (🥉18 ·  ⭐ 400) - A Lightweight Decision Tree Framework supporting regular algorithms:.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Xtra-Computing/thundergbm) (👨‍💻 10 · 🔀 87 · 📦 2 · 📋 77 - 45% open · ⏱️ 13.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/thundergbm) (📥 34 / month · ⏱️ 19.09.2022):
	```
...
- <b><a href="https://github.com/unifyai/ivy">ivy</a></b> (🥉31 ·  ⭐ 11K) - The Unified Machine Learning Framework. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/plotly/dash) (👨‍💻 140 · 🔀 1.9K · 📦 47K · 📋 1.5K - 47% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 160 · 🔀 730 · 📥 45 · 📦 58K · 📋 1.8K - 10% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 12M / month · 📦 570 · ⏱️ 01.03.2023):
	```
	pip install altair
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 100 · 🔀 200 · 📦 5.1K · 📋 560 - 13% open · ⏱️ 10.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 890K / month · 📦 250 · ⏱️ 29.09.2022):
	```
...
- [GitHub](https://github.com/pyqtgraph/pyqtgraph) (👨‍💻 250 · 🔀 1K · 📋 1.2K - 30% open · ⏱️ 29.05.2023):
...
- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 81 · 🔀 350 · 📦 310 · 📋 1.3K - 37% open · ⏱️ 28.05.2023):

	```
	git clone https://github.com/voxel51/fiftyone
	```
- [PyPi](https://pypi.org/project/fiftyone) (📥 67K / month · 📦 7 · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 190 · 🔀 610 · 📦 1.2K · 📋 1.4K - 22% open · ⏱️ 29.05.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 68K / month · 📦 130 · ⏱️ 14.11.2022):
	```
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 390K · ⏱️ 13.05.2023):
	...
	```
- [npm](https://www.npmjs.com/package/vispy) (📥 6 / month · 📦 1 · ⏱️ 15.03.2020):
	```
	npm install vispy
	```
</details>
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 120 · 🔀 340 · 📥 710 · 📦 1.9K · 📋 1.2K - 28% open · ⏱️ 01.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyvista) (📥 96K / month · 📦 200 · ⏱️ 02.11.2022):
	```
	pip install pyvista
	```
...
- [GitHub](https://github.com/amueller/word_cloud) (👨‍💻 68 · 🔀 2.3K · 📋 520 - 22% open · ⏱️ 18.05.2023):

	```
	git clone https://github.com/amueller/word_cloud
	```
- [PyPi](https://pypi.org/project/wordcloud) (📥 800K / month · 📦 800 · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/lmcinnes/umap) (👨‍💻 120 · 🔀 730 · 📦 9.2K · 📋 720 - 55% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/lmcinnes/umap
	```
- [PyPi](https://pypi.org/project/umap-learn) (📥 810K / month · 📦 460 · ⏱️ 13.04.2022):
	```
...
- [GitHub](https://github.com/holoviz/datashader) (👨‍💻 53 · 🔀 360 · 📦 2.4K · 📋 550 - 24% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/finos/perspective) (👨‍💻 88 · 🔀 690 · 📦 9 · 📋 640 - 14% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/finos/perspective
	```
- [PyPi](https://pypi.org/project/perspective-python) (📥 5.3K / month · 📦 11 · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 29 · 🔀 340 · 📦 730 · 📋 510 - 8% open · ⏱️ 16.05.2023):

	```
	git clone https://github.com/man-group/dtale
	```
- [PyPi](https://pypi.org/project/dtale) (📥 220K / month · 📦 16 · ⏱️ 17.06.2022):
	```
	pip install dtale
	```
...
- [GitHub](https://github.com/holoviz/hvplot) (👨‍💻 40 · 🔀 85 · 📦 3K · 📋 620 - 41% open · ⏱️ 23.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/hvplot) (📥 140K / month · 📦 82 · ⏱️ 24.11.2022):
	```
	pip install hvplot
	```
...
- [Conda](https://anaconda.org/conda-forge/mpld3) (📥 180K · ⏱️ 10.12.2022):
	...
	```
- [npm](https://www.npmjs.com/package/mpld3) (📥 880 / month · 📦 8 · ⏱️ 10.12.2022):
	```
	npm install mpld3
	```
</details>
...
- [GitHub](https://github.com/jupyter-widgets/pythreejs) (👨‍💻 30 · 🔀 180 · 📦 26 · 📋 230 - 25% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pythreejs) (📥 86K / month · 📦 56 · ⏱️ 20.02.2023):
	```
...
- [GitHub](https://github.com/tensorflow/data-validation) (👨‍💻 25 · 🔀 150 · 📥 420 · 📦 690 · 📋 170 - 21% open · ⏱️ 30.05.2023):

	```
	git clone https://github.com/tensorflow/data-validation
	```
- [PyPi](https://pypi.org/project/tensorflow-data-validation) (📥 420K / month · 📦 30 · ⏱️ 08.12.2022):
	```
...
- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 19 · 🔀 45 · 📥 460 · 📦 33 · 📋 380 - 25% open · ⏱️ 31.05.2023):
...
- [GitHub]() (👨‍💻 110 · 🔀 1.5K · 📦 550):
	...
	```
- [PyPi](https://pypi.org/project/pandas-profiling) (📥 970K / month · 📦 190 · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/predict-idlab/plotly-resampler) (👨‍💻 10 · 🔀 48 · 📦 310 · 📋 120 - 29% open · ⏱️ 30.05.2023):

	```
	git clone https://github.com/predict-idlab/plotly-resampler
	```
- [PyPi](https://pypi.org/project/plotly-resampler) (📥 290K / month):
	```
	pip install plotly-resampler
	```
- [Conda](https://anaconda.org/conda-forge/plotly-resampler) (📥 19K · ⏱️ 10.04.2023):
	```
...
- [GitHub](https://github.com/DmitryUlyanov/Multicore-TSNE) (👨‍💻 17 · 🔀 200 · 📦 380 · 📋 59 - 64% open · ⏱️ 26.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/MulticoreTSNE) (📥 12K / month · 📦 23 · ⏱️ 09.01.2019):
	```
...
- [GitHub](https://github.com/ing-bank/popmon) (👨‍💻 17 · 🔀 34 · 📥 81 · 📦 20 · 📋 52 - 28% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/ing-bank/popmon
	```
- [PyPi](https://pypi.org/project/popmon) (📥 10K / month · 📦 2 · ⏱️ 19.10.2022):
	```
	pip install popmon
	```
</details>
...
- [GitHub](https://github.com/marcharper/python-ternary) (👨‍💻 27 · 🔀 140 · 📥 20 · 📦 140 · 📋 140 - 27% open · ⏱️ 31.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-ternary) (📥 57K / month · 📦 26 · ⏱️ 17.02.2021):
	```
...
- <b><a href="https://github.com/nicolaskruchten/jupyter_pivottablejs">pivottablejs</a></b> (🥉22 ·  ⭐ 550 · 💀) - Dragndrop Pivot Tables and Charts for Jupyter/IPython.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/flairNLP/flair) (👨‍💻 240 · 🔀 2K · 📦 2.5K · 📋 2.1K - 3% open · ⏱️ 12.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/flair) (📥 75K / month · 📦 90 · ⏱️ 20.05.2022):
	```
	pip install flair
	```
...
- [GitHub](https://github.com/google/sentencepiece) (👨‍💻 78 · 🔀 960 · 📥 27K · 📦 31K · 📋 620 - 2% open · ⏱️ 25.05.2023):

	```
	git clone https://github.com/google/sentencepiece
	```
- [PyPi](https://pypi.org/project/sentencepiece) (📥 11M / month · 📦 670 · ⏱️ 07.08.2022):
	```
...
- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 180 · 🔀 1.2K · 📥 22 · 📦 720 · 📋 2.2K - 15% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/UKPLab/sentence-transformers) (👨‍💻 110 · 🔀 2K · 📦 9.1K · 📋 1.8K - 55% open · ⏱️ 23.05.2023):

	```
	git clone https://github.com/UKPLab/sentence-transformers
	```
- [PyPi](https://pypi.org/project/sentence-transformers) (📥 2.3M / month · 📦 300 · ⏱️ 26.06.2022):
	```
...
<details><summary><b><a href="https://github.com/NVIDIA/NeMo">NeMo</a></b> (🥇35 ·  ⭐ 6.8K) - NeMo: a toolkit for conversational AI. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/NVIDIA/NeMo) (👨‍💻 220 · 🔀 1.6K · 📥 41K · 📋 1.6K - 4% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/NVIDIA/NeMo
	```
- [PyPi](https://pypi.org/project/nemo-toolkit) (📥 42K / month · 📦 12 · ⏱️ 01.07.2022):
	```
...
- [GitHub](https://github.com/pytorch/text) (👨‍💻 150 · 🔀 800 · 📋 800 - 37% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/JohnSnowLabs/spark-nlp) (👨‍💻 110 · 🔀 660 · 📦 300 · 📋 790 - 4% open · ⏱️ 29.05.2023):
...
- [GitHub](https://github.com/sloria/TextBlob) (👨‍💻 36 · 🔀 1.1K · 📥 100 · 📦 30K · 📋 270 - 41% open · ⏱️ 11.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/textblob) (📥 830K / month · 📦 1.4K · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 69 · 🔀 580 · 📥 4 · 📦 61 · 📋 790 - 32% open · ⏱️ 25.05.2023):
...
- [GitHub](https://github.com/chartbeat-labs/textacy) (👨‍💻 35 · 🔀 250 · 📦 1.5K · 📋 260 - 11% open · ⏱️ 03.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/textacy) (📥 150K / month · 📦 110 · ⏱️ 06.12.2021):
	```
	pip install textacy
	```
...
- [GitHub](https://github.com/dedupeio/dedupe) (👨‍💻 71 · 🔀 500 · 📦 280 · 📋 800 - 8% open · ⏱️ 17.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/dedupe) (📥 68K / month · 📦 49 · ⏱️ 18.01.2023):
	```
	pip install dedupe
	```
...
- [GitHub](https://github.com/zjunlp/DeepKE) (👨‍💻 22 · 🔀 490 · 📦 16 · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 120 · 📦 11K · 📋 130 - 11% open · ⏱️ 25.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/ftfy) (📥 4.1M / month · 📦 580 · ⏱️ 09.02.2022):
	```
	pip install ftfy
	```
...
- [GitHub](https://github.com/dwyl/english-words) (👨‍💻 30 · 🔀 1.6K · 📋 120 - 72% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/english-words) (📥 360K / month · 📦 8 · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/makcedward/nlpaug) (👨‍💻 33 · 🔀 430 · 📦 740 · 📋 210 - 27% open · ⏱️ 07.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/nlpaug) (📥 120K / month · 📦 26 · ⏱️ 07.07.2022):
	```
	pip install nlpaug
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 900 · 📦 4.2K · ⏱️ 18.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 360K / month · 📦 60 · ⏱️ 20.09.2022):
	```
...
- [GitHub](https://github.com/JasonKessler/scattertext) (👨‍💻 14 · 🔀 280 · 📦 400 · 📋 97 - 19% open · ⏱️ 06.05.2023):
...
- [GitHub](https://github.com/qdrant/qdrant) (👨‍💻 50 · 🔀 520 · 📥 120 · 📋 530 - 17% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/thunlp/OpenPrompt) (👨‍💻 20 · 🔀 360 · 📦 53 · 📋 230 - 25% open · ⏱️ 06.05.2023):
...
- [GitHub](https://github.com/DerwenAI/pytextrank) (👨‍💻 18 · 🔀 340 · 📦 410 · 📋 96 - 25% open · ⏱️ 27.07.2022):
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 19 · 🔀 240 · 📥 54K · 📦 260 · 📋 110 - 18% open · ⏱️ 20.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/sense2vec) (📥 5.3K / month · 📦 13 · ⏱️ 08.12.2022):
	```
...
- [GitHub](https://github.com/deepset-ai/FARM) (👨‍💻 37 · 🔀 230 · 📋 400 - 0% open · ⏱️ 31.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/farm) (📥 4.1K / month · 📦 3 · ⏱️ 10.06.2021):
	```
	pip install farm
	```
...
<details><summary><b><a href="https://github.com/bytedance/lightseq">lightseq</a></b> (🥉22 ·  ⭐ 2.8K) - LightSeq: A High Performance Library for Sequence Processing and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/bytedance/lightseq) (👨‍💻 17 · 🔀 300 · 📥 660 · 📋 270 - 59% open · ⏱️ 10.05.2023):
...
<details><summary><b><a href="https://github.com/bigscience-workshop/promptsource">promptsource</a></b> (🥉22 ·  ⭐ 1.8K) - Toolkit for creating, sharing and using natural language.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/bigscience-workshop/promptsource) (👨‍💻 62 · 🔀 240 · 📋 190 - 27% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/webis-de/small-text) (👨‍💻 3 · 🔀 47 · 📦 19 · 📋 31 - 22% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/webis-de/small-text
	```
- [PyPi](https://pypi.org/project/small-text) (📥 620 / month · ⏱️ 14.10.2022):
	```
...
- [GitHub](https://github.com/dsfsi/textaugment) (👨‍💻 7 · 🔀 55 · 📥 57 · 📦 51 · 📋 20 - 35% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/unum-cloud/uform) (👨‍💻 8 · 🔀 14 · 📦 4 · 📋 5 - 20% open · ⏱️ 02.05.2023):

	```
	git clone https://github.com/unum-cloud/uform
	```
- [PyPi](https://pypi.org/project/uform) (📥 350 / month · ⏱️ 02.05.2023):
	```
	pip install uform
	```
</details>
...
- <b><a href="https://github.com/koursaros-ai/nboost">nboost</a></b> (🥉16 ·  ⭐ 660 · 💀) - NBoost is a scalable, search-api-boosting platform for deploying.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/kornia/kornia) (👨‍💻 220 · 🔀 840 · 📥 650 · 📦 4.5K · 📋 790 - 31% open · ⏱️ 30.05.2023):

	```
	git clone https://github.com/kornia/kornia
	```
- [PyPi](https://pypi.org/project/kornia) (📥 2.7M / month · 📦 100 · ⏱️ 21.12.2022):
	```
	pip install kornia
	```
...
<details><summary><b><a href="https://github.com/open-mmlab/mmdetection">MMDetection</a></b> (🥇36 ·  ⭐ 24K) - OpenMMLab Detection Toolbox and Benchmark. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/open-mmlab/mmdetection) (👨‍💻 390 · 🔀 8.7K · 📋 7.2K - 10% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/open-mmlab/mmdetection
	```
- [PyPi](https://pypi.org/project/mmdet) (📥 170K / month · 📦 29 · ⏱️ 01.06.2022):
	```
	pip install mmdet
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/detectron2) (👨‍💻 250 · 🔀 6.7K · 📦 1.2K · 📋 3.4K - 10% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/albumentations-team/albumentations) (👨‍💻 130 · 🔀 1.5K · 📦 15K · 📋 780 - 45% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/albumentations-team/albumentations
	```
- [PyPi](https://pypi.org/project/albumentations) (📥 640K / month · 📦 290 · ⏱️ 20.09.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleSeg) (👨‍💻 110 · 🔀 1.5K · 📦 930 · 📋 1.8K - 14% open · ⏱️ 29.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/paddleseg) (📥 3.4K / month · 📦 3 · ⏱️ 30.11.2022):
	```
...
- [GitHub](https://github.com/serengil/deepface) (👨‍💻 41 · 🔀 1.3K · 📦 1.5K · 📋 700 - 2% open · ⏱️ 11.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/deepface) (📥 54K / month · 📦 12 · ⏱️ 24.01.2023):
	```
...
<details><summary><b><a href="https://github.com/dmlc/gluon-cv">GluonCV</a></b> (🥈30 ·  ⭐ 5.6K) - Gluon CV Toolkit. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1X" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/timesler/facenet-pytorch) (👨‍💻 15 · 🔀 780 · 📥 620K · 📦 1.1K · 📋 170 - 39% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 27 · 🔀 200 · 📦 120 · 📋 410 - 19% open · ⏱️ 01.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/lightly) (📥 7K / month · 📦 4 · ⏱️ 31.01.2023):
	```
	pip install lightly
	```
</details>
...
- [GitHub](https://github.com/mindee/doctr) (👨‍💻 33 · 🔀 240 · 📥 1.4M · 📦 150 · 📋 250 - 20% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/mindee/doctr
	```
- [PyPi](https://pypi.org/project/python-doctr) (📥 7.1K / month · 📦 4 · ⏱️ 29.09.2022):
	```
	pip install python-doctr
	```
</details>
<details><summary><b><a href="https://github.com/OlafenwaMoses/ImageAI">imageai</a></b> (🥉27 ·  ⭐ 7.8K · 📉) - A python library built to empower developers to build applications.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Layout-Parser/layout-parser) (👨‍💻 8 · 🔀 360 · 📦 310 · 📋 130 - 58% open · ⏱️ 06.08.2022):

	```
	git clone https://github.com/Layout-Parser/layout-parser
	```
- [PyPi](https://pypi.org/project/layoutparser) (📥 67K / month · 📦 6 · ⏱️ 06.04.2022):
	```
...
- [GitHub](https://github.com/idealo/imagededup) (👨‍💻 15 · 🔀 410 · 📦 45 · 📋 130 - 37% open · ⏱️ 28.04.2023):
...
- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 24 · 🔀 180 · 📥 270 · 📦 120 · 📋 120 - 2% open · ⏱️ 15.05.2023):

	```
	git clone https://github.com/tryolabs/norfair
	```
- [PyPi](https://pypi.org/project/norfair) (📥 7K / month · 📦 2 · ⏱️ 04.01.2023):
	```
	pip install norfair
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/mmf) (👨‍💻 110 · 🔀 880 · 📦 14 · 📋 780 - 30% open · ⏱️ 19.05.2023):
...
- [GitHub](https://github.com/libffcv/ffcv) (👨‍💻 26 · 🔀 150 · 📦 23 · 📋 230 - 31% open · ⏱️ 18.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/ffcv) (📥 950 / month · 📦 1 · ⏱️ 28.01.2022):
	```
	pip install ffcv
	```
</details>
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 47 · 📦 520 · 📋 350 - 38% open · ⏱️ 11.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 27K / month · 📦 46 · ⏱️ 12.06.2022):
	```
	pip install pyvips
	```
...
- [GitHub](https://github.com/tensorflow/graphics) (👨‍💻 39 · 🔀 360 · 📋 240 - 61% open · ⏱️ 27.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-graphics) (📥 4.4K / month · 📦 8 · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 30 · 🔀 380 · 📦 860 · 📋 270 - 5% open · ⏱️ 25.05.2023):
...
- [GitHub](https://github.com/danielegrattarola/spektral) (👨‍💻 26 · 🔀 330 · 📦 210 · 📋 260 - 23% open · ⏱️ 11.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/spektral) (📥 7.5K / month · 📦 7 · ⏱️ 22.07.2022):
	```
...
- [GitHub](https://github.com/deepmind/jraph) (👨‍💻 17 · 🔀 73 · 📦 82 · 📋 35 - 25% open · ⏱️ 31.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/jraph) (📥 4.3K / month · 📦 6 · ⏱️ 12.08.2022):
	```
	pip install jraph
	```
...
- [GitHub](https://github.com/snap-stanford/deepsnap) (👨‍💻 17 · 🔀 51 · 📥 9 · 📦 50 · 📋 42 - 42% open · ⏱️ 27.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/deepsnap) (📥 670 / month · 📦 1 · ⏱️ 05.09.2021):
	```
...
<details><summary><b><a href="https://github.com/espnet/espnet">espnet</a></b> (🥇37 ·  ⭐ 6.6K) - End-to-End Speech Processing Toolkit. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/espnet/espnet) (👨‍💻 350 · 🔀 1.9K · 📥 78 · 📦 190 · 📋 2.2K - 21% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/speechbrain/speechbrain) (👨‍💻 200 · 🔀 1.1K · 📦 740 · 📋 950 - 17% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/pytorch/audio) (👨‍💻 210 · 🔀 560 · 📋 860 - 27% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/pytorch/audio
	```
- [PyPi](https://pypi.org/project/torchaudio) (📥 960K / month · 📦 330 · ⏱️ 15.12.2022):
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 940 · 📦 28K · 📋 560 - 53% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 5.3M / month · 📦 1.1K · ⏱️ 10.03.2021):
	```
	pip install pydub
	```
...
- [GitHub](https://github.com/coqui-ai/TTS) (👨‍💻 130 · 🔀 1.6K · 📥 890K · 📋 600 - 5% open · ⏱️ 22.05.2023):

	```
	git clone https://github.com/coqui-ai/TTS
	```
- [PyPi](https://pypi.org/project/tts) (📥 21K / month · 📦 14 · ⏱️ 11.01.2023):
	```
	pip install tts
	```
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥈32 ·  ⭐ 6K · 📈) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 890 · 📋 1.1K - 4% open · ⏱️ 16.05.2023):
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 160 · 🔀 3.7K · 📦 440 · 📋 960 - 38% open · ⏱️ 01.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/magenta) (📥 5.8K / month · 📦 38 · ⏱️ 01.08.2022):
	```
	pip install magenta
	```
</details>
...
- [GitHub](https://github.com/deezer/spleeter) (👨‍💻 19 · 🔀 2.5K · 📥 2.4M · 📦 510 · 📋 750 - 26% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/deezer/spleeter
	```
- [PyPi](https://pypi.org/project/spleeter) (📥 17K / month · 📦 6 · ⏱️ 07.09.2022):
	```
...
- [GitHub](https://github.com/iver56/audiomentations) (👨‍💻 24 · 🔀 160 · 📦 270 · 📋 160 - 26% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/iver56/audiomentations
	```
- [PyPi](https://pypi.org/project/audiomentations) (📥 7.8K / month · 📦 4 · ⏱️ 12.01.2023):
	```
...
- [GitHub](https://github.com/Picovoice/porcupine) (👨‍💻 35 · 🔀 420 · 📦 19 · 📋 450 - 0% open · ⏱️ 31.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/pvporcupine) (📥 3.2K / month · 📦 12 · ⏱️ 28.06.2022):
	```
...
- [GitHub](https://github.com/magenta/ddsp) (👨‍💻 32 · 🔀 300 · 📦 40 · 📋 160 - 24% open · ⏱️ 25.05.2023):

	```
	git clone https://github.com/magenta/ddsp
	```
- [PyPi](https://pypi.org/project/ddsp) (📥 35K / month · 📦 1 · ⏱️ 04.10.2022):
	```
	pip install ddsp
	```
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 23 · 📦 2.3K · 📋 96 - 14% open · ⏱️ 04.07.2022):

	```
	git clone https://github.com/keunwoochoi/kapre
	```
- [PyPi](https://pypi.org/project/kapre) (📥 1.7K / month · 📦 14 · ⏱️ 21.01.2022):
	```
	pip install kapre
	```
</details>
...
- [GitHub](https://github.com/KinWaiCheuk/nnAudio) (👨‍💻 14 · 🔀 82 · 📦 100 · 📋 59 - 28% open · ⏱️ 28.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/nnAudio) (📥 4.2K / month · 📦 3 · ⏱️ 09.10.2022):
	```
	pip install nnAudio
	```
</details>
...
- <b><a href="https://github.com/jameslyons/python_speech_features">python_speech_features</a></b> (🥉24 ·  ⭐ 2.2K · 💀) - This library provides common speech features for ASR.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 230 · 🔀 2K · 📦 6K · 📋 2.7K - 8% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/visgl/deck.gl
	```
- [PyPi](https://pypi.org/project/pydeck) (📥 1.4M / month · 📦 42 · ⏱️ 04.11.2022):
	```
	pip install pydeck
	```
- [Conda](https://anaconda.org/conda-forge/pydeck) (📥 380K · ⏱️ 04.11.2022):
	...
	```
- [npm](https://www.npmjs.com/package/deck.gl) (📥 410K / month · 📦 450 · ⏱️ 31.05.2023):
	```
	npm install deck.gl
	```
</details>
...
- [GitHub](https://github.com/geopandas/geopandas) (👨‍💻 200 · 🔀 820 · 📥 1.9K · 📦 23K · 📋 1.5K - 26% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/geopandas/geopandas
	```
- [PyPi](https://pypi.org/project/geopandas) (📥 4.8M / month · 📦 1.5K · ⏱️ 10.12.2022):
	```
...
- [GitHub](https://github.com/python-visualization/folium) (👨‍💻 150 · 🔀 2.2K · 📦 26K · 📋 1K - 5% open · ⏱️ 24.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/folium) (📥 730K / month · 📦 770 · ⏱️ 12.12.2022):
	```
	pip install folium
	```
...
- [GitHub](https://github.com/rasterio/rasterio) (👨‍💻 150 · 🔀 520 · 📥 800 · 📦 7.8K · 📋 1.7K - 7% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/rasterio/rasterio
	```
- [PyPi](https://pypi.org/project/rasterio) (📥 1.5M / month · 📦 950 · ⏱️ 13.02.2023):
	```
...
- [GitHub](https://github.com/shapely/shapely) (👨‍💻 140 · 🔀 520 · 📥 1.5K · 📦 46K · 📋 1.1K - 19% open · ⏱️ 20.05.2023):
...
- [GitHub](https://github.com/pyproj4/pyproj) (👨‍💻 61 · 🔀 190 · 📦 21K · 📋 570 - 4% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/pyproj4/pyproj
	```
- [PyPi](https://pypi.org/project/pyproj) (📥 6.7M / month · 📦 1.9K · ⏱️ 13.12.2022):
	```
	pip install pyproj
	```
...
- [GitHub](https://github.com/Toblerity/Fiona) (👨‍💻 68 · 🔀 200 · 📦 13K · 📋 750 - 4% open · ⏱️ 23.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/fiona) (📥 5M / month · 📦 860 · ⏱️ 10.02.2023):
	```
	pip install fiona
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 82 · 🔀 350 · 📦 4.5K · 📋 570 - 40% open · ⏱️ 10.02.2023):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 150K / month · 📦 150 · ⏱️ 19.10.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipyleaflet) (📥 1M · ⏱️ 19.10.2022):
	...
	```
- [npm](https://www.npmjs.com/package/jupyter-leaflet) (📥 40K / month · 📦 5 · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/holoviz/geoviews) (👨‍💻 28 · 🔀 70 · 📦 680 · 📋 320 - 34% open · ⏱️ 25.05.2023):

	```
	git clone https://github.com/holoviz/geoviews
	```
- [PyPi](https://pypi.org/project/geoviews) (📥 6.3K / month · 📦 33 · ⏱️ 17.01.2023):
	```
...
- [GitHub](https://github.com/geospace-code/pymap3d) (👨‍💻 15 · 🔀 78 · 📦 270 · 📋 47 - 6% open · ⏱️ 05.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/pymap3d) (📥 60K / month · 📦 20 · ⏱️ 03.07.2022):
	```
	pip install pymap3d
	```
...
- [GitHub](https://github.com/pmorissette/ffn) (👨‍💻 30 · 🔀 260 · 📦 330 · 📋 120 - 18% open · ⏱️ 28.05.2023):
...
- [GitHub](https://github.com/jealous/stockstats) (👨‍💻 9 · 🔀 270 · 📦 850 · 📋 97 - 16% open · ⏱️ 10.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/stockstats) (📥 9.7K / month · 📦 30 · ⏱️ 19.11.2022):
	```
...
- [GitHub](https://github.com/gbeced/pyalgotrade) (👨‍💻 11 · 🔀 1.3K · 📦 160 · 📋 140 - 38% open · ⏱️ 05.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyalgotrade) (📥 880 / month · 📦 21 · ⏱️ 21.08.2018):
	```
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 45 · 🔀 520 · 📋 61 - 54% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/tf-quant-finance) (📥 960 / month · 📦 2 · ⏱️ 19.08.2022):
	```
...
- [GitHub](https://github.com/sktime/sktime) (👨‍💻 260 · 🔀 1.1K · 📥 80 · 📦 1.3K · 📋 1.7K - 34% open · ⏱️ 31.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/sktime) (📥 1.4M / month · 📦 44 · ⏱️ 30.01.2023):
	```
	pip install sktime
	```
...
- [GitHub](https://github.com/facebook/prophet) (👨‍💻 170 · 🔀 4.4K · 📥 1.6K · 📋 2K - 16% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/alkaline-ml/pmdarima) (👨‍💻 22 · 🔀 220 · 📦 5.4K · 📋 310 - 13% open · ⏱️ 26.05.2023):
...
- [GitHub](https://github.com/TDAmeritrade/stumpy) (👨‍💻 33 · 🔀 260 · 📦 450 · 📋 440 - 14% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/awslabs/gluonts) (👨‍💻 100 · 🔀 700 · 📋 860 - 30% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/Nixtla/statsforecast) (👨‍💻 21 · 🔀 170 · 📦 290 · 📋 160 - 41% open · ⏱️ 31.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/statsforecast) (📥 330K / month · 📦 17 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/tslearn-team/tslearn) (👨‍💻 41 · 🔀 320 · 📦 840 · 📋 290 - 36% open · ⏱️ 24.03.2023):

	```
	git clone https://github.com/tslearn-team/tslearn
	```
- [PyPi](https://pypi.org/project/tslearn) (📥 250K / month · 📦 42 · ⏱️ 20.01.2023):
	```
	pip install tslearn
	```
...
- [GitHub](https://github.com/jdb78/pytorch-forecasting) (👨‍💻 35 · 🔀 480 · 📋 660 - 59% open · ⏱️ 10.04.2023):

	```
	git clone https://github.com/jdb78/pytorch-forecasting
	```
- [PyPi](https://pypi.org/project/pytorch-forecasting) (📥 63K / month · 📦 9 · ⏱️ 07.09.2022):
	```
...
- [GitHub](https://github.com/Nixtla/neuralforecast) (👨‍💻 25 · 🔀 150 · 📦 19 · 📋 270 - 22% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/Nixtla/neuralforecast
	```
- [PyPi](https://pypi.org/project/neuralforecast) (📥 5.7K / month · 📦 3 · ⏱️ 15.12.2022):
	```
	pip install neuralforecast
	```
- [Conda](https://anaconda.org/conda-forge/neuralforecast) (📥 6.9K · ⏱️ 22.04.2023):
	```
...
- [GitHub](https://github.com/linkedin/greykite) (👨‍💻 9 · 🔀 94 · 📥 1 · 📦 19 · 📋 88 - 17% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/dmbee/seglearn) (👨‍💻 14 · 🔀 64 · 📦 39 · 📋 30 - 20% open · ⏱️ 27.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/seglearn) (📥 2.5K / month · 📦 2 · ⏱️ 27.08.2022):
	```
...
- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 340 · 🔀 1.2K · 📦 2.7K · 📋 4.5K - 10% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/mne-tools/mne-python
	```
- [PyPi](https://pypi.org/project/mne) (📥 63K / month · 📦 270 · ⏱️ 22.12.2022):
	```
	pip install mne
	```
...
- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 150 · 🔀 790 · 📦 1K · 📋 2.5K - 11% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/Project-MONAI/MONAI
	```
- [PyPi](https://pypi.org/project/monai) (📥 89K / month · 📦 45 · ⏱️ 19.12.2022):
	```
	pip install monai
	```
...
- [GitHub](https://github.com/nilearn/nilearn) (👨‍💻 210 · 🔀 500 · 📥 120 · 📦 2.3K · 📋 1.8K - 15% open · ⏱️ 24.05.2023):

	```
	git clone https://github.com/nilearn/nilearn
	```
- [PyPi](https://pypi.org/project/nilearn) (📥 35K / month · 📦 270 · ⏱️ 06.01.2023):
	```
	pip install nilearn
	```
...
- [GitHub](https://github.com/nipy/nipype) (👨‍💻 240 · 🔀 510 · 📦 1.5K · 📋 1.3K - 29% open · ⏱️ 28.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/nipype) (📥 76K / month · 📦 170 · ⏱️ 21.09.2022):
	```
	pip install nipype
	```
...
- [GitHub](https://github.com/carefree0910/carefree-learn) (👨‍💻 1 · 🔀 37 · 📦 3 · 📋 82 - 2% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/manujosephv/pytorch_tabular) (👨‍💻 15 · 🔀 100 · 📥 5 · 📋 100 - 6% open · ⏱️ 01.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/pytorch_tabular) (📥 1.8K / month · 📦 2 · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 860 · 🔀 4.5K · 📥 82 · 📦 9.9K · 📋 14K - 19% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 310 · 🔀 690 · 📦 29K · 📋 3.6K - 38% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/horovod/horovod) (👨‍💻 170 · 🔀 2.2K · 📦 910 · 📋 2.2K - 15% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/horovod/horovod
	```
- [PyPi](https://pypi.org/project/horovod) (📥 73K / month · 📦 35 · ⏱️ 21.06.2022):
	```
	pip install horovod
	```
</details>
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 2K · 📋 8.9K - 29% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/h2oai/h2o-3
	```
- [PyPi](https://pypi.org/project/h2o) (📥 370K / month · 📦 82 · ⏱️ 08.02.2023):
	```
	pip install h2o
	```
</details>
...
- [GitHub](https://github.com/hpcaitech/ColossalAI) (👨‍💻 130 · 🔀 3.5K · 📦 240 · 📋 1.1K - 27% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 110 · 🔀 740 · 📋 680 - 43% open · ⏱️ 26.05.2023):
...
- [GitHub](https://github.com/maxpumperla/elephas) (👨‍💻 27 · 🔀 310 · 📦 70 · 📋 160 - 4% open · ⏱️ 31.08.2022):

	```
	git clone https://github.com/maxpumperla/elephas
	```
- [PyPi](https://pypi.org/project/elephas) (📥 64K / month · 📦 3 · ⏱️ 04.03.2023):
	```
	pip install elephas
	```
...
- [GitHub](https://github.com/mpi4py/mpi4py) (👨‍💻 24 · 🔀 97 · 📥 13K · 📋 120 - 8% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/yahoo/TensorFlowOnSpark) (👨‍💻 34 · 🔀 960 · 📋 360 - 2% open · ⏱️ 27.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorflowonspark) (📥 300K / month · 📦 5 · ⏱️ 21.04.2022):
	```
...
- [GitHub](https://github.com/facebookincubator/submitit) (👨‍💻 23 · 🔀 100 · 📦 1.2K · 📋 99 - 28% open · ⏱️ 28.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/submitit) (📥 130K / month · 📦 11 · ⏱️ 20.07.2022):
	```
...
- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 28 · 🔀 97 · 📦 61 · 📋 150 - 33% open · ⏱️ 26.04.2023):

	```
	git clone https://github.com/learning-at-home/hivemind
	```
- [PyPi](https://pypi.org/project/hivemind) (📥 1.9K / month · 📦 5 · ⏱️ 07.01.2023):
	```
...
- [GitHub](https://github.com/intel-analytics/analytics-zoo) (👨‍💻 110 · 🔀 720 · 📦 3 · 📋 1.4K - 38% open · ⏱️ 24.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/analytics-zoo) (📥 310 / month · 📦 1 · ⏱️ 22.08.2022):
	```
...
- [GitHub](https://github.com/tunib-ai/parallelformers) (👨‍💻 5 · 🔀 51 · 📦 19 · 📋 39 - 56% open · ⏱️ 27.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/parallelformers) (📥 2.7K / month · ⏱️ 27.07.2022):
	```
...
- [GitHub](https://github.com/microsoft/nni) (👨‍💻 190 · 🔀 1.8K · 📦 400 · 📋 1.9K - 14% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/microsoft/nni
	```
- [PyPi](https://pypi.org/project/nni) (📥 14K / month · 📦 38 · ⏱️ 14.11.2022):
	```
	pip install nni
	```
</details>
...
- [GitHub](https://github.com/alteryx/featuretools) (👨‍💻 69 · 🔀 840 · 📦 1.3K · 📋 960 - 18% open · ⏱️ 25.05.2023):

	```
	git clone https://github.com/alteryx/featuretools
	```
- [PyPi](https://pypi.org/project/featuretools) (📥 50K / month · 📦 76 · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/pytorch/botorch) (👨‍💻 92 · 🔀 320 · 📦 560 · 📋 410 - 15% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/pytorch/botorch
	```
- [PyPi](https://pypi.org/project/botorch) (📥 190K / month · 📦 30 · ⏱️ 06.01.2023):
	```
	pip install botorch
	```
...
- [GitHub](https://github.com/facebook/Ax) (👨‍💻 140 · 🔀 260 · 📦 480 · 📋 540 - 9% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/keras-team/keras-tuner) (👨‍💻 56 · 🔀 370 · 📦 2.4K · 📋 450 - 42% open · ⏱️ 22.04.2023):

	```
	git clone https://github.com/keras-team/keras-tuner
	```
- [PyPi](https://pypi.org/project/keras-tuner) (📥 280K / month · 📦 56 · ⏱️ 28.01.2023):
	```
...
- [GitHub](https://github.com/automl/auto-sklearn) (👨‍💻 88 · 🔀 1.2K · 📥 44 · 📦 450 · 📋 980 - 16% open · ⏱️ 18.04.2023):
...
- [GitHub](https://github.com/autogluon/autogluon) (👨‍💻 100 · 🔀 740 · 📦 2 · 📋 1K - 22% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/facebookresearch/nevergrad) (👨‍💻 49 · 🔀 330 · 📦 500 · 📋 270 - 42% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/mljar/mljar-supervised) (👨‍💻 21 · 🔀 340 · 📦 76 · 📋 540 - 21% open · ⏱️ 16.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/mljar-supervised) (📥 10K / month · 📦 2 · ⏱️ 02.01.2023):
	```
...
- [GitHub](https://github.com/aimclub/FEDOT) (👨‍💻 27 · 🔀 73 · 📦 31 · 📋 460 - 20% open · ⏱️ 30.05.2023):

	```
	git clone https://github.com/nccr-itmo/FEDOT
	```
- [PyPi](https://pypi.org/project/fedot) (📥 730 / month · 📦 1 · ⏱️ 12.12.2022):
	```
	pip install fedot
	```
</details>
...
<details><summary><b><a href="https://github.com/AutoViML/featurewiz">featurewiz</a></b> (🥉23 ·  ⭐ 410) - Use advanced feature engineering strategies and select best.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/Neuraxio/Neuraxle) (👨‍💻 9 · 🔀 57 · 📦 46 · 📋 330 - 14% open · ⏱️ 16.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/neuraxle) (📥 420 / month · 📦 1 · ⏱️ 16.08.2022):
	```
...
- [GitHub](https://github.com/nidhaloff/igel) (👨‍💻 20 · 🔀 160 · 📥 36 · 📦 4 · 📋 50 - 12% open · ⏱️ 08.04.2023):

	```
	git clone https://github.com/nidhaloff/igel
	```
- [PyPi](https://pypi.org/project/igel) (📥 91 / month · ⏱️ 19.11.2021):
	```
	pip install igel
	```
</details>
...
- [GitHub](https://github.com/dragonfly/dragonfly) (👨‍💻 13 · 🔀 220 · 📋 59 - 66% open · ⏱️ 01.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/dragonfly-opt) (📥 24K / month · 📦 2 · ⏱️ 01.10.2022):
	```
...
- <b><a href="https://github.com/automl/SMAC3">SMAC3</a></b> (🥈26 ·  ⭐ 850) - SMAC3: A Versatile Bayesian Optimization Package for.. <code><a href="https://tldrlegal.com/search?q=BSD-1-Clause">❗️BSD-1-Clause</a></code>
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 8.5K · 📦 43K · 📋 1.8K - 2% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 490K / month · 📦 2.7K · ⏱️ 04.10.2022):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 140 · 🔀 690 · 📦 1.2K · 📋 640 - 28% open · ⏱️ 26.05.2023):
...
- [GitHub](https://github.com/AI4Finance-Foundation/FinRL) (👨‍💻 95 · 🔀 1.8K · 📦 20 · 📋 600 - 23% open · ⏱️ 26.05.2023):
...
- [GitHub](https://github.com/deepmind/acme) (👨‍💻 83 · 🔀 400 · 📦 140 · 📋 260 - 21% open · ⏱️ 26.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dm-acme) (📥 2.5K / month · 📦 3 · ⏱️ 10.02.2022):
	```
	pip install dm-acme
	```
...
- [GitHub](https://github.com/PaddlePaddle/PARL) (👨‍💻 41 · 🔀 800 · 📦 110 · 📋 490 - 19% open · ⏱️ 19.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/parl) (📥 620 / month · 📦 1 · ⏱️ 28.11.2022):
	```
	pip install parl
	```
</details>
...
- [GitHub](https://github.com/google/dopamine) (👨‍💻 15 · 🔀 1.4K · 📋 180 - 52% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/dopamine-rl) (📥 46K / month · 📦 39 · ⏱️ 21.09.2022):
	```
...
- [GitHub](https://github.com/rlworkgroup/garage) (👨‍💻 79 · 🔀 290 · 📦 84 · 📋 1K - 22% open · ⏱️ 04.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/garage) (📥 900 / month · 📦 2 · ⏱️ 23.03.2021):
	```
	pip install garage
	```
</details>
...
- [GitHub](https://github.com/deepmind/rlax) (👨‍💻 21 · 🔀 75 · 📦 130 · 📋 33 - 45% open · ⏱️ 09.05.2023):
...
- [GitHub](https://github.com/hill-a/stable-baselines) (👨‍💻 110 · 🔀 710 · 📋 940 - 12% open · ⏱️ 04.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/stable-baselines) (📥 7.2K / month · 📦 37 · ⏱️ 06.04.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 160 · 🔀 490 · 📋 140 - 47% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/tensorforce/tensorforce) (👨‍💻 82 · 🔀 540 · 📋 660 - 4% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorforce) (📥 820 / month · 📦 2 · ⏱️ 30.08.2021):
	```
...
- [GitHub](https://github.com/microsoft/recommenders) (👨‍💻 120 · 🔀 2.7K · 📥 330 · 📦 73 · 📋 760 - 20% open · ⏱️ 22.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/recommenders) (📥 38K / month · 📦 2 · ⏱️ 20.07.2022):
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 590 · 📥 360 · 📦 1K · 📋 460 - 17% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/tensorflow/recommenders) (👨‍💻 42 · 🔀 230 · 📦 220 · 📋 370 - 53% open · ⏱️ 27.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-recommenders) (📥 340K / month · 📦 2 · ⏱️ 23.08.2021):
	```
...
- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 16 · 🔀 120 · 📦 160 · 📋 120 - 10% open · ⏱️ 13.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/cornac) (📥 56K / month · 📦 16 · ⏱️ 19.02.2022):
	```
	pip install cornac
	```
...
- [GitHub](https://github.com/pytorch/torchrec) (👨‍💻 160 · 🔀 260 · 📋 190 - 61% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/RUCAIBox/RecBole) (👨‍💻 63 · 🔀 500 · 📋 720 - 14% open · ⏱️ 19.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/recbole) (📥 3.8K / month · 📦 2 · ⏱️ 05.10.2022):
	```
	pip install recbole
	```
...
- [GitHub](https://github.com/OpenMined/PySyft) (👨‍💻 490 · 🔀 1.9K · 📋 3.4K - 4% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/pytorch/opacus) (👨‍💻 69 · 🔀 290 · 📥 78 · 📦 590 · 📋 250 - 25% open · ⏱️ 18.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/opacus) (📥 30K / month · 📦 18 · ⏱️ 14.11.2022):
	```
	pip install opacus
	```
...
- [GitHub](https://github.com/facebookresearch/CrypTen) (👨‍💻 32 · 🔀 220 · 📦 30 · 📋 230 - 22% open · ⏱️ 29.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/crypten) (📥 310 / month · 📦 2 · ⏱️ 08.12.2022):
	```
	pip install crypten
	```
</details>
...
- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 580 · 🔀 3.4K · 📦 20K · 📋 3.1K - 36% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 300 · 🔀 1.6K · 📦 170K · 📋 1.8K - 34% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/wandb/wandb) (👨‍💻 150 · 🔀 480 · 📦 24K · 📋 2.5K - 24% open · ⏱️ 31.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/wandb) (📥 2.3M / month · 📦 460 · ⏱️ 07.03.2023):
	```
	pip install wandb
	```
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 370 · 🔀 980 · 📦 2.6K · 📋 1.3K - 36% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/aws/sagemaker-python-sdk
	```
- [PyPi](https://pypi.org/project/sagemaker) (📥 25M / month · 📦 76 · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/pycaret/pycaret) (👨‍💻 120 · 🔀 1.6K · 📥 640 · 📦 3.7K · 📋 2.1K - 13% open · ⏱️ 31.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/pycaret) (📥 230K / month · 📦 14 · ⏱️ 09.01.2023):
	```
	pip install pycaret
	```
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 290 · 🔀 450 · 📦 1.5K · 📋 1.3K - 59% open · ⏱️ 22.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/snakemake) (📥 65K / month · 📦 240 · ⏱️ 18.01.2023):
	```
...
- [GitHub](https://github.com/aimhubio/aim) (👨‍💻 62 · 🔀 230 · 📦 230 · 📋 890 - 29% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/Azure/MachineLearningNotebooks) (👨‍💻 64 · 🔀 2.3K · 📥 490 · 📋 1.4K - 24% open · ⏱️ 25.05.2023):
...
- [GitHub](https://github.com/lanpa/tensorboardX) (👨‍💻 79 · 🔀 870 · 📥 380 · 📦 31K · 📋 450 - 17% open · ⏱️ 14.05.2023):

	```
	git clone https://github.com/lanpa/tensorboardX
	```
- [PyPi](https://pypi.org/project/tensorboardX) (📥 1.6M / month · 📦 970 · ⏱️ 05.06.2022):
	```
...
- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 71 · 🔀 640 · 📦 480 · 📋 570 - 47% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/Netflix/metaflow
	```
- [PyPi](https://pypi.org/project/metaflow) (📥 130K / month · 📦 16 · ⏱️ 26.01.2023):
	```
...
- [GitHub](https://github.com/allegroai/clearml) (👨‍💻 78 · 🔀 590 · 📥 1.1K · 📦 570 · 📋 810 - 42% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/allegroai/clearml
	```
- [PyPi](https://pypi.org/project/clearml) (📥 220K / month · 📦 14 · ⏱️ 25.01.2023):
	```
	pip install clearml
	```
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 32 · 🔀 630 · 📥 300 · 📦 2K · 📋 490 - 28% open · ⏱️ 04.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/visualdl) (📥 130K / month · 📦 39 · ⏱️ 17.01.2023):
	```
	pip install visualdl
	```
</details>
<details><summary><b><a href="https://github.com/Kaggle/kaggle-api">kaggle</a></b> (🥈30 ·  ⭐ 5.3K · 📈) - Official Kaggle API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/IDSIA/sacred) (👨‍💻 100 · 🔀 370 · 📦 2.4K · 📋 550 - 17% open · ⏱️ 02.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/sacred) (📥 41K / month · 📦 110 · ⏱️ 25.01.2023):
	```
	pip install sacred
	```
...
- [GitHub](https://github.com/neptune-ai/neptune-client) (👨‍💻 41 · 🔀 41 · 📋 210 - 14% open · ⏱️ 22.05.2023):
...
- [GitHub](https://github.com/pytorch/tnt) (👨‍💻 87 · 🔀 230 · 📋 67 - 8% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/MrPowers/quinn) (👨‍💻 16 · 🔀 65 · 📥 6 · 📦 62 · 📋 60 - 50% open · ⏱️ 08.05.2023):
...
- [GitHub](https://github.com/labmlai/labml) (👨‍💻 7 · 🔀 94 · 📦 88 · 📋 39 - 56% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/studioml/studio) (👨‍💻 22 · 🔀 52 · 📦 5 · 📋 250 - 22% open · ⏱️ 09.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/studioml) (📥 450 / month · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 280 · 🔀 3.5K · 📥 19K · 📦 16K · 📋 2.4K - 15% open · ⏱️ 30.05.2023):

	```
	git clone https://github.com/onnx/onnx
	```
- [PyPi](https://pypi.org/project/onnx) (📥 3M / month · 📦 540 · ⏱️ 12.12.2022):
	```
	pip install onnx
	```
...
- [GitHub](https://github.com/bentoml/BentoML) (👨‍💻 160 · 🔀 570 · 📥 1.9K · 📦 990 · 📋 910 - 20% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/bentoml/BentoML
	```
- [PyPi](https://pypi.org/project/bentoml) (📥 39K / month · 📦 11 · ⏱️ 15.02.2023):
	```
	pip install bentoml
	```
</details>
...
- [GitHub](https://github.com/apple/coremltools) (👨‍💻 150 · 🔀 500 · 📥 6.5K · 📦 3.1K · 📋 1.2K - 18% open · ⏱️ 31.05.2023):
...
<details><summary><b><a href="https://github.com/huggingface/huggingface_hub">huggingface_hub</a></b> (🥈33 ·  ⭐ 920) - All the open source things related to the Hugging Face Hub. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/huggingface_hub) (👨‍💻 96 · 🔀 220 · 📋 480 - 20% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/huggingface/huggingface_hub
	```
- [PyPi](https://pypi.org/project/huggingface_hub) (📥 12M / month · 📦 270 · ⏱️ 25.01.2023):
	```
...
- [GitHub](https://github.com/pytorch/serve) (👨‍💻 160 · 🔀 740 · 📥 3.9K · 📋 1.3K - 21% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/microsoft/hummingbird) (👨‍💻 38 · 🔀 260 · 📥 250 · 📦 78 · 📋 290 - 18% open · ⏱️ 15.05.2023):

	```
	git clone https://github.com/microsoft/hummingbird
	```
- [PyPi](https://pypi.org/project/hummingbird-ml) (📥 6.9K / month · 📦 5 · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/nebuly-ai/nebuly) (👨‍💻 39 · 🔀 640 · 📋 190 - 46% open · ⏱️ 05.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/nebullvm) (📥 440 / month · 📦 1 · ⏱️ 23.01.2023):
	```
...
- [GitHub](https://github.com/fastmachinelearning/hls4ml) (👨‍💻 53 · 🔀 270 · 📋 340 - 31% open · ⏱️ 16.05.2023):

	```
	git clone https://github.com/fastmachinelearning/hls4ml
	```
- [PyPi](https://pypi.org/project/hls4ml) (📥 670 / month):
	```
	pip install hls4ml
	```
...
- [GitHub](https://github.com/BayesWitnesses/m2cgen) (👨‍💻 14 · 🔀 200 · 📥 47 · 📦 130 · 📋 100 - 30% open · ⏱️ 05.10.2022):
...
- <b><a href="https://github.com/apple/ml-ane-transformers">ml-ane-transformers</a></b> (🥉15 ·  ⭐ 2.2K · 💤) - Reference implementation of the Transformer.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/slundberg/shap) (👨‍💻 200 · 🔀 2.8K · 📦 12K · 📋 2.2K - 71% open · ⏱️ 16.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/shap) (📥 3.8M / month · 📦 390 · ⏱️ 16.06.2022):
	```
	pip install shap
	```
...
- [GitHub](https://github.com/lutzroeder/netron) (👨‍💻 2 · 🔀 2.5K · 📥 68K · 📦 10 · 📋 940 - 2% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/interpretml/interpret) (👨‍💻 38 · 🔀 670 · 📦 450 · 📋 360 - 17% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/interpretml/interpret
	```
- [PyPi](https://pypi.org/project/interpret) (📥 60K / month · 📦 26 · ⏱️ 18.11.2022):
	```
...
- [GitHub](https://github.com/bmabey/pyLDAvis) (👨‍💻 39 · 🔀 360 · 📦 5K · 📋 180 - 44% open · ⏱️ 24.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyldavis) (📥 460K / month · 📦 150 · ⏱️ 24.03.2021):
	```
...
- [GitHub](https://github.com/huggingface/evaluate) (👨‍💻 120 · 🔀 150 · 📦 2.2K · 📋 190 - 38% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/huggingface/evaluate
	```
- [PyPi](https://pypi.org/project/evaluate) (📥 500K / month):
	```
...
- [GitHub](https://github.com/py-why/dowhy) (👨‍💻 75 · 🔀 820 · 📥 32 · 📦 240 · 📋 380 - 31% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/py-why/dowhy
	```
- [PyPi](https://pypi.org/project/dowhy) (📥 34K / month · 📦 13 · ⏱️ 17.12.2022):
	```
	pip install dowhy
	```
...
- [GitHub](https://github.com/microsoft/responsible-ai-toolbox) (👨‍💻 36 · 🔀 230 · 📦 58 · 📋 290 - 24% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/microsoft/responsible-ai-toolbox
	```
- [PyPi](https://pypi.org/project/raiwidgets) (📥 5K / month · 📦 3 · ⏱️ 18.01.2023):
	```
...
- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 19 · 🔀 240 · 📦 300 · 📋 210 - 8% open · ⏱️ 09.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/explainerdashboard) (📥 36K / month · 📦 8 · ⏱️ 02.01.2023):
	```
...
- [GitHub](https://github.com/quantumblacklabs/causalnex) (👨‍💻 34 · 🔀 220 · 📦 92 · 📋 140 - 17% open · ⏱️ 01.06.2023):
...
<details><summary><b><a href="https://github.com/DistrictDataLabs/yellowbrick">yellowbrick</a></b> (🥈26 ·  ⭐ 4K) - Visual analysis and diagnostic tools to facilitate machine.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/DistrictDataLabs/yellowbrick) (👨‍💻 110 · 🔀 540 · 📋 690 - 12% open · ⏱️ 19.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/yellowbrick) (📥 510K / month · 📦 77 · ⏱️ 21.08.2022):
	```
...
- [GitHub](https://github.com/csinva/imodels) (👨‍💻 20 · 🔀 98 · 📦 48 · 📋 65 - 33% open · ⏱️ 28.05.2023):
...
- [GitHub](https://github.com/marcotcr/checklist) (👨‍💻 13 · 🔀 180 · 📦 250 · 📋 110 - 22% open · ⏱️ 12.08.2022):
...
- [GitHub](https://github.com/philipperemy/keract) (👨‍💻 16 · 🔀 180 · 📦 180 · 📋 89 - 3% open · ⏱️ 03.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/keract) (📥 14K / month · 📦 9 · ⏱️ 25.09.2022):
	```
	pip install keract
	```
</details>
...
- [GitHub](https://github.com/PAIR-code/what-if-tool) (👨‍💻 20 · 🔀 150 · 📋 140 - 58% open · ⏱️ 27.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/witwidget) (📥 9.1K / month · 📦 4 · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/edublancas/sklearn-evaluation) (👨‍💻 19 · 🔀 41 · ⏱️ 13.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-evaluation) (📥 110K / month · 📦 5 · ⏱️ 07.03.2023):
	```
...
- <b><a href="https://github.com/understandable-machine-intelligence-lab/Quantus">Quantus</a></b> (🥉21 ·  ⭐ 370) - Quantus is an eXplainable AI toolkit for responsible evaluation.. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 460 · 🔀 1.8K · 📥 1.9K · 📦 1.6K · 📋 3.1K - 6% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 480 · 🔀 1.1K · 📋 1.4K - 46% open · ⏱️ 26.05.2023):
...
- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 140 · 🔀 970 · 📦 1.4K · 📋 1K - 23% open · ⏱️ 29.05.2023):

	```
	git clone https://github.com/pyro-ppl/pyro
	```
- [PyPi](https://pypi.org/project/pyro-ppl) (📥 330K / month · 📦 88 · ⏱️ 03.01.2023):
	```
...
- [GitHub](https://github.com/cornellius-gp/gpytorch) (👨‍💻 120 · 🔀 490 · 📦 1.3K · 📋 1.3K - 26% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/cornellius-gp/gpytorch
	```
- [PyPi](https://pypi.org/project/gpytorch) (📥 210K / month · 📦 68 · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/pgmpy/pgmpy) (👨‍💻 120 · 🔀 670 · 📥 240 · 📦 640 · 📋 840 - 28% open · ⏱️ 17.05.2023):

	```
	git clone https://github.com/pgmpy/pgmpy
	```
- [PyPi](https://pypi.org/project/pgmpy) (📥 61K / month · 📦 24 · ⏱️ 02.01.2023):
	```
	pip install pgmpy
	```
</details>
<details><summary><b><a href="https://github.com/SALib/SALib">SALib</a></b> (🥈32 ·  ⭐ 720) - Sensitivity Analysis Library in Python. Contains Sobol, Morris, FAST, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/SALib/SALib) (👨‍💻 41 · 🔀 210 · 📦 780 · 📋 300 - 13% open · ⏱️ 02.05.2023):
...
- [GitHub](https://github.com/jmschrei/pomegranate) (👨‍💻 68 · 🔀 570 · 📦 940 · 📋 710 - 1% open · ⏱️ 22.05.2023):

	```
	git clone https://github.com/jmschrei/pomegranate
	```
- [PyPi](https://pypi.org/project/pomegranate) (📥 29K / month · 📦 54 · ⏱️ 21.02.2022):
	```
...
- [GitHub](https://github.com/GPflow/GPflow) (👨‍💻 83 · 🔀 440 · 📦 520 · 📋 820 - 17% open · ⏱️ 03.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/gpflow) (📥 54K / month · 📦 35 · ⏱️ 27.01.2023):
	```
	pip install gpflow
	```
...
- [GitHub](https://github.com/pydata/patsy) (👨‍💻 17 · 🔀 100 · 📦 73K · 📋 140 - 48% open · ⏱️ 09.10.2022):

	```
	git clone https://github.com/pydata/patsy
	```
- [PyPi](https://pypi.org/project/patsy) (📥 9M / month · 📦 2.7K · ⏱️ 09.10.2022):
	```
	pip install patsy
	```
...
- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 32 · 🔀 100 · 📦 69 · 📋 340 - 21% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/bambinos/bambi
	```
- [PyPi](https://pypi.org/project/bambi) (📥 14K / month · 📦 5 · ⏱️ 21.12.2022):
	```
	pip install bambi
	```
...
- [GitHub](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (👨‍💻 130 · 🔀 980 · 📦 370 · 📋 800 - 13% open · ⏱️ 29.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/adversarial-robustness-toolbox) (📥 18K / month · 📦 10 · ⏱️ 16.02.2023):
	```
...
- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 58 · 🔀 320 · 📦 180 · 📋 250 - 15% open · ⏱️ 21.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/textattack) (📥 5.3K / month · 📦 7 · ⏱️ 02.11.2022):
	```
...
- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 260 · 🔀 690 · 📋 5.5K - 15% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/rapidsai/cudf
	```
- [PyPi](https://pypi.org/project/cudf) (📥 2K / month · 📦 8 · ⏱️ 01.06.2020):
	```
	pip install cudf
	```
</details>
...
- [GitHub](https://github.com/huggingface/optimum) (👨‍💻 63 · 🔀 180 · 📦 170 · 📋 370 - 43% open · ⏱️ 01.06.2023):
...
- [PyPi](https://pypi.org/project/optimum) (📥 110K / month · 📦 13 · ⏱️ 25.01.2023):
	...
	pip install optimum
	```
- [Conda](https://anaconda.org/conda-forge/optimum) (📥 7.4K · ⏱️ 12.07.2022):
	```
...
- [GitHub](https://github.com/NVIDIA/apex) (👨‍💻 120 · 🔀 1.2K · 📦 1.8K · 📋 1.2K - 56% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/inducer/pycuda) (👨‍💻 80 · 🔀 270 · 📦 2.1K · 📋 250 - 31% open · ⏱️ 27.05.2023):
...
- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 100 · 🔀 240 · 📦 2 · 📋 1.5K - 20% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/NVIDIA/DALI) (👨‍💻 82 · 🔀 570 · 📋 1.5K - 18% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/NVIDIA-Merlin/Merlin) (👨‍💻 29 · 🔀 76 · 📋 410 - 43% open · ⏱️ 30.05.2023):
...
- [GitHub](https://github.com/tensorflow/datasets) (👨‍💻 280 · 🔀 1.4K · 📋 1.3K - 49% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/tensorflow/tfx) (👨‍💻 170 · 🔀 670 · 📋 900 - 13% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 79 · 🔀 310 · 📦 2.9K · 📋 350 - 55% open · ⏱️ 26.05.2023):

	```
	git clone https://github.com/tensorflow/model-optimization
	```
- [PyPi](https://pypi.org/project/tensorflow-model-optimization) (📥 320K / month · 📦 30 · ⏱️ 21.07.2022):
	```
...
<details><summary><b><a href="https://github.com/google/evojax">evojax</a></b> (🥉18 ·  ⭐ 660) - EvoJAX: Hardware-accelerated Neuroevolution. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google/evojax) (👨‍💻 13 · 🔀 54 · 📦 4 · 📋 22 - 27% open · ⏱️ 20.02.2023):
...
- [GitHub](https://github.com/rasbt/mlxtend) (👨‍💻 98 · 🔀 810 · 📦 9.4K · 📋 460 - 27% open · ⏱️ 21.05.2023):

	```
	git clone https://github.com/rasbt/mlxtend
	```
- [PyPi](https://pypi.org/project/mlxtend) (📥 820K / month · 📦 170 · ⏱️ 20.09.2022):
	```
	pip install mlxtend
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/imbalanced-learn) (👨‍💻 71 · 🔀 1.2K · 📦 17K · 📋 560 - 11% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/intel/scikit-learn-intelex) (👨‍💻 74 · 🔀 160 · 📦 6.4K · 📋 220 - 34% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/koaning/scikit-lego) (👨‍💻 57 · 🔀 99 · 📦 93 · 📋 260 - 10% open · ⏱️ 04.03.2023):

	```
	git clone https://github.com/koaning/scikit-lego
	```
- [PyPi](https://pypi.org/project/scikit-lego) (📥 29K / month · 📦 7 · ⏱️ 02.11.2022):
	```
...
- [GitHub](https://github.com/trent-b/iterative-stratification) (👨‍💻 7 · 🔀 69 · 📦 310 · 📋 26 - 15% open · ⏱️ 06.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/iterative-stratification) (📥 59K / month · 📦 12 · ⏱️ 03.10.2021):
	```
...
- [GitHub](https://github.com/huggingface/accelerate) (👨‍💻 140 · 🔀 480 · 📦 7.1K · 📋 750 - 13% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/huggingface/accelerate
	```
- [PyPi](https://pypi.org/project/accelerate) (📥 3.5M / month · 📦 180 · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/KevinMusgrave/pytorch-metric-learning) (👨‍💻 34 · 🔀 620 · 📦 680 · 📋 460 - 10% open · ⏱️ 27.05.2023):

	```
	git clone https://github.com/KevinMusgrave/pytorch-metric-learning
	```
- [PyPi](https://pypi.org/project/pytorch-metric-learning) (📥 210K / month · 📦 18 · ⏱️ 29.01.2023):
	```
...
- [GitHub](https://github.com/geohot/tinygrad) (👨‍💻 130 · 🔀 1.3K · 📦 16 · 📋 240 - 23% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/rusty1s/pytorch_scatter) (👨‍💻 25 · 🔀 160 · 📋 320 - 5% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/rusty1s/pytorch_sparse) (👨‍💻 41 · 🔀 140 · 📋 240 - 11% open · ⏱️ 22.05.2023):
...
- [GitHub](https://github.com/dreamquark-ai/tabnet) (👨‍💻 19 · 🔀 420 · 📋 290 - 14% open · ⏱️ 25.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-tabnet) (📥 29K / month · 📦 10 · ⏱️ 19.09.2022):
	```
...
- [GitHub](https://github.com/BloodAxe/pytorch-toolbelt) (👨‍💻 7 · 🔀 110 · 📥 21 · 📋 27 - 7% open · ⏱️ 04.05.2023):
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.5K · 🔀 4.7K · 📥 370K · 📦 750K · 📋 9.4K - 17% open · ⏱️ 01.06.2023):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 4K · 📥 500K · 📦 64K · 📋 13K - 36% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 8.6M / month · 📦 4.5K · ⏱️ 30.08.2022):
	```
	pip install sympy
	```
...
- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 160 · 🔀 1.2K · 📦 7.6K · 📋 2.2K - 16% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/gradio-app/gradio
	```
- [PyPi](https://pypi.org/project/gradio) (📥 3.8M / month · 📦 100 · ⏱️ 20.02.2023):
	```
	pip install gradio
	```
</details>
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 220 · 🔀 1.5K · 📦 210 · 📋 1.6K - 27% open · ⏱️ 31.05.2023):
...
<details><summary><b><a href="https://github.com/carla-simulator/carla">carla</a></b> (🥇34 ·  ⭐ 9.3K) - Open-source simulator for autonomous driving research. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/carla-simulator/carla) (👨‍💻 150 · 🔀 2.9K · 📦 460 · 📋 4.5K - 22% open · ⏱️ 24.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/carla) (📥 21K / month · 📦 6 · ⏱️ 24.12.2022):
	```
	pip install carla
	```
</details>
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 70 · 🔀 190 · 📦 860 · 📋 820 - 15% open · ⏱️ 26.05.2023):
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 97 · 🔀 470 · 📦 300 · 📋 430 - 3% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/online-ml/river
	```
- [PyPi](https://pypi.org/project/river) (📥 12K / month · 📦 27 · ⏱️ 29.01.2023):
	```
	pip install river
	```
...
- [GitHub](https://github.com/adapter-hub/adapter-transformers) (👨‍💻 1.7K · 🔀 260 · 📦 180 · 📋 320 - 18% open · ⏱️ 22.05.2023):
...
- [GitHub](https://github.com/PaddlePaddle/PaddleHub) (👨‍💻 69 · 🔀 2.1K · 📥 620 · 📦 1.3K · 📋 1.2K - 44% open · ⏱️ 28.03.2023):
...
- [GitHub](https://github.com/PennyLaneAI/pennylane) (👨‍💻 130 · 🔀 470 · 📥 66 · 📋 1K - 29% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/PennyLaneAI/PennyLane
	```
- [PyPi](https://pypi.org/project/pennylane) (📥 27K / month · 📦 56 · ⏱️ 06.03.2023):
	```
...
- [GitHub](https://github.com/datalad/datalad) (👨‍💻 55 · 🔀 100 · 📋 3.8K - 12% open · ⏱️ 24.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/datalad) (📥 8.9K / month · 📦 73 · ⏱️ 16.01.2023):
	```
	pip install datalad
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/hdbscan) (👨‍💻 81 · 🔀 440 · 📦 2.3K · 📋 480 - 66% open · ⏱️ 10.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/hdbscan) (📥 460K / month · 📦 200 · ⏱️ 31.10.2022):
	```
	pip install hdbscan
	```
...
<details><summary><b><a href="https://github.com/inducer/pyopencl">pyopencl</a></b> (🥈30 ·  ⭐ 970) - OpenCL integration for Python, plus shiny features. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/inducer/pyopencl) (👨‍💻 94 · 🔀 240 · 📦 1.5K · 📋 330 - 21% open · ⏱️ 25.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyopencl) (📥 43K / month · 📦 210 · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/SeldonIO/alibi-detect) (👨‍💻 18 · 🔀 180 · 📦 350 · 📋 330 - 34% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/SeldonIO/alibi-detect
	```
- [PyPi](https://pypi.org/project/alibi-detect) (📥 17K / month · 📦 7 · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/ContinualAI/avalanche) (👨‍💻 69 · 🔀 230 · 📥 4 · 📦 29 · 📋 690 - 14% open · ⏱️ 31.05.2023):

	```
	git clone https://github.com/ContinualAI/avalanche
	```
- [PyPi](https://pypi.org/project/avalanche-lib) (📥 2.5K / month · 📦 1 · ⏱️ 15.12.2022):
	```
...
- [GitHub](https://github.com/pyjanitor-devs/pyjanitor) (👨‍💻 110 · 🔀 160 · 📦 390 · 📋 540 - 20% open · ⏱️ 01.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyjanitor) (📥 28K / month · 📦 18 · ⏱️ 12.11.2022):
	```
...
- [GitHub](https://github.com/deepmind/pysc2) (👨‍💻 39 · 🔀 1.2K · 📥 30K · 📦 550 · 📋 280 - 17% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/openvinotoolkit/anomalib) (👨‍💻 43 · 🔀 360 · 📥 420 · 📦 13 · 📋 480 - 16% open · ⏱️ 31.05.2023):
...
- [GitHub](https://github.com/nicodv/kmodes) (👨‍💻 22 · 🔀 390 · 📦 2.1K · 📋 160 - 11% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/mars-project/mars) (👨‍💻 46 · 🔀 310 · 📋 1.2K - 18% open · ⏱️ 23.05.2023):

	```
	git clone https://github.com/mars-project/mars
	```
- [PyPi](https://pypi.org/project/pymars) (📥 62K / month · 📦 1 · ⏱️ 10.01.2023):
	```
	pip install pymars
	```
</details>
...
<details><summary><b><a href="https://github.com/MaxHalford/prince">Prince</a></b> (🥉27 ·  ⭐ 990) - Multivariate exploratory data analysis in Python: PCA, CA, MCA, MFA,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/MaxHalford/prince) (👨‍💻 15 · 🔀 170 · 📦 370 · 📋 120 - 0% open · ⏱️ 31.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/prince) (📥 51K / month · 📦 10 · ⏱️ 06.10.2020):
	```
	pip install prince
	```
...
- [GitHub](https://github.com/ljvmiranda921/pyswarms) (👨‍💻 44 · 🔀 320 · 📦 260 · 📋 220 - 9% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyswarms) (📥 7.7K / month · 📦 14 · ⏱️ 03.01.2021):
	```
...
- [GitHub](https://github.com/trevorstephens/gplearn) (👨‍💻 11 · 🔀 240 · 📦 390 · 📋 210 - 10% open · ⏱️ 04.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/gplearn) (📥 4.5K / month · 📦 13 · ⏱️ 03.05.2022):
	```
	pip install gplearn
	```
...
<details><summary><b><a href="https://github.com/dstackai/dstack">dstack</a></b> (🥉25 ·  ⭐ 680) - Develop ML faster. Easily and cost-effectively run dev environments,.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/dstackai/dstack) (👨‍💻 12 · 🔀 45 · 📦 11 · 📋 260 - 14% open · ⏱️ 31.05.2023):
...
<details><summary><b><a href="https://github.com/gventuri/pandas-ai">pandas-ai</a></b> (🥉24 ·  ⭐ 6.8K · 🐣) - Pandas AI is a Python library that integrates generative.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gventuri/pandas-ai) (👨‍💻 22 · 🔀 440 · 📦 70 · 📋 110 - 19% open · ⏱️ 01.06.2023):
...
<details><summary><b><a href="https://github.com/solegalli/feature_engine">Feature Engine</a></b> (🥉24 ·  ⭐ 1.3K) - Feature engineering package with sklearn like functionality. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/BioPandas/biopandas) (👨‍💻 11 · 🔀 110 · 📦 180 · 📋 51 - 39% open · ⏱️ 25.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/biopandas) (📥 6.5K / month · 📦 18 · ⏱️ 13.05.2022):
	```
...
- [GitHub](https://github.com/astroML/astroML) (👨‍💻 30 · 🔀 280 · 📋 160 - 39% open · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/astroML) (📥 1.6K / month · 📦 34 · ⏱️ 01.03.2022):
	```
	pip install astroML
	```
...
- [GitHub](https://github.com/Project-MONAI/MONAILabel) (👨‍💻 46 · 🔀 150 · 📥 54K · 📋 430 - 14% open · ⏱️ 19.05.2023):

	```
	git clone https://github.com/Project-MONAI/MONAILabel
	```
- [PyPi](https://pypi.org/project/monailabel-weekly) (📥 920 / month · ⏱️ 29.01.2023):
	```
...
- [GitHub](https://github.com/modAL-python/modAL) (👨‍💻 20 · 🔀 300 · 📥 23 · 📋 140 - 61% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/modAL-python/modAL
	```
- [PyPi](https://pypi.org/project/modAL) (📥 5.5K / month · 📦 10 · ⏱️ 07.01.2021):
	```
	pip install modAL
	```
</details>
...
- [GitHub](https://github.com/pykale/pykale) (👨‍💻 19 · 🔀 56 · 📦 1 · 📋 100 - 4% open · ⏱️ 19.05.2023):

	```
	git clone https://github.com/pykale/pykale
	```
- [PyPi](https://pypi.org/project/pykale) (📥 47 / month · ⏱️ 21.08.2022):
	```
	pip install pykale
	```
</details>
...
- [GitHub](https://github.com/SforAiDl/KD_Lib) (👨‍💻 6 · 🔀 49 · 📋 67 - 26% open · ⏱️ 01.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/KD-Lib) (📥 63 / month · ⏱️ 18.05.2022):
	```
	pip install KD-Lib
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/NeuralCompression) (👨‍💻 6 · 🔀 30 · 📋 77 - 23% open · ⏱️ 11.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/neuralcompression) (📥 96 / month · ⏱️ 12.01.2022):
	```
...
- <b><a href="https://github.com/jmschrei/apricot">apricot</a></b> (🥉20 ·  ⭐ 470 · 💀) - apricot implements submodular optimization for the purpose of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
